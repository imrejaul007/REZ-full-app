        ...
        <View style={[styles.container, { backgroundColor: Colors.gray[50] }]}>
          <ScrollView contentContainerStyle={styles.content}>
            <View style={styles.errorIconContainer}>
              <Ionicons name="alert-circle" size={64} color={Colors.primary[500]} />
            </View>
            ...
            {__DEV__ && (
              <View
                style={[
                  styles.errorStack,
                  { backgroundColor: Colors.gray[100], borderColor: Colors.border.default },
                ]}
              >
                <Text style={[styles.stackTrace, { color: Colors.text.primary }]}>
            ...
            <TouchableOpacity
              style={[styles.resetButton, { backgroundColor: Colors.primary[500] }]}
