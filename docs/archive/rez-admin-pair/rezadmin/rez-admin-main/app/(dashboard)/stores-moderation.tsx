        ...
        <View style={[styles.card, { backgroundColor: colors.card }]}>
          ...
          <View style={styles.cardHeader}>
            {item.logo ? (
              ...
              <View style={[styles.logoPlaceholder, { backgroundColor: colors.gray200 }]}>
          ...
          <View style={styles.actionRow}>
            ...
            >
              <Text style={styles.actionBtnText}>{item.isSuspended ? 'Suspended' : 'Suspend'}</Text>
            </TouchableOpacity>
            <TouchableOpacity
    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.background }}>
      ...
      <View style={styles.header}>
        <View style={styles.rowBetween}>
          <Text style={[styles.title, { color: colors.text }]}>Store Moderation</Text>
          {activeStoreCount > 0 && (
