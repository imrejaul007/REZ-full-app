      ...
      <View style={styles.section}>
        ...
        <View style={styles.settingsGroup}>
          ...
          <SettingItem
            ...
            onPress={() => router.push('/(dashboard)/bbps-analytics' as any)}
          />
          <SettingItem
            ...
            onPress={() => router.push('/(dashboard)/bbps-config' as any)}
          />
          <SettingItem
            icon="grid-outline"
            iconColor={colors.cyan}
            ...
            onPress={() => router.push('/(dashboard)/bbps-providers' as any)}
          />
          <SettingItem
            ...
            onPress={() => router.push('/(dashboard)/bbps-transactions' as any)}
          />
          <SettingItem
            icon="cash-outline"
            ...
            onPress={() => router.push('/(dashboard)/cashback-rules' as any)}
          />
          <SettingItem
            ...
            onPress={() => router.push('/(dashboard)/membership-config' as any)}
          />
          <SettingItem
            icon="ticket-outline"
            ...
            onPress={() => router.push('/(dashboard)/voucher-management' as any)}
          />
          <SettingItem
            icon="card-outline"
            iconColor={colors.info}
            ...
            onPress={() => router.push('/(dashboard)/wallet-adjustment' as any)}
          />
          <SettingItem
          ...
          <SettingItem
            ...
            onPress={() => router.push('/(dashboard)/partner-earnings' as any)}
          />
          <SettingItem
            ...
            onPress={() => router.push('/(dashboard)/disputes' as any)}
          />
        </View>
      </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.settingsGroup}>
          ...
          <SettingItem
            ...
            onPress={() => router.push('/(dashboard)/prive-campaigns' as any)}
          />
        </View>
      </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.settingsGroup}>
          ...
          <SettingItem
            ...
            onPress={() => router.push('/(dashboard)/store-collections' as any)}
          />
        </View>
      </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.settingsGroup}>
          <SettingItem
            ...
            onPress={() => router.push('/(dashboard)/revenue' as any)}
          />
          <SettingItem
            icon="analytics"
            ...
            onPress={() => router.push('/(dashboard)/analytics-dashboard' as any)}
          />
          <SettingItem
            icon="trending-up"
          ...
          <SettingItem
            ...
            onPress={() => router.push('/(dashboard)/marketing-analytics' as any)}
          />
        </View>
      </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.settingsGroup}>
          <SettingItem
            ...
            onPress={() => router.push('/(dashboard)/rez-now-orders' as any)}
          />
          <SettingItem
            icon="bar-chart-outline"
            iconColor={colors.purple}
            ...
            onPress={() => router.push('/(dashboard)/rez-now-analytics' as any)}
          />
          <SettingItem
            icon="document-text-outline"
            iconColor={colors.successDark}
            ...
            onPress={() => router.push('/(dashboard)/revenue-report' as any)}
          />
          <SettingItem
      ...
      <View style={styles.section}>
        ...
        <View style={styles.settingsGroup}>
          ...
          <SettingItem
            ...
            onPress={() => router.push('/(dashboard)/fraud-queue' as any)}
          />
          <SettingItem
            icon="shield-checkmark"
            iconColor={colors.purple}
          ...
          <SettingItem
            ...
            onPress={() => router.push('/(dashboard)/audit-log' as any)}
          />
          <SettingItem
            icon="settings"
            iconColor={colors.orange}
            ...
            onPress={() => router.push('/(dashboard)/admin-settings' as any)}
          />
          <SettingItem
            icon="car"
            iconColor={colors.info}
          ...
          <SettingItem
            ...
            onPress={() => router.push('/(dashboard)/achievements' as any)}
          />
          <SettingItem
            icon="podium-outline"
            iconColor={colors.purple}
            ...
            onPress={() => router.push('/(dashboard)/leaderboard-config' as any)}
          />
          <SettingItem
            ...
            onPress={() => router.push('/(dashboard)/daily-checkin-config' as any)}
          />
          <SettingItem
            icon="flash-outline"
            iconColor={colors.warningDark}
            ...
            onPress={() => router.push('/(dashboard)/quick-actions' as any)}
          />
          <SettingItem
            icon="card-outline"
            iconColor={colors.info}
            ...
            onPress={() => router.push('/(dashboard)/value-cards' as any)}
          />
          <SettingItem
            icon="megaphone-outline"
            iconColor={colors.info}
            ...
            onPress={() => router.push('/(dashboard)/campaign-management' as any)}
          />
          <SettingItem
            ...
            onPress={() => router.push('/(dashboard)/creators' as any)}
          />
          <SettingItem
            icon="calendar"
            iconColor={colors.info}
            ...
            onPress={() => router.push('/(dashboard)/events' as any)}
          />
          <SettingItem
            icon="apps-outline"
            iconColor={colors.indigo}
            ...
            onPress={() => router.push('/(dashboard)/event-categories' as any)}
          />
          <SettingItem
            icon="gift-outline"
            iconColor={colors.green}
            ...
            onPress={() => router.push('/(dashboard)/event-rewards' as any)}
          />
          <SettingItem
            ...
            onPress={() => router.push('/(dashboard)/service-appointments' as any)}
          />
          <SettingItem
            ...
            onPress={() => router.push('/(dashboard)/table-bookings' as any)}
          />
          <SettingItem
            icon="school-outline"
            iconColor={colors.purpleDark}
            ...
            onPress={() => router.push('/(dashboard)/institute-referrals' as any)}
          />
        </View>
      </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.settingsGroup}>
          ...
          <SettingItem
            ...
            onPress={() => router.push('/(dashboard)/platform-config' as any)}
          />
          <SettingItem
            icon="server-outline"
            iconColor={colors.info}
            ...
            onPress={() => router.push('/(dashboard)/platform-control-center' as any)}
          />
          <SettingItem
          ...
          <SettingItem
            ...
            onPress={() => router.push('/(dashboard)/device-security' as any)}
          />
        </View>
      </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.settingsGroup}>
          <SettingItem
            ...
            onPress={() => router.push('/(dashboard)/live-monitor' as any)}
          />
          <SettingItem
            icon="storefront"
            iconColor={colors.info}
      ...
      <View style={styles.section}>
        ...
        <View style={styles.settingsGroup}>
          ...
          <SettingItem
            ...
            onPress={() => router.push('/(dashboard)/support-tools' as any)}
          />
          <SettingItem
            ...
            onPress={() => router.push('/(dashboard)/faq-management' as any)}
          />
          <SettingItem
            icon="camera-outline"
            iconColor={colors.pink}
            ...
            onPress={() => router.push('/(dashboard)/ugc-moderation' as any)}
          />
          <SettingItem
            icon="star-outline"
            iconColor={colors.warning}
            ...
            onPress={() => router.push('/(dashboard)/review-moderation' as any)}
          />
          <SettingItem
            ...
            onPress={() => router.push('/(dashboard)/pending-approvals' as any)}
          />
          <SettingItem
            icon="people-outline"
            iconColor={colors.purpleDark}
            ...
            onPress={() => router.push('/(dashboard)/admin-users' as any)}
          />
        </View>
      </View>
      ...
      <View style={styles.section}>
        ...
        <View style={styles.settingsGroup}>
          ...
          <SettingItem
            ...
            onPress={() => router.push('/(dashboard)/support-tickets' as any)}
          />
        </View>
      </View>
