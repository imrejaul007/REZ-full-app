  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: colors.background }}>
      ...
      >
        ...
        >
          {/* Page title */}
          <Text style={[styles.pageTitle, { color: colors.text }]}>Send Platform Broadcast</Text>
          ...
          {audience === 'custom' && (
            <View style={{ marginBottom: 16 }}>
              <Text style={[styles.sectionLabel, { color: colors.text }]}>Custom Segment Tag</Text>
              <TextInput
                style={[
                  styles.input,
          ...
          {(title.trim() || body.trim()) && (
            <View style={{ marginBottom: 20 }}>
              <Text style={[styles.sectionLabel, { color: colors.text }]}>Preview</Text>
              <View
                style={[
                  styles.previewCard,
              ...
              >
                <View style={styles.previewHeader}>
                  <View style={[styles.previewAppIcon, { backgroundColor: colors.tint }]}>
          ...
          <TouchableOpacity
            ...
            disabled={sending}
            style={[styles.sendBtn, { backgroundColor: isValid ? colors.tint : colors.gray300 }]}
          >
            {sending ? (
          ...
          <View style={{ marginTop: 28 }}>
            <Text style={[styles.sectionLabel, { color: colors.text }]}>Recent Broadcasts</Text>
            {loadingHistory ? (
              <ActivityIndicator color={colors.tint} style={{ marginTop: 8 }} />
            ) : history.length === 0 ? (
              <View style={[styles.historyEmpty, { backgroundColor: colors.card }]}>
                ...
                {history.map((item) => (
                  ...
                  >
                    <View style={styles.rowBetween}>
                      ...
                      <View style={[styles.audiencePill, { backgroundColor: colors.infoLight }]}>
      ...
      <Modal visible={showConfirmModal} transparent animationType="fade">
        <View style={styles.modalOverlay}>
          <View style={[styles.modalCard, { backgroundColor: colors.card }]}>
            <View style={[styles.modalIconWrap, { backgroundColor: colors.errorLight }]}>
              <Ionicons name="megaphone" size={28} color={colors.tint} />
            </View>
            <Text style={[styles.modalTitle, { color: colors.text }]}>Confirm Broadcast</Text>
            <Text
              style={{
                fontSize: 13,
      ...
      <Modal visible={showSuccessModal} transparent animationType="fade">
        <View style={styles.modalOverlay}>
          <View style={[styles.modalCard, { backgroundColor: colors.card }]}>
            ...
            <Text style={[styles.modalTitle, { color: colors.text }]}>Broadcast Sent!</Text>
