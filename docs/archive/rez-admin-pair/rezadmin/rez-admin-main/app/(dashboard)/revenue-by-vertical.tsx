    ...
    >
      ...
      <View style={styles.heroCard}>
        <View style={styles.heroTop}>
          <View>
            <Text style={styles.heroLabel}>Total Revenue ({periodLabel(period)})</Text>
            <Text style={styles.heroValue}>{loading ? '...' : formatCurrency(totalRevenue)}</Text>
          </View>
          {!loading && overallGrowth !== 0 && (
            <View
              style={[styles.growthBadge, overallGrowth > 0 ? styles.growthUp : styles.growthDown]}
            >
              <Ionicons
        ...
        {!loading && <Text style={styles.heroSub}>vs previous {periodLabel(period)}</Text>}
      </View>
      ...
      {!loading && (
        <View style={styles.statsRow}>
          <View style={styles.statCard}>
            ...
            <Text style={styles.statValue}>{totalTransactions.toLocaleString('en-IN')}</Text>
          ...
          <View style={styles.statCard}>
            ...
            <Text style={styles.statValue}>{totalCustomers.toLocaleString('en-IN')}</Text>
      ...
      {loading ? (
        ...
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Revenue by Vertical</Text>
            ...
            return (
              <View key={i} style={styles.verticalCard}>
                ...
                <View style={styles.verticalHeader}>
                  ...
                  <View style={{ flex: 1 }}>
                    <Text style={styles.verticalName}>{item._id || 'Unknown'}</Text>
                    <Text style={styles.verticalShare}>{pct}% of total</Text>
                  </View>
                  <View style={{ alignItems: 'flex-end' }}>
                    <Text style={styles.verticalRevenue}>{formatCurrency(item.revenue || 0)}</Text>
                    {growth !== 0 && (
                      <View style={styles.inlineGrowth}>
                        <Ionicons
                ...
                <View style={styles.metricsRow}>
                  ...
                  <View style={styles.metric}>
                    <Text style={styles.metricValue}>{item.storeCount || 0}</Text>
