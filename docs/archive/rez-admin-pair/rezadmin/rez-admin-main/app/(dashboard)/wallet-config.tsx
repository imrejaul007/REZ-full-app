      ...
      >
        ...
        >
          <View style={styles.killSwitchHeader}>
            <Text style={styles.killSwitchTitle}>⚡ Coin Issuance Kill Switch</Text>
            <View
              style={[
                styles.killSwitchBadge,
                {
          ...
          >
            <Text style={styles.killSwitchButtonText}>
              {(config?.rewardIssuanceEnabled ?? true)
        ...
        {renderSectionCard(
          ...
          <>
            ...
            <TouchableOpacity
              style={[styles.addTierBtn, { borderColor: colors.border }]}
              onPress={addTier}
            >
