  ...
  return (
    ...
    >
      ...
      <View style={[styles.header, { backgroundColor: '#7c3aed' }]}>
        <Text style={styles.headerTitle}>💜 Rendez</Text>
        <Text style={styles.headerSub}>Social dating partner platform — real-time stats</Text>
        {error && (
      ...
      {planStats && (
        <View style={styles.section}>
          <Text style={[styles.sectionTitle, { color: colors.text }]}>Plans (Social Invites)</Text>
          <View style={styles.grid}>
            <StatCard
              label="Total Plans"
        ...
        <View style={{ gap: 10 }}>
          {[
            ...
            >
              ...
              <Text style={[styles.linkBtnText, { color: colors.text }]}>{item.label}</Text>
