      ...
      <View style={styles.tabBar}>
        {[
          ...
          >
            ...
            {tab.key === 'builder' && isDirty && <View style={styles.dirtyIndicator} />}
          </TouchableOpacity>
        ))}
      </View>
              ...
              <View style={{ flexDirection: 'row', gap: 8 }}>
                {!showCreateModal && (
                  ...
                  >
                    ...
                    <Text style={[styles.reorderToggleText, { color: colors.success }]}>
                      Create
                    </Text>
                  </TouchableOpacity>
                )}
                {!reorderMode ? (
                  <TouchableOpacity
                    style={[styles.reorderToggle, { backgroundColor: `${colors.info}15` }]}
                  ...
                  <View style={styles.reorderActions}>
                    ...
                    <TouchableOpacity
                      style={[styles.reorderBtn, { backgroundColor: colors.mutedDark }]}
