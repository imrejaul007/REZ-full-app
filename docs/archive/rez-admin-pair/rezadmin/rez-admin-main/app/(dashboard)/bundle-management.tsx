...
export default function BundleManagementScreen() {
  ...
  const openEditModal = (bundle: TrialBundle) => {
    ...
    setFormData({
      ...
      maxUsesPerMerchant: String((bundle as any).maxUsesPerMerchant ?? 1),
      ...
      <View style={[styles.container, { backgroundColor: colors.background }]}>
        ...
        >
          <View style={styles.headerContent}>
            ...
            <Text style={styles.headerTitle}>Trial Bundles & Passes</Text>
            <View style={{ width: 40 }} />
          </View>
        </LinearGradient>
    ...
    <View style={[styles.container, { backgroundColor: colors.background }]}>
      ...
      <View style={[styles.filterContainer, { borderBottomColor: colors.border }]}>
        {(['all', 'active', 'pass', 'pack'] as FilterType[]).map((f) => (
          <TouchableOpacity
            ...
            style={[
              styles.filterTab,
              filter === f && [styles.filterTabActive, { borderBottomColor: '#16A34A' }],
            ]}
            onPress={() => setFilter(f)}
          >
            <Text
      ...
      {filteredBundles.length === 0 ? (
        <View style={styles.emptyContainer}>
          ...
          <Text style={[styles.emptyTitle, { color: colors.text }]}>No Bundles</Text>
        ...
        <View style={[styles.modalOverlay, { backgroundColor: 'rgba(0,0,0,0.5)' }]}>
          <View style={[styles.modalContent, { backgroundColor: colors.card }]}>
            ...
            <ScrollView style={styles.modalForm} showsVerticalScrollIndicator={false}>
                ...
                <View style={styles.typeSelector}>
                  {(['pass', 'pack'] as const).map((t) => (
                    <TouchableOpacity
                      ...
                      style={[
                        styles.typeOption,
                        formData.bundleType === t && styles.typeOptionActive,
              ...
              {/* Trial Slots */}
              <View style={styles.formField}>
                <Text style={[styles.formLabel, { color: colors.text }]}>Trial Slots</Text>
                <TextInput
                  style={[styles.formInput, { color: colors.text, borderColor: colors.border }]}
                  placeholder="5"
                  placeholderTextColor={colors.icon}
              ...
              {/* Trial Coins */}
              <View style={styles.formField}>
                <Text style={[styles.formLabel, { color: colors.text }]}>Trial Coins Included</Text>
                <TextInput
                  style={[styles.formInput, { color: colors.text, borderColor: colors.border }]}
                  placeholder="100"
                  placeholderTextColor={colors.icon}
              ...
              {/* Bonus Reward Coins */}
              <View style={styles.formField}>
                <Text style={[styles.formLabel, { color: colors.text }]}>Bonus Reward Coins</Text>
                <TextInput
                  style={[styles.formInput, { color: colors.text, borderColor: colors.border }]}
                  placeholder="50"
                  placeholderTextColor={colors.icon}
              ...
              {/* Category */}
              <View style={styles.formField}>
                <Text style={[styles.formLabel, { color: colors.text }]}>Category (optional)</Text>
                <TextInput
                  style={[styles.formInput, { color: colors.text, borderColor: colors.border }]}
              ...
              {/* Featured */}
              <View style={[styles.formField, styles.toggleField]}>
