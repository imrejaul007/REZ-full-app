 ...
 * NEW-A-L3 FIX: Replaced `as any` with the isValidAdminRole type guard from roles.ts.
...
const isAdminRole = (role: string | undefined): boolean => {
  ...
  // Use the typed isValidAdminRole guard instead of VALID_ADMIN_ROLES.includes(role as any)
