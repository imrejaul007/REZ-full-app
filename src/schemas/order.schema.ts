...
/**
 * All 14 canonical order statuses.
 * Extended from 11 → 14 to include failed_delivery, return_requested, return_rejected
 * which the backend already emits.
 * Must match `enums/index.ts` OrderStatus.
 */
