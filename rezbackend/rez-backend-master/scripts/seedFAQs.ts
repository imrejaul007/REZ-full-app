...
const faqData = [
  // ORDER CATEGORY
  {
    ...
    answer:
      'You can track your order in real-time by going to the "Orders" section in your account. Click on the specific order to see detailed tracking information including current location, estimated delivery time, and delivery status. You will also receive SMS and push notifications with tracking updates.',
  ...
  },
  {
    ...
    answer:
      'Delivery times vary based on your location and the seller. Typically: Same-day delivery for nearby stores (within 5km), 1-3 days for local city delivery, 3-7 days for other cities. Express delivery options are available for select products. You can see estimated delivery date before placing your order.',
  ...
  // PAYMENT CATEGORY
  {
    ...
    answer:
      'We accept multiple payment methods: Credit/Debit Cards (Visa, Mastercard, Amex, RuPay), UPI (Google Pay, PhonePe, Paytm, BHIM), Net Banking from all major banks, Digital Wallets (RezPay, Paytm, PhonePe), Cash on Delivery (COD) for eligible orders, and EMI options for orders above ₹3,000.',
  ...
  },
  {
    ...
    answer:
      'Payment can be declined for several reasons: Insufficient funds, Daily transaction limit exceeded, Incorrect card details or OTP, Bank server issues, International cards not enabled for online transactions. Try these solutions: Check bank balance, Use different payment method, Contact your bank, Ensure OTP is entered correctly, Try after some time if bank server is down.',
  ...
  },
  {
    ...
    answer:
      'RezPay is our digital wallet that offers instant checkouts, cashback rewards, and exclusive offers. You can: Add money via UPI/Cards/Net Banking, Get instant refunds, Earn cashback on every purchase (up to 5%), Pay bills and recharge, Transfer to bank account (free). Minimum balance: ₹0, Maximum balance: ₹1,00,000. Activate from Account > RezPay.',
  ...
  // PRODUCT CATEGORY
  {
    ...
    answer:
      'To return a product: 1) Go to Orders > Select Order > Return Item, 2) Select reason for return, 3) Choose refund method (Original payment source or RezPay wallet), 4) Schedule pickup or drop-off, 5) Pack item with original packaging and tags. Return window: 7 days for most products, 3 days for electronics, 15 days for clothing. Product must be unused and in original condition.',
  ...
  },
  {
    ...
    answer:
      'To update profile: Go to Account > Edit Profile. You can update: Name, Email, Phone number (requires OTP verification), Date of birth, Gender, Profile photo. Note: Phone number is linked to your account for security. Changing it requires OTP verification on both old and new numbers. Email changes are instant. Keep your profile updated for personalized recommendations.',
  ...
  },
  {
    ...
    answer:
      'To manage addresses: Go to Account > Addresses. You can: Add new address, Edit existing address, Delete address, Set default address, Add delivery instructions (e.g., "Ring doorbell", "Leave with security"). You can save unlimited addresses. Use labels like Home, Office, Mom\'s House for easy identification. Default address is auto-selected during checkout.',
  ...
  // TECHNICAL CATEGORY
  {
    ...
    answer:
      'Try these troubleshooting steps: 1) Force close the app and reopen, 2) Check internet connection (WiFi/Mobile data), 3) Clear app cache: Settings > Apps > Rez > Clear Cache, 4) Update app to latest version from Play Store/App Store, 5) Restart your phone, 6) Uninstall and reinstall the app (your data is safe in cloud). If issue persists, contact support with: Phone model, OS version, App version, Screenshot of error.',
  ...
  },
  {
    ...
    answer:
      'OTP delivery issues can occur due to: Network congestion (wait 2-3 minutes), Phone memory full, SMS blocking apps, DND (Do Not Disturb) activated, Incorrect number entered. Solutions: Wait and don\'t request multiple OTPs (15 min cooldown), Check spam/blocked messages, Disable DND temporarily, Ensure correct +91 country code, Try email OTP instead, Contact mobile operator, Use "Resend OTP" after 2 minutes.',
  ...
  },
  {
    ...
    answer:
      'To enable notifications: Android: Settings > Apps > Rez > Notifications > Enable all. iOS: Settings > Rez > Notifications > Allow Notifications. In-app: Account > Notification Settings > Enable categories (Orders, Offers, Delivery, Payments). Notification types: Push (instant), SMS (order updates), Email (receipts, offers). Manage preferences to avoid spam while staying updated on important order info.',
  ...
  // DELIVERY CATEGORY
  {
    ...
    answer:
      'Delivery charges vary based on: Order value: FREE for orders ₹499 and above, ₹49 for orders below ₹499. Distance: Local (within 10km) - Free above ₹299, Outstation - ₹99-199 based on distance. Express delivery (same-day/next-day) - Additional ₹99-149. Exact charges shown at checkout. RezPlus members get free delivery on all orders!',
  ...
  // REFUND CATEGORY
  {
    ...
    answer:
      'Refund timelines after approval: UPI/Wallet: 1-3 business days (instant in most cases), Credit/Debit Card: 5-7 business days, Net Banking: 5-7 business days, COD orders: 7-10 business days to bank account or instant to RezPay wallet. Refund initiation: 24-48 hours after product pickup/quality check. You will receive SMS/Email confirmation when refund is processed. Check status: Orders > Refunds.',
  ...
  },
  {
    ...
    answer:
      'Yes, delivery charges are refunded in these cases: 1) Product is defective/damaged/wrong item received, 2) Order not delivered and returned, 3) Order cancelled before dispatch. No refund for delivery charges if: You cancel after dispatch, Return due to change of mind, Size/color mismatch (customer error). Delivery charges are shown separately in refund breakdown. Processing time same as product refund.',
  ...
  // OTHER/GENERAL CATEGORY
  {
    ...
    answer:
      'Multiple ways to reach us: Live Chat (fastest): Account > Help > Chat Now (9 AM - 9 PM daily), Phone: 1800-123-4567 (toll-free, 24/7), Email: support@rezapp.com (response within 24 hours), Support ticket: Account > Help > Create Ticket. For urgent issues: Use live chat or phone. For order-specific: Go to Orders > Select Order > Get Help. Average response time: Chat - 2 mins, Phone - 5 mins, Email - 12 hours.',
