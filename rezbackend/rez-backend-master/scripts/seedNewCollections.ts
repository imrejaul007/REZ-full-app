...
const rechargeOperators = [
  ...
  },
  {
    ...
    plans: [
      ...
      {
        name: 'Xstream Premium',
        amount: 453,
        validity: '30 days',
        data: '300+ channels + OTT',
        calls: 'N/A',
        sms: 'N/A',
        cashbackPercent: 3,
        popular: true,
  ...
  },
  {
    ...
    plans: [
      {
        name: 'Jio Fiber 30Mbps',
        amount: 399,
        validity: '30 days',
        data: 'Unlimited (30 Mbps)',
        calls: 'N/A',
        sms: 'N/A',
        cashbackPercent: 3,
        popular: true,
      ...
      {
        name: 'Jio Fiber 300Mbps',
        amount: 999,
        validity: '30 days',
        data: 'Unlimited (300 Mbps)',
        calls: 'N/A',
        sms: 'N/A',
        cashbackPercent: 5,
        popular: false,
...
const billProviders = [
  ...
  },
  {
    ...
    logo: '',
    region: 'Delhi',
    requiredFields: [{ fieldName: 'caNumber', label: 'CA Number', placeholder: 'Enter CA number', type: 'text' }],
    cashbackPercent: 1,
  },
  // Water
  {
  ...
  },
  {
    ...
    logo: '',
    region: 'Delhi',
    requiredFields: [{ fieldName: 'bpNumber', label: 'BP Number', placeholder: 'Enter BP number', type: 'number' }],
    cashbackPercent: 1,
  },
  // Internet
  {
    ...
    requiredFields: [
      {
        ...
        placeholder: 'Enter landline/account number',
        type: 'text',
      },
    ],
    cashbackPercent: 1,
...
const insurancePlans = [
  ...
  },
  {
    ...
    features: [
      ...
      'Health returns up to 30%',
      'Multiplier benefit',
      'InfinitiCare (unlimited sum)',
