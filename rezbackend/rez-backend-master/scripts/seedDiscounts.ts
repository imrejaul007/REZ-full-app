...
const discountTemplates = [
  ...
  },
  {
    ...
    metadata: {
      ...
      termsAndConditions: ['Valid on all card payments', 'Maximum discount amount: ₹500'],
    },
  },
  {
    code: 'FIRST100',
    ...
    metadata: {
      ...
      termsAndConditions: ['Valid only on first order', 'Minimum order value: ₹500'],
    },
  },
  {
    code: 'MEGA25',
    ...
    metadata: {
      ...
      termsAndConditions: ['Valid during mega sale period only', 'Offline purchases only', 'Maximum discount: ₹2500'],
    },
  },
  {
    code: 'UPI10',
    ...
    metadata: {
      ...
      termsAndConditions: ['Valid on UPI payments only', 'Maximum discount: ₹200'],
    },
  },
];
