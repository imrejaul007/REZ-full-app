...
const DELHI_COORDS = [77.209, 28.6139];
const LOCATIONS = [
  { name: 'Connaught Place', coords: [77.209, 28.6139] },
  { name: 'Karol Bagh', coords: [77.2295, 28.6129] },
  { name: 'Lajpat Nagar', coords: [77.209, 28.6039] },
...
async function seedOffers(stores: any[], adminUser: any) {
  ...
  const offers = [
    // Mega Offers
    {
      ...
      description:
        "Get amazing discounts on smartphones, laptops, and gadgets. Limited time offer! Don't miss out on these incredible deals.",
