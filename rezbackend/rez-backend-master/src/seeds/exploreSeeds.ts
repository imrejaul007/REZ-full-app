...
const CITY_COORDS = {
  delhi: {
    ...
    areas: [
      ...
      { name: 'Rajouri Garden', coords: [77.122, 28.6473] },
      { name: 'Dwarka', coords: [77.041, 28.5921] },
  ...
  mumbai: {
    ...
    areas: [
      ...
      { name: 'Powai', coords: [72.906, 19.1176] },
      { name: 'Worli', coords: [72.815, 19.0176] },
  ...
  bangalore: {
    ...
    areas: [
      ...
      { name: 'Electronic City', coords: [77.67, 12.8395] },
      { name: 'MG Road', coords: [77.607, 12.9758] },
    ],
  },
};
...
const storeData = {
  delhi: [
    // Food & Restaurants
    {
      ...
      category: 'food',
      description: 'Authentic Indian sweets and namkeen since 1937',
      tags: ['indian', 'sweets', 'vegetarian', 'halal'],
      cashback: 15,
    ...
    {
      name: 'Bikanervala',
      slug: 'bikanervala-karol-bagh',
      category: 'food',
      description: 'Traditional Indian cuisine and sweets',
    ...
    },
    {
      ...
      slug: 'dominos-saket',
      category: 'food',
      description: 'Fresh hot pizzas delivered in 30 minutes',
    ...
    {
      name: 'McDonalds',
      slug: 'mcdonalds-lajpat-nagar',
      category: 'food',
      description: 'Global fast food chain',
      tags: ['burger', 'fast-food', 'quick-bites'],
      cashback: 10,
      partnerLevel: 'silver',
      area: 3,
    },
    {
      name: 'Pizza Hut',
      slug: 'pizza-hut-greater-kailash',
      category: 'food',
      description: 'Pan pizzas and pasta',
    ...
    {
      name: 'Subway',
      slug: 'subway-rajouri-garden',
      category: 'food',
      description: 'Fresh made subs and salads',
    ...
    // Cafes
    {
      ...
      slug: 'starbucks-khan-market',
      category: 'cafe',
      description: 'Premium coffee experience',
      tags: ['coffee', 'cafe', 'premium', 'desserts'],
      cashback: 20,
      partnerLevel: 'platinum',
      area: 2,
    },
    {
      ...
      slug: 'blue-tokai-saket',
      category: 'cafe',
      description: 'Specialty Indian coffee roasters',
    ...
    {
      name: 'Chaayos',
      slug: 'chaayos-connaught-place',
      category: 'cafe',
      description: 'Experiments with chai',
      tags: ['tea', 'chai', 'snacks', 'indian'],
      cashback: 15,
      partnerLevel: 'gold',
      area: 0,
    },
    ...
    {
      name: 'Zara',
      slug: 'zara-select-citywalk',
      category: 'fashion',
      description: 'International fashion brand',
      tags: ['fashion', 'clothing', 'premium', 'international'],
      cashback: 10,
      partnerLevel: 'platinum',
      area: 1,
    },
    ...
    {
      name: 'FabIndia',
      slug: 'fabindia-khan-market',
      category: 'fashion',
      description: 'Indian ethnic wear and home products',
      tags: ['ethnic', 'indian', 'handloom'],
      cashback: 15,
      partnerLevel: 'gold',
      area: 2,
    },
    {
      name: 'Pantaloons',
      slug: 'pantaloons-lajpat-nagar',
      category: 'fashion',
      description: 'Family fashion destination',
      tags: ['fashion', 'family', 'affordable'],
      cashback: 14,
      partnerLevel: 'gold',
      area: 3,
    },
    ...
    {
      name: 'Vijay Sales',
      slug: 'vijay-sales-lajpat-nagar',
      category: 'electronics',
      description: 'Electronics and home appliances',
      tags: ['electronics', 'appliances', 'affordable'],
      cashback: 10,
      partnerLevel: 'silver',
      area: 3,
    },
    {
      ...
      slug: 'reliance-digital-pitampura',
      category: 'electronics',
    ...
    {
      name: 'Big Bazaar',
      slug: 'big-bazaar-rajouri-garden',
      category: 'grocery',
      description: 'Hypermarket chain',
      tags: ['grocery', 'essentials', 'household'],
      cashback: 8,
      partnerLevel: 'gold',
      area: 6,
    },
    {
      ...
      slug: 'dmart-dwarka',
      category: 'grocery',
      description: 'Value retail chain',
      tags: ['grocery', 'value', 'essentials'],
      cashback: 5,
      partnerLevel: 'silver',
      area: 7,
    },
    {
      name: 'Natures Basket',
      slug: 'natures-basket-greater-kailash',
      category: 'grocery',
      description: 'Gourmet and organic foods',
      tags: ['grocery', 'organic', 'premium', 'gourmet'],
      cashback: 12,
      partnerLevel: 'gold',
      area: 4,
    },
    ...
    {
      name: 'Lakme Salon',
      slug: 'lakme-salon-connaught-place',
      category: 'salon',
      description: 'Premium beauty services',
      tags: ['salon', 'beauty', 'spa', 'premium'],
      cashback: 25,
      partnerLevel: 'platinum',
      area: 0,
    },
    {
      ...
      slug: 'vlcc-saket',
      category: 'salon',
      description: 'Wellness and beauty treatments',
      tags: ['salon', 'wellness', 'slimming'],
      cashback: 20,
      partnerLevel: 'gold',
      area: 1,
    },
    {
      name: 'Naturals',
      slug: 'naturals-lajpat-nagar',
      category: 'salon',
      description: 'Unisex beauty salon',
      tags: ['salon', 'beauty', 'unisex'],
      cashback: 18,
      partnerLevel: 'gold',
      area: 3,
    },
    ...
    {
      name: 'Golds Gym',
      slug: 'golds-gym-nehru-place',
      category: 'fitness',
      description: 'Premium fitness center',
      tags: ['gym', 'fitness', 'premium'],
      cashback: 15,
      partnerLevel: 'gold',
      area: 9,
    },
    {
      name: 'Cult.fit',
      slug: 'cultfit-greater-kailash',
      category: 'fitness',
      description: 'Holistic fitness experience',
      tags: ['gym', 'fitness', 'yoga', 'cult'],
      cashback: 18,
      partnerLevel: 'platinum',
      area: 4,
    },
  ...
  mumbai: [
    ...
    {
      name: 'Theobroma',
      slug: 'theobroma-bandra',
      category: 'food',
      description: 'Artisan bakery and patisserie',
      tags: ['bakery', 'desserts', 'cafe', 'premium'],
      cashback: 15,
      partnerLevel: 'platinum',
      area: 0,
    },
    {
      name: 'Leopold Cafe',
      slug: 'leopold-cafe-colaba',
      category: 'food',
      description: 'Iconic Mumbai cafe since 1871',
      tags: ['cafe', 'heritage', 'continental'],
      cashback: 12,
      partnerLevel: 'gold',
      area: 3,
    },
    {
      ...
      slug: 'sbopw-lower-parel',
      category: 'food',
      description: 'Parsi Iranian cafe',
      tags: ['parsi', 'iranian', 'cafe', 'unique'],
      cashback: 18,
      partnerLevel: 'gold',
      area: 4,
    },
    {
      name: 'Dominos Pizza',
      slug: 'dominos-andheri',
      category: 'food',
      description: 'Fresh hot pizzas delivered',
      tags: ['pizza', 'fast-food', 'delivery'],
      cashback: 18,
      partnerLevel: 'gold',
      area: 1,
    ...
    {
      name: 'McDonalds',
      slug: 'mcdonalds-powai',
      category: 'food',
      description: 'Global fast food',
      tags: ['burger', 'fast-food', 'quick-bites'],
      cashback: 10,
      partnerLevel: 'silver',
      area: 5,
    },
    {
      ...
      slug: 'britannia-fort',
      category: 'food',
      description: 'Legendary Parsi restaurant',
      tags: ['parsi', 'heritage', 'non-veg'],
      cashback: 10,
      partnerLevel: 'silver',
      area: 9,
    },
    {
      ...
      slug: 'bastian-worli',
      category: 'food',
      description: 'Seafood and coastal cuisine',
    ...
    },
    {
      ...
      slug: 'coffee-bean-bandra',
      category: 'cafe',
      description: 'International coffee house',
      tags: ['coffee', 'cafe', 'international'],
      cashback: 15,
      partnerLevel: 'gold',
      area: 0,
    },
    {
      name: 'Prithvi Cafe',
      slug: 'prithvi-cafe-juhu',
      category: 'cafe',
      description: 'Iconic theatre cafe',
      tags: ['cafe', 'cultural', 'heritage'],
      cashback: 10,
      partnerLevel: 'silver',
      area: 2,
    },
    ...
    {
      name: 'Lifestyle',
      slug: 'lifestyle-andheri',
      category: 'fashion',
      description: 'Fashion and home decor',
      tags: ['fashion', 'lifestyle', 'home'],
      cashback: 14,
      partnerLevel: 'gold',
      area: 1,
    },
    {
      ...
      slug: 'westside-malad',
      category: 'fashion',
      description: 'Fashion for the family',
      tags: ['fashion', 'family', 'affordable'],
      cashback: 12,
      partnerLevel: 'gold',
      area: 7,
    ...
    {
      name: 'Shoppers Stop',
      slug: 'shoppers-stop-goregaon',
      category: 'fashion',
      description: 'Department store chain',
      tags: ['fashion', 'premium', 'department'],
      cashback: 15,
      partnerLevel: 'platinum',
      area: 8,
    },
    ...
    },
    {
      ...
      slug: 'natures-basket-bandra',
      category: 'grocery',
      description: 'Premium organic foods',
      tags: ['grocery', 'organic', 'premium'],
      cashback: 12,
      partnerLevel: 'gold',
      area: 0,
    },
    ...
    {
      name: 'Lakme Salon',
      slug: 'lakme-salon-bandra',
      category: 'salon',
      description: 'Premium beauty services',
      tags: ['salon', 'beauty', 'spa'],
      cashback: 25,
      partnerLevel: 'platinum',
      area: 0,
    },
    {
      ...
      slug: 'jcb-juhu',
      category: 'salon',
      description: 'French luxury salon',
      tags: ['salon', 'luxury', 'french'],
      cashback: 20,
      partnerLevel: 'platinum',
      area: 2,
    },
    ...
    {
      name: 'Talwalkars',
      slug: 'talwalkars-andheri',
      category: 'fitness',
      description: 'Fitness chain',
      tags: ['gym', 'fitness'],
      cashback: 12,
      partnerLevel: 'silver',
      area: 1,
  ...
  bangalore: [
    ...
    },
    {
      ...
      category: 'food',
      description: 'Brewpub with craft beer',
    ...
    {
      name: 'CTR',
      slug: 'ctr-malleshwaram',
      category: 'food',
      description: 'Legendary dosa joint',
      tags: ['south-indian', 'dosa', 'heritage', 'vegetarian'],
      cashback: 8,
      partnerLevel: 'silver',
      area: 5,
    },
    {
      ...
      slug: 'vidyarthi-bhavan-jayanagar',
      category: 'food',
      description: 'Iconic masala dosa since 1943',
      tags: ['south-indian', 'dosa', 'heritage', 'vegetarian'],
      cashback: 8,
      partnerLevel: 'silver',
      area: 4,
    },
    {
      ...
      category: 'food',
      description: 'Andhra style biryani',
      tags: ['biryani', 'andhra', 'non-veg', 'spicy'],
      cashback: 15,
      partnerLevel: 'gold',
      area: 0,
    },
    {
      ...
      slug: 'empire-koramangala',
      category: 'food',
      description: 'Late night biryani hub',
      tags: ['biryani', 'non-veg', 'late-night'],
      cashback: 12,
      partnerLevel: 'gold',
      area: 0,
    },
    ...
    // Cafes
    {
      ...
      category: 'cafe',
      description: 'Art meets coffee',
      tags: ['coffee', 'art', 'cultural'],
      cashback: 15,
      partnerLevel: 'gold',
      area: 0,
    },
    {
      name: 'Matteo Coffea',
      slug: 'matteo-coffea-church-street',
      category: 'cafe',
      description: 'European style cafe',
      tags: ['coffee', 'european', 'premium'],
      cashback: 15,
      partnerLevel: 'gold',
      area: 9,
    },
    ...
    {
      name: 'Max Fashion',
      slug: 'max-fashion-whitefield',
      category: 'fashion',
      description: 'Value fashion',
      tags: ['fashion', 'value', 'family'],
      cashback: 14,
      partnerLevel: 'gold',
      area: 3,
    },
    {
      ...
      slug: 'reliance-trends-electronic-city',
      category: 'fashion',
    ...
    {
      name: 'Reliance Digital',
      slug: 'reliance-digital-indiranagar',
      category: 'electronics',
    ...
    },
    {
      ...
      slug: 'sangeetha-jayanagar',
      category: 'electronics',
      description: 'Mobile retail chain',
    ...
    {
      name: 'BigBasket',
      slug: 'bigbasket-hsr-layout',
      category: 'grocery',
      description: 'Online grocery',
      tags: ['grocery', 'online', 'delivery'],
      cashback: 10,
      partnerLevel: 'gold',
      area: 2,
    },
    {
      ...
      slug: 'more-koramangala',
      category: 'grocery',
      description: 'Neighborhood supermarket',
    ...
    {
      name: 'Star Bazaar',
      slug: 'star-bazaar-whitefield',
      category: 'grocery',
      description: 'Hypermarket',
      tags: ['grocery', 'household', 'essentials'],
      cashback: 8,
      partnerLevel: 'gold',
      area: 3,
    },
...
const productData = [
  ...
  { name: 'Aashirvaad Atta 10kg', category: 'grocery', price: 480, originalPrice: 550, cashback: 5, store: 'dmart' },
  {
    ...
    originalPrice: 550,
    cashback: 12,
    store: 'natures-basket',
  },
  {
    name: 'Imported Olive Oil 1L',
    category: 'grocery',
    price: 899,
    originalPrice: 1099,
    cashback: 12,
...
async function seedExploreData() {
  try {
    ...
    logger.info('Found categories:', Object.keys(categoryMap).length);
    ...
    logger.warn(
      `[SEED] Demo user password for this run: ${seedPassword} — record this now, it will not be shown again.`,
    );
    ...
    logger.info(`Created/Found ${createdUsers.length} users`);
    ...
    logger.info(`Created/Found ${Object.keys(createdStores).length} stores`);
    ...
    logger.info(`Created ${productsCreated} products`);
    ...
    for (const [category, titles] of Object.entries(videoTitles)) {
      ...
      for (const title of titles) {
        ...
        const _videoSlug = `${title.toLowerCase().replace(/[^a-z0-9]+/g, '-')}-${Date.now()}`;
    ...
    logger.info(`Created ${videosCreated} videos`);
    ...
    logger.info(`Created ${offersCreated} offers`);
    ...
    logger.info(`Created ${reviewsCreated} reviews`);

    logger.info('\n========================================');
    logger.info('EXPLORE SEEDS COMPLETED SUCCESSFULLY!');
    logger.info('========================================');
    logger.info(`Users: ${createdUsers.length}`);
    logger.info(`Stores: ${Object.keys(createdStores).length}`);
    logger.info(`Products: ${productsCreated}`);
    logger.info(`Videos: ${videosCreated}`);
    logger.info(`Offers: ${offersCreated}`);
    logger.info(`Reviews: ${reviewsCreated}`);
    logger.info('========================================\n');
