...
describe('Referral Controller', () => {
  ...
  beforeEach(() => {
    ...
    mockReq = {
      userId: '507f1f77bcf86cd799439011', // valid 24-char hex ObjectId
      body: {},
    } as any;
    ...
    it('should generate referral code if not exists', async () => {
      const mockUser: any = {
        ...
        save: jest.fn().mockImplementation(() => {
          // Simulate pre-save hook setting referral code
          mockUser.referral = { referralCode: 'REF87654321' };
          mockUser.referralCode = 'REF87654321';
