  ...
  describe('Game Routes', () => {
    describe('GET /api/games/available', () => {
      ...
      it('should return available games with auth', async () => {
        const response = await request(app).get('/api/games/available').set('Authorization', `Bearer ${authToken}`);
    ...
    describe('GET /api/games/my-games', () => {
      it('should return user games', async () => {
        const response = await request(app).get('/api/games/my-games').set('Authorization', `Bearer ${authToken}`);
      ...
      it('should reject request without auth', async () => {
        const response = await request(app).get('/api/games/my-games');
    ...
    describe('GET /api/games/pending', () => {
      it('should return pending games', async () => {
        const response = await request(app).get('/api/games/pending').set('Authorization', `Bearer ${authToken}`);
    ...
    describe('GET /api/games/statistics', () => {
      it('should return game statistics', async () => {
        const response = await request(app).get('/api/games/statistics').set('Authorization', `Bearer ${authToken}`);
    ...
    describe('GET /api/games/daily-limits', () => {
      it('should return daily game limits', async () => {
        const response = await request(app).get('/api/games/daily-limits').set('Authorization', `Bearer ${authToken}`);
    ...
    describe('GET /api/games/daily-trivia', () => {
      it('should return daily trivia question', async () => {
        const response = await request(app).get('/api/games/daily-trivia').set('Authorization', `Bearer ${authToken}`);
  ...
  describe('Leaderboard Routes', () => {
    ...
    describe('GET /api/leaderboard/reviews', () => {
      it('should return review leaderboard', async () => {
        const response = await request(app).get('/api/leaderboard/reviews').set('Authorization', `Bearer ${authToken}`);
    ...
    describe('GET /api/leaderboard/streak', () => {
      it('should return streak leaderboard', async () => {
        const response = await request(app).get('/api/leaderboard/streak').set('Authorization', `Bearer ${authToken}`);
    ...
    describe('GET /api/leaderboard/all', () => {
      it('should return all leaderboards', async () => {
        const response = await request(app).get('/api/leaderboard/all').set('Authorization', `Bearer ${authToken}`);
    ...
    describe('GET /api/leaderboard/my-rank', () => {
      it('should return user rank', async () => {
        const response = await request(app).get('/api/leaderboard/my-rank').set('Authorization', `Bearer ${authToken}`);
    ...
    it('should reject leaderboard request without auth', async () => {
      const response = await request(app).get('/api/leaderboard/spending');
  ...
  describe('Achievement Routes', () => {
    describe('GET /api/achievements', () => {
      it('should return user achievements', async () => {
        const response = await request(app).get('/api/achievements').set('Authorization', `Bearer ${authToken}`);
    ...
    describe('POST /api/achievements/initialize', () => {
      it('should initialize user achievements', async () => {
        ...
        // May return 200/201 on success or 400/409 if already initialized or DB seeding issue
        expect(response.status).toBeLessThan(500);
      });
    });
