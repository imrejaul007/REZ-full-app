...
// P0-ENUM-5 FIX: added COMPLETED — mirrors models/Referral.ts ReferralStatus which
// has COMPLETED='completed' so that seed scripts and service code stay consistent.
