...
// ============================================================
const FRONTEND_CATEGORIES: Record<
  string,
  {
    name: string;
    keywords: string[];
  ...
  'food-dining': {
    ...
    subcategories: [
      ...
      },
      {
        slug: 'fine-dining',
        name: 'Fine Dining',
        keywords: ['fine dining', 'premium', 'luxury', 'gourmet', 'michelin', 'upscale'],
      },
      {
        slug: 'ice-cream-dessert',
        name: 'Ice Cream & Dessert',
        keywords: ['ice cream', 'dessert', 'gelato', 'sundae', 'waffle', 'pancake', 'frozen', 'kulfi', 'falooda'],
      },
      {
      ...
      },
      {
        slug: 'cloud-kitchens',
        name: 'Cloud Kitchens',
        keywords: ['cloud kitchen', 'delivery only', 'ghost kitchen', 'virtual kitchen', 'online kitchen'],
      },
      {
        slug: 'street-food',
        name: 'Street Food',
    ...
    subcategories: [
      {
        slug: 'supermarkets',
        name: 'Supermarkets',
        keywords: ['supermarket', 'hypermarket', 'departmental', 'mini mart', 'mart', 'mega store'],
      },
      {
        slug: 'kirana-stores',
        name: 'Kirana Stores',
        keywords: ['kirana', 'general store', 'provision', 'neighborhood store', 'corner shop'],
      },
      {
        slug: 'fresh-vegetables',
        name: 'Fresh Vegetables',
        keywords: ['vegetable', 'veggie', 'fresh', 'sabzi', 'organic vegetables', 'fruits'],
      },
      {
        slug: 'meat-fish',
        name: 'Meat & Fish',
        keywords: ['meat', 'fish', 'chicken', 'mutton', 'seafood', 'butcher', 'non veg', 'poultry', 'egg'],
      },
      {
        slug: 'dairy',
        name: 'Dairy',
        keywords: ['dairy', 'milk', 'curd', 'yogurt', 'cheese', 'paneer', 'butter', 'ghee'],
      },
      {
        slug: 'packaged-goods',
        name: 'Packaged Goods',
        keywords: ['packaged', 'branded', 'fmcg', 'snacks', 'chips', 'beverages', 'soft drinks'],
      },
      {
        slug: 'water-cans',
        name: 'Water Cans',
        keywords: ['water', 'water can', 'mineral water', 'drinking water', 'purified'],
      },
    ],
  },
  'beauty-wellness': {
    ...
    subcategories: [
      {
        slug: 'salons',
        name: 'Salons',
        keywords: ['salon', 'hair', 'haircut', 'hair style', 'barber', 'parlour', 'parlor', 'unisex salon'],
      },
      {
        slug: 'spa-massage',
        name: 'Spa & Massage',
        keywords: ['spa', 'massage', 'body massage', 'thai massage', 'ayurvedic', 'relaxation'],
      },
      {
        slug: 'beauty-services',
        name: 'Beauty Services',
        keywords: ['beauty', 'facial', 'wax', 'threading', 'makeup', 'bridal', 'mehndi'],
      },
      {
        slug: 'cosmetology',
        name: 'Cosmetology',
        keywords: ['cosmetology', 'cosmetic', 'aesthetic', 'laser', 'botox'],
      },
      { slug: 'dermatology', name: 'Dermatology', keywords: ['dermatology', 'skin', 'derma', 'acne', 'pigmentation'] },
      {
        ...
        keywords: ['skincare', 'cosmetics', 'cream', 'serum', 'lotion', 'sunscreen', 'makeup products'],
      },
      {
        slug: 'nail-studios',
        name: 'Nail Studios',
        keywords: ['nail', 'manicure', 'pedicure', 'nail art', 'nail studio'],
      },
      {
        slug: 'grooming-men',
        name: 'Grooming for Men',
        keywords: ['grooming', 'men grooming', 'barber', 'shave', 'beard', 'men salon', 'gents'],
      },
    ],
  },
  healthcare: {
    ...
    subcategories: [
      {
        slug: 'pharmacy',
        name: 'Pharmacy',
        keywords: ['pharmacy', 'chemist', 'drugstore', 'medicine', 'medical store'],
      },
      {
        slug: 'clinics',
        name: 'Clinics',
        keywords: ['clinic', 'doctor', 'physician', 'consultation', 'hospital', 'nursing home'],
      },
      {
        slug: 'diagnostics',
        name: 'Diagnostics',
        keywords: ['diagnostic', 'lab', 'pathology', 'blood test', 'x-ray', 'scan', 'mri', 'ultrasound'],
      },
      { slug: 'dental', name: 'Dental', keywords: ['dental', 'dentist', 'tooth', 'teeth', 'orthodontic', 'oral'] },
      {
        slug: 'physiotherapy',
        name: 'Physiotherapy',
        keywords: ['physiotherapy', 'physio', 'rehab', 'rehabilitation', 'physical therapy'],
      },
      {
        slug: 'home-nursing',
        name: 'Home Nursing',
        keywords: ['nursing', 'home care', 'home nurse', 'attendant', 'caretaker'],
      },
      {
        slug: 'vision-eyewear',
        name: 'Vision & Eyewear',
        keywords: ['eye', 'eyewear', 'optical', 'glasses', 'lens', 'contact lens', 'vision', 'optician'],
      },
    ],
  },
  fashion: {
    ...
    subcategories: [
      {
        slug: 'footwear',
        name: 'Footwear',
        keywords: ['footwear', 'shoe', 'sneaker', 'sandal', 'slipper', 'boot', 'heel', 'chappal'],
      },
      {
        slug: 'bags-accessories',
        name: 'Bags & Accessories',
        keywords: ['bag', 'handbag', 'purse', 'backpack', 'luggage', 'accessories', 'belt', 'scarf', 'sunglasses'],
      },
      {
        slug: 'mobile-accessories',
        name: 'Mobile Accessories',
        keywords: ['mobile accessories', 'phone cover', 'case', 'screen guard', 'charger', 'earphone', 'power bank'],
      },
      ...
      },
      {
        slug: 'local-brands',
        name: 'Local Brands',
        keywords: ['local brand', 'boutique', 'designer', 'indie', 'handmade', 'artisan'],
      },
    ],
  },
  'fitness-sports': {
    ...
    subcategories: [
      ...
      { slug: 'zumba', name: 'Zumba', keywords: ['zumba', 'dance fitness', 'aerobics', 'cardio dance'] },
      {
        slug: 'martial-arts',
        name: 'Martial Arts',
        keywords: ['martial arts', 'karate', 'taekwondo', 'boxing', 'mma', 'kung fu', 'judo', 'self defense'],
      },
      {
      ...
      },
      {
        slug: 'sportswear',
        name: 'Sportswear',
        keywords: ['sportswear', 'sports gear', 'athletic', 'activewear', 'sports equipment'],
      },
    ],
  },
  'education-learning': {
    ...
    subcategories: [
      {
        ...
        keywords: ['coaching', 'tuition', 'iit', 'neet', 'competitive', 'entrance', 'exam prep'],
      },
      {
        slug: 'skill-development',
        name: 'Skill Development',
        keywords: ['skill', 'development', 'computer', 'coding', 'programming', 'digital', 'soft skill'],
      },
      {
      ...
      },
      {
        slug: 'art-craft',
        name: 'Art & Craft',
        keywords: ['art', 'craft', 'painting', 'drawing', 'sketch', 'pottery', 'sculpture'],
      },
      {
        slug: 'vocational',
        name: 'Vocational',
        keywords: ['vocational', 'diploma', 'certification', 'technical', 'trade'],
      },
      {
        slug: 'language-training',
        name: 'Language Training',
        keywords: ['language', 'english', 'spoken english', 'ielts', 'toefl', 'french', 'german', 'spanish', 'hindi'],
      },
    ],
  },
  'home-services': {
    ...
    subcategories: [
      {
        slug: 'ac-repair',
        name: 'AC Repair',
        keywords: ['ac', 'air conditioner', 'ac repair', 'ac service', 'hvac', 'cooling'],
      },
      { slug: 'plumbing', name: 'Plumbing', keywords: ['plumbing', 'plumber', 'pipe', 'tap', 'leakage', 'drainage'] },
      {
        slug: 'electrical',
        name: 'Electrical',
        keywords: ['electrical', 'electrician', 'wiring', 'switch', 'fan', 'light'],
      },
      {
        slug: 'cleaning',
        name: 'Cleaning',
        keywords: ['cleaning', 'deep cleaning', 'house cleaning', 'sanitization', 'disinfection'],
      },
      {
        slug: 'pest-control',
        name: 'Pest Control',
        keywords: ['pest', 'pest control', 'termite', 'cockroach', 'mosquito', 'fumigation'],
      },
      {
        slug: 'house-shifting',
        name: 'House Shifting',
        keywords: ['shifting', 'movers', 'packers', 'relocation', 'transport', 'moving'],
      },
      {
        slug: 'laundry-dry-cleaning',
        name: 'Laundry & Dry Cleaning',
        keywords: ['laundry', 'dry cleaning', 'ironing', 'pressing', 'wash', 'steam'],
      },
    ...
    subcategories: [
      {
        slug: 'hotels',
        name: 'Hotels',
        keywords: ['hotel', 'resort', 'lodge', 'inn', 'motel', 'guest house', 'hostel', 'homestay', 'oyo'],
      },
      {
        slug: 'intercity-travel',
        name: 'Intercity Travel',
        keywords: ['intercity', 'bus', 'train', 'flight', 'long distance', 'outstation'],
      },
      { slug: 'taxis', name: 'Taxis', keywords: ['taxi', 'cab', 'car rental', 'ride', 'uber', 'ola', 'driver'] },
      {
        slug: 'bike-rentals',
        name: 'Bike Rentals',
        keywords: ['bike rental', 'scooter', 'motorcycle', 'two wheeler', 'rent a bike'],
      },
      {
        slug: 'weekend-getaways',
        name: 'Weekend Getaways',
        keywords: ['weekend', 'getaway', 'staycation', 'short trip', 'day trip'],
      },
      {
        slug: 'tours',
        name: 'Tours',
        keywords: ['tour', 'travel package', 'sightseeing', 'guide', 'excursion', 'pilgrimage'],
      },
      {
        slug: 'activities',
        name: 'Activities',
        keywords: ['activity', 'adventure', 'trekking', 'camping', 'rafting', 'paragliding', 'bungee'],
      },
    ],
  },
  entertainment: {
    ...
    subcategories: [
      {
        slug: 'movies',
        name: 'Movies',
        keywords: ['movie', 'cinema', 'theatre', 'theater', 'multiplex', 'film', 'imax', 'pvr', 'inox'],
      },
      {
        slug: 'live-events',
        name: 'Live Events',
        keywords: ['live event', 'concert', 'show', 'standup', 'comedy', 'performance', 'music show'],
      },
      ...
      { slug: 'workshops', name: 'Workshops', keywords: ['workshop', 'masterclass', 'seminar', 'interactive session'] },
      {
        ...
        keywords: ['amusement', 'theme park', 'water park', 'fun zone', 'rides'],
      },
      {
        slug: 'gaming-cafes',
        name: 'Gaming Cafés',
        keywords: ['gaming', 'game cafe', 'esports', 'arcade', 'playstation', 'xbox', 'pc gaming'],
      },
      {
        slug: 'vr-ar-experiences',
        name: 'VR/AR Experiences',
        keywords: ['vr', 'virtual reality', 'ar', 'augmented reality', 'immersive'],
      },
    ],
  },
  'financial-lifestyle': {
    ...
    subcategories: [
      {
        slug: 'bill-payments',
        name: 'Bill Payments',
        keywords: ['bill', 'electricity', 'gas', 'water bill', 'utility', 'payment'],
      },
      {
        slug: 'mobile-recharge',
        name: 'Mobile Recharge',
        keywords: ['recharge', 'mobile recharge', 'prepaid', 'postpaid', 'data pack'],
      },
      { slug: 'broadband', name: 'Broadband', keywords: ['broadband', 'internet', 'wifi', 'fiber', 'connection'] },
      {
        slug: 'cable-ott',
        name: 'Cable/OTT',
        keywords: ['cable', 'ott', 'streaming', 'dth', 'dish', 'netflix', 'hotstar'],
      },
      {
        slug: 'insurance',
        name: 'Insurance',
        keywords: ['insurance', 'life insurance', 'health insurance', 'motor insurance', 'policy'],
      },
      {
        slug: 'gold-savings',
        name: 'Gold Savings',
        keywords: ['gold', 'savings', 'gold savings', 'digital gold', 'investment'],
      },
      {
        slug: 'donations',
        name: 'Donations',
        keywords: ['donation', 'charity', 'ngo', 'social cause', 'fund', 'contribute'],
      },
    ],
  },
  electronics: {
    ...
    subcategories: [
      {
        slug: 'mobile-phones',
        name: 'Mobile Phones',
        keywords: ['mobile', 'phone', 'smartphone', 'iphone', 'samsung', 'android', 'cell phone'],
      },
      {
        slug: 'laptops',
        name: 'Laptops',
        keywords: ['laptop', 'notebook', 'macbook', 'chromebook', 'ultrabook', 'computer', 'pc', 'desktop'],
      },
      ...
      { slug: 'cameras', name: 'Cameras', keywords: ['camera', 'dslr', 'mirrorless', 'gopro', 'photography', 'lens'] },
      {
        ...
        keywords: ['audio', 'headphone', 'earphone', 'speaker', 'bluetooth', 'soundbar', 'earbuds', 'airpods'],
      },
      {
        slug: 'gaming',
        name: 'Gaming',
        keywords: ['gaming', 'console', 'playstation', 'xbox', 'nintendo', 'gaming laptop', 'gaming pc'],
      },
      {
        slug: 'accessories',
        name: 'Accessories',
        keywords: ['accessories', 'cable', 'adapter', 'hub', 'charger', 'mouse', 'keyboard', 'pendrive', 'hard disk'],
      },
      {
        slug: 'smartwatches',
        name: 'Smartwatches',
        keywords: ['smartwatch', 'smart watch', 'fitness band', 'apple watch', 'galaxy watch', 'wearable'],
      },
    ],
  },
};
...
async function linkStoresToCategories() {
  try {
    logger.info('🚀 Starting Store-Category Linking...');
    ...
    logger.info('📦 Loading frontend categories from DB...\n');
    ...
    for (const slug of frontendMainSlugs) {
      ...
      if (cat) {
        ...
        logger.info(`   ⚠️ Main category '${slug}' not found in DB!`);
      }
    }
    ...
    logger.info(`   Found ${Object.keys(mainCatMap).length} main categories`);
    logger.info(`   Found ${Object.keys(subCatMap).length} subcategories\n`);
    ...
    logger.info('========================================');
    logger.info('🔍 STORE → CATEGORY MAPPING ANALYSIS');
    logger.info('========================================\n');
    ...
    for (const store of stores) {
      ...
      mappings.push({
        ...
        newSubCat: subMatch
          ? FRONTEND_CATEGORIES[mainMatch.slug].subcategories.find((s) => s.slug === subMatch.slug)?.name || null
          : null,
    ...
    for (const [mainSlug, storeMappings] of Object.entries(byMainCat)) {
      ...
      for (const m of storeMappings) {
        ...
        logger.info(`   ${status} ${m.storeName}${subInfo}${currentInfo} (score: ${m.mainScore}/${m.subScore})`);
      }
    }
    ...
    logger.info('📊 SUMMARY');
    logger.info('========================================');
    logger.info(`Total active stores: ${stores.length}`);
    logger.info(`Already linked to frontend categories: ${alreadyLinkedCount}`);
    logger.info(`Need linking: ${needsLinkingCount}`);
    logger.info(`No match found: ${unmatchedCount}`);
    logger.info('========================================\n');

    // ---- Step 6: Perform Migration ----
    if (needsLinkingCount === 0 && unmatchedCount === 0) {
      logger.info('✅ All stores are already linked! Nothing to do.\n');
    } else {
      ...
      for (const m of mappings) {
        ...
        if (!mainCatId) {
          logger.info(`   ⚠️ Skipping "${m.storeName}" — main cat ID not found for ${m.newMainCatSlug}`);
          errorCount++;
          continue;
        }
        ...
        if (m.newSubCatSlug && subCatMap[m.newSubCatSlug]) {
          ...
          const alreadyHasSub = existingSubCats.some((id: any) => id.toString() === newSubCatId.toString());
        ...
        try {
          await storesCol.updateOne({ _id: m.storeId }, { $set: updateFields });
          updatedCount++;
          logger.info(`   ✅ Linked: "${m.storeName}" → ${m.newMainCat}${m.newSubCat ? ` > ${m.newSubCat}` : ''}`);
        } catch (err: any) {
          errorCount++;
          logger.info(`   ❌ Error linking "${m.storeName}": ${err.message}`);
        }
      }
      ...
      logger.info(`Skipped (already linked): ${skippedCount}`);
    ...
    for (const [slug, config] of Object.entries(FRONTEND_CATEGORIES)) {
      ...
      for (const sub of config.subcategories) {
        ...
        const count = await storesCol.countDocuments({
          isActive: true,
          $or: [{ subCategories: subCatId }, { category: subCatId }],
        });
        if (count > 0) {
      ...
      logger.info(`📁 ${config.name} (${slug}): ${mainCount} stores`);
