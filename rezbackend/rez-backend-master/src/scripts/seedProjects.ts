...
async function seedProjects() {
  try {
    ...
    if (users.length === 0) {
      logger.info('❌ Please run basic seeding first (users)');
      process.exit(1);
    }

    logger.info(`Found ${users.length} users, ${stores.length} stores, ${products.length} products`);

    // Clear existing projects
    await Project.deleteMany({});
    logger.info('🗑️  Cleared existing projects');
    ...
    const projects = [
      {
        ...
        description:
          "We're launching a new line of organic beauty products and need your honest reviews! Try our products and share your experience in a detailed video review.",
      ...
      },
      {
        ...
        description:
          'Show off your best fashion looks! Create content featuring your favorite outfits from our store and inspire others with your style.',
      ...
      },
      {
        ...
        description:
          "We've opened a new store in your area! Be one of the first to visit, explore our offerings, and share your experience.",
      ...
      },
      {
        ...
        description:
          'We need authentic user-generated content! Create engaging videos showcasing how you use our products in your daily life.',
      ...
      },
      {
        ...
        description:
          'Help us understand your shopping habits! Complete a 10-question survey about your preferences and shopping behavior.',
      ...
      },
      {
        ...
        description:
          'Love our app? Share it with your friends! For every friend who signs up using your referral code and makes their first purchase, you earn ₹100.',
    ...
    for (let i = 0; i < createdProjects.length; i++) {
      ...
      logger.info(`  ${i + 1}. "${project.title}"`);
      logger.info(`     💰 ₹${project.reward.amount} • ⏱️  ${project.estimatedTime}min • 🎯 ${project.difficulty}`);
      logger.info(
        `     📊 ${project.analytics.totalSubmissions} submissions • ${project.analytics.approvalRate.toFixed(1)}% approval rate`,
      );
    }
