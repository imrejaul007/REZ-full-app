...
async function seedVideos() {
  try {
    logger.info('🚀 Starting Video seeding...');
    ...
    logger.info(`Found ${users.length} users, ${products.length} products`);

    // Clear existing videos
    await Video.deleteMany({});
    logger.info('🗑️  Cleared existing videos');
    ...
    const videos = [
      {
        ...
        description:
          'In-depth review of the iPhone 15 Pro covering camera, performance, battery life, and whether you should upgrade from your current phone.',
        creator: users[0]._id,
      ...
      },
      {
        ...
        description:
          'Latest fashion trends for Spring 2025! From oversized blazers to statement accessories, showing you everything trending this season.',
      ...
      },
      {
        ...
        description:
          'Get your sweat on with this intense 20-minute HIIT workout that requires zero equipment! Perfect for burning fat and building endurance at home.',
        creator: users[0]._id,
      ...
      },
      {
        ...
        description:
          'Join me on the ultimate Mumbai street food adventure! Trying the most famous vada pav, bhel puri, and pani puri spots across the city.',
        creator: users[1] ? users[1]._id : users[0]._id,
      ...
      },
      {
        ...
        description:
          'Transform your space without breaking the bank! 5 simple DIY home decor projects that will give your room a complete makeover for under ₹1000.',
        creator: users[0]._id,
      ...
      },
      {
        ...
        description:
          'Complete beginner guide to cryptocurrency! Everything you need to know about Bitcoin, Ethereum, and how to get started safely.',
        creator: users[1] ? users[1]._id : users[0]._id,
    ...
    for (let i = 0; i < createdVideos.length; i++) {
      ...
      logger.info(`  ${i + 1}. "${video.title}" by ${userName}`);
      logger.info(
        `     📹 ${duration}m • 👀 ${video.engagement.views} views • ❤️ ${video.engagement.likes.length} likes`,
      );
    }
