...
const PRODUCT_TEMPLATES: Record<string, ProductTemplate[]> = {
  ...
  cafes: [
    // Espresso-based drinks
    {
      ...
      priceRange: [150, 220],
      subSubCategory: 'Espresso-based drinks',
    ...
    // Tea (Chai/Herbal)
    {
      ...
      priceRange: [60, 100],
      subSubCategory: 'Tea (Chai/Herbal)',
      tags: ['tea', 'indian', 'spiced'],
    ...
    // Breakfast Items
    {
      ...
      priceRange: [180, 280],
      subSubCategory: 'Breakfast Items',
    ...
    },
    {
      ...
      priceRange: [220, 320],
      subSubCategory: 'Breakfast Items',
      tags: ['breakfast', 'eggs', 'premium'],
      image: 'https://images.unsplash.com/photo-1608039829572-9b0e1347eca2?w=400',
    },
    // Sandwiches
    {
      name: 'Club Sandwich',
    ...
    },
    {
      ...
      priceRange: [120, 180],
      subSubCategory: 'Sandwiches',
      tags: ['sandwich', 'cheese', 'vegetarian'],
    ...
    // All-day brunch
    {
      ...
      description: 'Eggs, bacon, sausage, beans, toast, mushrooms',
      priceRange: [280, 380],
      subSubCategory: 'All-day brunch',
      tags: ['brunch', 'english', 'hearty'],
  ...
  'qsr-fast-food': [
    ...
    // Wraps/Rolls
    {
      ...
      priceRange: [120, 180],
      subSubCategory: 'Wraps/Rolls',
      tags: ['wrap', 'chicken', 'quick'],
      image: 'https://images.unsplash.com/photo-1626700051175-6818013e1d4f?w=400',
    },
    {
      name: 'Paneer Roll',
      description: 'Spiced cottage cheese in paratha',
      priceRange: [100, 160],
      subSubCategory: 'Wraps/Rolls',
      tags: ['roll', 'paneer', 'indian'],
      image: 'https://images.unsplash.com/photo-1606755962773-d324e0a13086?w=400',
    },
    {
      name: 'Egg Roll',
      description: 'Egg stuffed roll with chutney',
      priceRange: [80, 140],
      subSubCategory: 'Wraps/Rolls',
      tags: ['roll', 'egg', 'street-food'],
    ...
    // Fried Chicken
    {
      ...
      priceRange: [350, 500],
      subSubCategory: 'Fried Chicken',
      tags: ['chicken', 'fried', 'bucket'],
    ...
    },
    {
      ...
      priceRange: [150, 220],
      subSubCategory: 'Fried Chicken',
      tags: ['chicken', 'popcorn', 'snack'],
      image: 'https://images.unsplash.com/photo-1562967914-608f82629710?w=400',
    },
    // Momos
    {
      name: 'Steamed Veg Momos',
      description: 'Soft steamed vegetable dumplings',
      priceRange: [80, 120],
      subSubCategory: 'Momos',
      tags: ['momos', 'vegetarian', 'steamed'],
      image: 'https://images.unsplash.com/photo-1534422298391-e4f8c172dddb?w=400',
    },
    {
      name: 'Fried Chicken Momos',
      description: 'Crispy fried chicken dumplings',
      priceRange: [100, 150],
      subSubCategory: 'Momos',
      tags: ['momos', 'chicken', 'fried'],
  ...
  'family-restaurants': [
    ...
    // South Indian
    {
      ...
      priceRange: [100, 160],
      subSubCategory: 'South Indian',
      tags: ['dosa', 'breakfast', 'crispy'],
    ...
    },
    {
      ...
      description: 'Complete meal with rice, sambar, rasam, curries',
      priceRange: [180, 280],
      subSubCategory: 'South Indian',
    ...
    // Chinese/Asian
    {
      ...
      priceRange: [160, 240],
      subSubCategory: 'Chinese/Asian',
      tags: ['noodles', 'chinese', 'vegetarian'],
    ...
    },
    {
      ...
      priceRange: [180, 260],
      subSubCategory: 'Chinese/Asian',
      tags: ['manchurian', 'indo-chinese', 'spicy'],
      image: 'https://images.unsplash.com/photo-1625220194771-7ebdea0b70b9?w=400',
    },
    {
      name: 'Fried Rice',
    ...
    // Multicuisine
    {
      ...
      description: 'Variety platter for 4 with rotis, rice, curries',
      priceRange: [600, 900],
      subSubCategory: 'Multicuisine',
  ...
  'fine-dining': [
    // Continental
    {
      ...
      priceRange: [800, 1200],
      subSubCategory: 'Continental',
      tags: ['salmon', 'grilled', 'premium'],
    ...
    // Modern Indian
    {
      name: 'Deconstructed Biryani',
      description: 'Modern take on classic biryani with saffron foam',
      priceRange: [600, 900],
      subSubCategory: 'Modern Indian',
      tags: ['biryani', 'modern', 'fusion'],
      image: 'https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8?w=400',
    },
    {
      name: 'Butter Chicken Sphere',
      description: 'Molecular gastronomy butter chicken',
      priceRange: [550, 800],
      subSubCategory: 'Modern Indian',
      tags: ['chicken', 'molecular', 'innovative'],
      image: 'https://images.unsplash.com/photo-1603894584373-5ac82b2ae398?w=400',
    },
    // Italian (Gourmet)
    {
      ...
      priceRange: [700, 1100],
      subSubCategory: 'Italian (Gourmet)',
      tags: ['risotto', 'truffle', 'italian'],
      image: 'https://images.unsplash.com/photo-1476124369491-e7addf5db371?w=400',
    },
    {
      name: 'Lobster Pasta',
      description: 'Fresh lobster with linguine in bisque',
      priceRange: [1000, 1500],
      subSubCategory: 'Italian (Gourmet)',
      tags: ['lobster', 'pasta', 'premium'],
    ...
    // Japanese (Sushi/Teppanyaki)
    {
      ...
      priceRange: [800, 1400],
      subSubCategory: 'Japanese (Sushi/Teppanyaki)',
      tags: ['sushi', 'japanese', 'raw'],
      image: 'https://images.unsplash.com/photo-1579871494447-9811cf80d66c?w=400',
    },
    {
      name: 'Teppanyaki Set',
      description: 'Live grilled seafood and vegetables',
      priceRange: [1200, 1800],
      subSubCategory: 'Japanese (Sushi/Teppanyaki)',
      tags: ['teppanyaki', 'grilled', 'experience'],
      image: 'https://images.unsplash.com/photo-1540648639573-8c848de23f0a?w=400',
    },
    // Mediterranean
    {
      name: 'Mezze Platter',
      ...
      priceRange: [500, 800],
      subSubCategory: 'Mediterranean',
      tags: ['mezze', 'mediterranean', 'sharing'],
  ...
  'ice-cream-dessert': [
    // Gelato
    {
      ...
      priceRange: [120, 180],
      subSubCategory: 'Gelato',
      tags: ['gelato', 'pistachio', 'italian'],
    ...
    // Shakes
    {
      ...
      priceRange: [150, 220],
      subSubCategory: 'Shakes',
      tags: ['shake', 'chocolate', 'thick'],
      image: 'https://images.unsplash.com/photo-1572490122747-3968b75cc699?w=400',
    },
    {
      name: 'Oreo Shake',
      description: 'Creamy shake loaded with Oreo cookies',
      priceRange: [180, 250],
      subSubCategory: 'Shakes',
      tags: ['shake', 'oreo', 'cookies'],
    ...
    },
    {
      ...
      priceRange: [140, 200],
      subSubCategory: 'Shakes',
      tags: ['shake', 'strawberry', 'fruity'],
      image: 'https://images.unsplash.com/photo-1579954115545-a95591f28bfc?w=400',
    },
    // Sundaes
    {
      name: 'Hot Fudge Sundae',
      description: 'Vanilla ice cream with hot chocolate fudge',
      priceRange: [180, 280],
      subSubCategory: 'Sundaes',
      tags: ['sundae', 'fudge', 'hot'],
    ...
    },
    {
      ...
      priceRange: [220, 320],
      subSubCategory: 'Sundaes',
      tags: ['sundae', 'banana', 'classic'],
      image: 'https://images.unsplash.com/photo-1570197788417-0e82375c9371?w=400',
    },
    // Indian Desserts (Kulfi)
    {
      name: 'Malai Kulfi',
      description: 'Traditional creamy Indian ice cream',
      priceRange: [80, 120],
      subSubCategory: 'Indian Desserts (Kulfi)',
      tags: ['kulfi', 'indian', 'traditional'],
      image: 'https://images.unsplash.com/photo-1567206563064-6f60f40a2b57?w=400',
    },
    {
      name: 'Paan Kulfi',
      description: 'Betel leaf flavored kulfi',
      priceRange: [90, 140],
      subSubCategory: 'Indian Desserts (Kulfi)',
      tags: ['kulfi', 'paan', 'unique'],
      image: 'https://images.unsplash.com/photo-1551024506-0bccd828d307?w=400',
    },
    {
      name: 'Kesar Pista Kulfi',
      description: 'Saffron and pistachio kulfi',
      priceRange: [100, 150],
      subSubCategory: 'Indian Desserts (Kulfi)',
      tags: ['kulfi', 'saffron', 'premium'],
  ...
  'bakery-confectionery': [
    // Cakes & Pastries
    {
      ...
      description: 'Classic chocolate cake with cherries',
      priceRange: [400, 800],
      subSubCategory: 'Cakes & Pastries',
      tags: ['cake', 'chocolate', 'cherry'],
    ...
    },
    {
      ...
      priceRange: [500, 900],
      subSubCategory: 'Cakes & Pastries',
      tags: ['cake', 'red-velvet', 'cream-cheese'],
    ...
    // Bread (Sourdough/Rye)
    {
      ...
      priceRange: [150, 250],
      subSubCategory: 'Bread (Sourdough/Rye)',
    ...
    // Cookies & Brownies
    {
      ...
      priceRange: [80, 150],
      subSubCategory: 'Cookies & Brownies',
      tags: ['cookies', 'chocolate', 'classic'],
    ...
    {
      name: 'Glazed Donuts',
      description: 'Classic glazed ring donuts',
      priceRange: [60, 100],
      subSubCategory: 'Donuts',
      tags: ['donuts', 'glazed', 'classic'],
      image: 'https://images.unsplash.com/photo-1551024601-bec78aea704b?w=400',
    },
    {
      name: 'Chocolate Donuts',
      description: 'Chocolate frosted donuts',
      priceRange: [80, 120],
      subSubCategory: 'Donuts',
      tags: ['donuts', 'chocolate', 'frosted'],
    ...
    // Indian Sweets (Mithai)
    {
      ...
      priceRange: [150, 300],
      subSubCategory: 'Indian Sweets (Mithai)',
      tags: ['mithai', 'gulab-jamun', 'traditional'],
      image: 'https://images.unsplash.com/photo-1666190050371-bc5ed5c6d265?w=400',
    },
    {
      name: 'Kaju Katli',
    ...
    },
    {
      ...
      priceRange: [200, 400],
      subSubCategory: 'Indian Sweets (Mithai)',
      tags: ['mithai', 'rasgulla', 'bengali'],
      image: 'https://images.unsplash.com/photo-1601303516150-0f4a5f1c82f8?w=400',
    },
  ],
  ...
  'cloud-kitchens': [
    // Biryani
    {
      ...
      priceRange: [250, 380],
      subSubCategory: 'Biryani',
      tags: ['biryani', 'hyderabadi', 'chicken'],
      image: 'https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8?w=400',
    },
    {
    ...
    // Health & Salad Bowls
    {
      ...
      priceRange: [280, 380],
      subSubCategory: 'Health & Salad Bowls',
      tags: ['healthy', 'quinoa', 'bowl'],
    ...
    // Meal Boxes
    {
      ...
      description: 'High protein meal with chicken, rice, veggies',
      priceRange: [220, 320],
      subSubCategory: 'Meal Boxes',
      tags: ['meal-box', 'protein', 'fitness'],
      image: 'https://images.unsplash.com/photo-1484980972926-edee96e0960d?w=400',
    },
    {
      name: 'Office Lunch Box',
      description: 'Balanced meal for office lunch',
      priceRange: [180, 260],
      subSubCategory: 'Meal Boxes',
      tags: ['meal-box', 'lunch', 'office'],
  ...
  'street-food': [
    // Chaat (Pani Puri/Bhel)
    {
      ...
      priceRange: [40, 80],
      subSubCategory: 'Chaat (Pani Puri/Bhel)',
      tags: ['chaat', 'pani-puri', 'tangy'],
    ...
    },
    {
      ...
      priceRange: [50, 90],
      subSubCategory: 'Chaat (Pani Puri/Bhel)',
      tags: ['chaat', 'bhel', 'crunchy'],
      image: 'https://images.unsplash.com/photo-1601050690597-df0568f70950?w=400',
    },
    {
      name: 'Sev Puri',
      description: 'Crispy puris with sev and chutneys',
      priceRange: [60, 100],
      subSubCategory: 'Chaat (Pani Puri/Bhel)',
      tags: ['chaat', 'sev', 'crispy'],
    ...
    // Vada Pav
    {
      ...
      priceRange: [30, 60],
      subSubCategory: 'Vada Pav',
      tags: ['vada-pav', 'mumbai', 'street-food'],
      image: 'https://images.unsplash.com/photo-1606491956689-2ea866880c84?w=400',
    },
    {
      name: 'Cheese Vada Pav',
      description: 'Vada pav with melted cheese',
      priceRange: [50, 80],
      subSubCategory: 'Vada Pav',
      tags: ['vada-pav', 'cheese', 'fusion'],
      image: 'https://images.unsplash.com/photo-1606491956689-2ea866880c84?w=400',
    },
    // Pav Bhaji
    {
      name: 'Butter Pav Bhaji',
      description: 'Spiced mashed veggies with buttered bread',
      priceRange: [80, 140],
      subSubCategory: 'Pav Bhaji',
      tags: ['pav-bhaji', 'butter', 'mumbai'],
      image: 'https://images.unsplash.com/photo-1606491956689-2ea866880c84?w=400',
    },
    // Local Snacks (Bajji/Bonda)
    {
      ...
      priceRange: [40, 70],
      subSubCategory: 'Local Snacks (Bajji/Bonda)',
      tags: ['bajji', 'onion', 'crispy'],
      image: 'https://images.unsplash.com/photo-1601050690597-df0568f70950?w=400',
    },
    {
      name: 'Mysore Bonda',
      description: 'Spiced lentil balls, deep fried',
      priceRange: [40, 70],
      subSubCategory: 'Local Snacks (Bajji/Bonda)',
      tags: ['bonda', 'mysore', 'snack'],
      image: 'https://images.unsplash.com/photo-1567337710282-00832b415979?w=400',
    },
    {
      name: 'Samosa',
  ...
  supermarkets: [
    ...
    },
    {
      ...
      description: 'Assorted Lays chips pack',
      priceRange: [100, 180],
      subSubCategory: 'Packaged Foods',
      tags: ['chips', 'snacks', 'combo'],
      image: 'https://images.unsplash.com/photo-1566478989037-eec170784d0b?w=400',
    },
    {
      name: 'Vim Dishwash Bar',
      description: 'Effective dish cleaning bar',
      priceRange: [40, 70],
      subSubCategory: 'Household Goods',
    ...
    },
    {
      ...
      priceRange: [250, 350],
      subSubCategory: 'Personal Care',
      tags: ['shampoo', 'haircare', 'dove'],
  ...
  'kirana-stores': [
    ...
    },
    {
      ...
      priceRange: [350, 500],
      subSubCategory: 'Oils & Ghee',
      tags: ['ghee', 'traditional', 'pure'],
      image: 'https://images.unsplash.com/photo-1631515242808-497c3fbd4c22?w=400',
    },
  ],
  ...
  dairy: [
    ...
    },
    {
      ...
      priceRange: [120, 180],
      subSubCategory: 'Yogurt/Curd',
      tags: ['yogurt', 'greek', 'protein'],
      image: 'https://images.unsplash.com/photo-1488477181946-6428a0291777?w=400',
    },
    {
      name: 'Fresh Curd 500g',
      description: 'Homestyle fresh curd',
      priceRange: [40, 60],
      subSubCategory: 'Yogurt/Curd',
      tags: ['curd', 'fresh', 'probiotic'],
      image: 'https://images.unsplash.com/photo-1571211905393-6de67ff8fb61?w=400',
    },
    {
      name: 'Amul Cheese Slices',
      description: 'Processed cheese slices',
      priceRange: [100, 150],
      subSubCategory: 'Cheese',
      tags: ['cheese', 'slices', 'amul'],
    ...
    },
    {
      ...
      priceRange: [80, 120],
      subSubCategory: 'Paneer',
      tags: ['paneer', 'fresh', 'protein'],
      image: 'https://images.unsplash.com/photo-1631452180519-c014fe946bc7?w=400',
    },
    {
  ...
  'water-cans': [
    {
      name: 'Bisleri 20L Can',
      description: 'Packaged drinking water 20 liters',
      priceRange: [80, 120],
      subSubCategory: '20L Can',
      tags: ['water', '20l', 'bisleri'],
      image: 'https://images.unsplash.com/photo-1548839140-29a749e1cf4d?w=400',
    },
    {
      name: 'Aquafina 20L Can',
      description: 'Purified water 20 liters',
      priceRange: [70, 100],
      subSubCategory: '20L Can',
      tags: ['water', '20l', 'aquafina'],
      image: 'https://images.unsplash.com/photo-1548839140-29a749e1cf4d?w=400',
    },
    {
      name: 'Kinley 1L Bottle',
      description: 'Packaged drinking water',
      priceRange: [20, 30],
      subSubCategory: 'Small Bottles (1L/500ml)',
      tags: ['water', '1l', 'kinley'],
      image: 'https://images.unsplash.com/photo-1560023907-5f339617ea30?w=400',
    },
    {
      name: 'Bailley 500ml Pack of 24',
      description: 'Small water bottles pack',
      priceRange: [200, 280],
      subSubCategory: 'Small Bottles (1L/500ml)',
      tags: ['water', '500ml', 'pack'],
      image: 'https://images.unsplash.com/photo-1560023907-5f339617ea30?w=400',
    },
  ],
  ...
  salons: [
    {
      ...
      priceRange: [200, 400],
      subSubCategory: 'Haircuts & Styling',
    ...
    },
    {
      ...
      description: 'Haircut with blow dry styling',
      priceRange: [400, 800],
      subSubCategory: 'Haircuts & Styling',
    ...
    },
    {
      ...
      subSubCategory: 'Hair Colouring',
      tags: ['color', 'hair', 'global'],
    ...
    },
    {
      ...
      subSubCategory: 'Hair Colouring',
      tags: ['highlights', 'hair', 'color'],
      image: 'https://images.unsplash.com/photo-1519699047748-de8e457a634e?w=400',
    },
    {
      name: 'Keratin Treatment',
      description: 'Hair smoothening treatment',
      priceRange: [3000, 8000],
      subSubCategory: 'Keratin/Smoothening',
      tags: ['keratin', 'smoothening', 'treatment'],
      image: 'https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?w=400',
    },
    {
      name: 'Gold Facial',
      ...
      priceRange: [800, 1500],
      subSubCategory: 'Facials',
      tags: ['facial', 'gold', 'luxury'],
      image: 'https://images.unsplash.com/photo-1570172619644-dfd03ed5d881?w=400',
    },
    {
      name: 'Fruit Facial',
      description: 'Refreshing fruit-based facial',
      priceRange: [500, 900],
      subSubCategory: 'Facials',
      tags: ['facial', 'fruit', 'natural'],
  ...
  'spa-massage': [
    {
      ...
      subSubCategory: 'Swedish Massage',
    ...
    },
    {
      ...
      subSubCategory: 'Aromatherapy',
      tags: ['aromatherapy', 'essential-oils', 'relaxing'],
    ...
    },
    {
      ...
      priceRange: [2000, 3500],
      subSubCategory: 'Ayurvedic Treatments',
      tags: ['ayurveda', 'abhyanga', 'traditional'],
    ...
    },
    {
      ...
      priceRange: [800, 1500],
      subSubCategory: 'Reflexology',
      tags: ['reflexology', 'foot', 'pressure-points'],
      image: 'https://images.unsplash.com/photo-1519823551278-64ac92734fb1?w=400',
    },
  ],
  ...
  'beauty-services': [
    {
      ...
      description: 'Complete arms hair removal',
      priceRange: [300, 500],
      subSubCategory: 'Waxing & Threading',
      tags: ['waxing', 'arms', 'hair-removal'],
      image: 'https://images.unsplash.com/photo-1570172619644-dfd03ed5d881?w=400',
    },
    {
    ...
    },
    {
      ...
      priceRange: [400, 700],
      subSubCategory: 'Manicure & Pedicure',
    ...
    },
    {
      ...
      subSubCategory: 'Bridal Makeup',
      tags: ['bridal', 'makeup', 'wedding'],
      image: 'https://images.unsplash.com/photo-1487412720507-e7ab37603c6f?w=400',
    },
    {
      name: 'Eyelash Extensions',
      description: 'Semi-permanent lash extensions',
      priceRange: [2000, 5000],
      subSubCategory: 'Eyelash Extensions',
      tags: ['eyelash', 'extensions', 'beauty'],
  ...
  pharmacy: [
    {
      ...
      priceRange: [20, 40],
      subSubCategory: 'Over-the-Counter (OTC)',
      tags: ['medicine', 'paracetamol', 'fever'],
    ...
    },
    {
      ...
      priceRange: [200, 500],
      subSubCategory: 'Vitamins & Supplements',
    ...
    },
    {
      ...
      priceRange: [250, 450],
      subSubCategory: 'Vitamins & Supplements',
      tags: ['vitamin-d', 'supplements', 'bones'],
      image: 'https://images.unsplash.com/photo-1584308666744-24d5c474f2ae?w=400',
    },
    {
  ...
  'vision-eyewear': [
    {
      ...
      subSubCategory: 'Prescription Eyeglasses',
      tags: ['glasses', 'prescription', 'vision'],
      image: 'https://images.unsplash.com/photo-1574258495973-f010dfbb5371?w=400',
    },
    {
      name: 'Progressive Lenses',
      description: 'Multifocal progressive glasses',
      priceRange: [3000, 8000],
      subSubCategory: 'Prescription Eyeglasses',
      tags: ['progressive', 'multifocal', 'premium'],
    ...
    {
      name: 'Daily Contact Lenses 30pc',
      description: 'Disposable daily lenses',
      priceRange: [800, 1500],
      subSubCategory: 'Contact Lenses',
      tags: ['contacts', 'daily', 'disposable'],
      image: 'https://images.unsplash.com/photo-1583001931096-959e9a1a6223?w=400',
    },
    {
      name: 'Eye Checkup',
      ...
      priceRange: [300, 800],
      subSubCategory: 'Eye Checkups',
      tags: ['checkup', 'eye-exam', 'vision'],
  ...
  gyms: [
    {
      ...
      priceRange: [1500, 3500],
      subSubCategory: 'Weight Training',
      tags: ['gym', 'membership', 'fitness'],
      image: 'https://images.unsplash.com/photo-1534438327276-14e5300c3a48?w=400',
    },
    {
      name: 'Personal Training Session',
      description: 'One-on-one trainer session',
      priceRange: [500, 1500],
      subSubCategory: 'Personal Training',
      tags: ['personal-training', 'fitness', 'coach'],
      image: 'https://images.unsplash.com/photo-1571019614242-c5c5dee9f50b?w=400',
    },
    {
      name: 'Cardio Zone Access',
      description: 'Treadmill and cardio equipment',
      priceRange: [200, 400],
      subSubCategory: 'Cardio',
      tags: ['cardio', 'treadmill', 'heart-health'],
      image: 'https://images.unsplash.com/photo-1538805060514-97d9cc17730c?w=400',
    },
    {
      name: 'Zumba Class',
      description: 'Fun dance fitness class',
      priceRange: [300, 600],
      subSubCategory: 'Group Classes (Zumba/Aerobics)',
      tags: ['zumba', 'dance', 'group'],
  ...
  yoga: [
    ...
    },
    {
      ...
      priceRange: [400, 700],
      subSubCategory: 'Vinyasa Yoga',
      tags: ['yoga', 'vinyasa', 'flow'],
      image: 'https://images.unsplash.com/photo-1506126613408-eca07ce68773?w=400',
    },
    {
      name: 'Power Yoga',
      description: 'Intense strength-building yoga',
      priceRange: [400, 800],
      subSubCategory: 'Power Yoga',
    ...
    },
    {
      ...
      priceRange: [200, 500],
      subSubCategory: 'Meditation Classes',
  ...
  'ac-repair': [
    {
      ...
      description: 'Complete AC cleaning and service',
      priceRange: [400, 800],
      subSubCategory: 'Split AC Repair',
      tags: ['ac', 'service', 'split'],
      image: 'https://images.unsplash.com/photo-1585771724684-38269d6639fd?w=400',
    },
    {
      name: 'AC Gas Refill',
      description: 'Refrigerant gas top-up',
    ...
    },
    {
      ...
      description: 'Window AC maintenance',
      priceRange: [350, 600],
      subSubCategory: 'Window AC Repair',
      tags: ['ac', 'window', 'service'],
      image: 'https://images.unsplash.com/photo-1585771724684-38269d6639fd?w=400',
    },
    {
      name: 'AC Deep Cleaning',
      description: 'Thorough AC cleaning service',
      priceRange: [800, 1500],
      subSubCategory: 'AC Servicing & Cleaning',
      tags: ['ac', 'cleaning', 'deep'],
      image: 'https://images.unsplash.com/photo-1585771724684-38269d6639fd?w=400',
    },
  ],
  ...
  plumbing: [
    {
      name: 'Tap Repair',
      description: 'Leaky tap fixing service',
      priceRange: [200, 400],
      subSubCategory: 'Faucet/Leak Repair',
    ...
    },
    {
      ...
      priceRange: [250, 500],
      subSubCategory: 'Drainage Unclogging',
      tags: ['plumbing', 'drain', 'unclog'],
      image: 'https://images.unsplash.com/photo-1585704032915-c3400ca199e7?w=400',
    },
    {
      ...
      priceRange: [500, 1000],
      subSubCategory: 'Water Heater Installation',
      tags: ['plumbing', 'geyser', 'installation'],
      image: 'https://images.unsplash.com/photo-1585704032915-c3400ca199e7?w=400',
    },
  ],
  ...
  cleaning: [
    {
      ...
      description: '2BHK complete deep clean',
      priceRange: [2000, 4000],
      subSubCategory: 'Deep House Cleaning',
    ...
    },
    {
      ...
      priceRange: [800, 1500],
      subSubCategory: 'Sofa & Carpet Cleaning',
      tags: ['cleaning', 'sofa', 'shampoo'],
    ...
    },
    {
      ...
      subSubCategory: 'Kitchen Cleaning',
      tags: ['cleaning', 'kitchen', 'deep'],
    ...
    },
    {
      ...
      priceRange: [500, 1000],
      subSubCategory: 'Deep House Cleaning',
      tags: ['cleaning', 'bathroom', 'sanitize'],
  ...
  hotels: [
    {
      name: 'Budget Room Night Stay',
      description: 'Clean comfortable budget room',
      priceRange: [800, 1500],
      subSubCategory: 'Budget/Boutique Stays',
      tags: ['hotel', 'budget', 'stay'],
      image: 'https://images.unsplash.com/photo-1566665797739-1674de7a421a?w=400',
    },
    {
      name: 'Boutique Hotel Stay',
      description: 'Unique boutique experience',
      priceRange: [2500, 5000],
      subSubCategory: 'Budget/Boutique Stays',
      tags: ['hotel', 'boutique', 'unique'],
      image: 'https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?w=400',
    },
    {
      name: 'Serviced Apartment',
      description: 'Fully furnished apartment stay',
      priceRange: [3000, 7000],
      subSubCategory: 'Serviced Apartments',
      tags: ['apartment', 'serviced', 'furnished'],
      image: 'https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=400',
    },
    {
      name: '5-Star Luxury Suite',
      description: 'Premium luxury accommodation',
      priceRange: [8000, 25000],
      subSubCategory: '5-Star Luxury',
      tags: ['hotel', 'luxury', '5-star'],
  ...
  taxis: [
    {
      ...
      description: 'Within city taxi service',
      priceRange: [150, 500],
      subSubCategory: 'Local City Trips',
      tags: ['taxi', 'local', 'city'],
    ...
    },
    {
      ...
      priceRange: [500, 1500],
      subSubCategory: 'Airport Transfers',
      tags: ['taxi', 'airport', 'transfer'],
      image: 'https://images.unsplash.com/photo-1530685932526-48ec92998eaa?w=400',
    },
    {
      name: 'Outstation Cab',
      description: 'Intercity taxi booking',
      priceRange: [2000, 8000],
      subSubCategory: 'Outstation Cabs',
      tags: ['taxi', 'outstation', 'intercity'],
  ...
  activities: [
    {
      ...
      subSubCategory: 'Cooking Classes',
      tags: ['cooking', 'class', 'experience'],
      image: 'https://images.unsplash.com/photo-1556910103-1c02745aae4d?w=400',
    },
    {
      name: 'Pottery Workshop',
      description: 'Hands-on pottery making',
      priceRange: [800, 2000],
      subSubCategory: 'Pottery Workshops',
      tags: ['pottery', 'workshop', 'craft'],
      image: 'https://images.unsplash.com/photo-1565193566173-7a0ee3dbe261?w=400',
    },
    {
      name: 'City Walking Tour',
      description: 'Guided heritage walk',
      priceRange: [500, 1500],
      subSubCategory: 'City Walking Tours',
      tags: ['tour', 'walking', 'heritage'],
...
async function updateProductDetailsWithSubSubCategory() {
  try {
    logger.info('🚀 Starting comprehensive product update...');
    ...
    for (const product of products) {
      ...
      if (!templates || templates.length === 0) {
        ...
        const similarCategories = Object.keys(PRODUCT_TEMPLATES).filter(
          (key) => categorySlug.includes(key.split('-')[0]) || key.includes(categorySlug.split('-')[0]),
        );
    ...
    logger.info('========================================');
    logger.info(`Total products updated: ${updatedCount}`);
    ...
    for (const [subSubCat, count] of sortedStats) {
      logger.info(`   ${subSubCat}: ${count} products`);
    }

    if (Object.keys(subSubCategoryStats).length > 30) {
      logger.info(`   ... and ${Object.keys(subSubCategoryStats).length - 30} more sub-sub-categories`);
    }
  } catch (error) {
