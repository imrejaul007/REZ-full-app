...
> = {
  fruits: [
    ...
    {
      name: 'Pomegranate',
      description: 'Fresh ruby red pomegranates',
      basePrice: 220,
      salePrice: 199,
      unit: '1 kg',
      image: 'https://images.unsplash.com/photo-1541344999736-4a22dc7e4f8b?w=400',
      tags: ['pomegranate', 'fruit', 'antioxidant'],
      cashbackPercentage: 12,
    },
    {
      name: 'Watermelon',
    ...
    },
    {
      ...
      tags: ['strawberry', 'berry', 'fresh'],
      cashbackPercentage: 15,
    },
    {
      name: 'Kiwi',
      description: 'Imported green kiwis',
      basePrice: 200,
      unit: '3 pcs',
      image: 'https://images.unsplash.com/photo-1585059895524-72359e06133a?w=400',
      tags: ['kiwi', 'fruit', 'imported'],
      cashbackPercentage: 12,
    },
  ],
  veggies: [
    ...
    },
    {
      ...
      tags: ['onion', 'vegetable', 'essential'],
      cashbackPercentage: 5,
    },
    {
      name: 'Potatoes',
      ...
      basePrice: 30,
      unit: '1 kg',
      image: 'https://images.unsplash.com/photo-1518977676601-b53f82ber88f?w=400',
  ...
  dairy: [
    ...
    },
    {
      ...
      salePrice: 99,
      unit: '200 g',
      image: 'https://images.unsplash.com/photo-1571212515416-fca325e36a1e?w=400',
    ...
    {
      name: 'Cream',
      description: 'Fresh cream for cooking',
      basePrice: 55,
      unit: '200 ml',
      image: 'https://images.unsplash.com/photo-1599599810769-bcde5a160d32?w=400',
      tags: ['cream', 'dairy', 'cooking'],
      cashbackPercentage: 8,
    },
    {
      name: 'Flavored Milk',
  ...
  snacks: [
    ...
    {
      name: 'Kurkure',
      description: 'Masala munch kurkure',
      basePrice: 20,
      unit: '75 g',
      image: 'https://images.unsplash.com/photo-1599490659213-e2b9527bd087?w=400',
      tags: ['kurkure', 'snack', 'namkeen'],
      cashbackPercentage: 12,
    },
    {
      name: 'Haldirams Bhujia',
      description: 'Classic besan bhujia',
      basePrice: 85,
      unit: '200 g',
      image: 'https://images.unsplash.com/photo-1606312619070-d48b4c652a52?w=400',
      tags: ['bhujia', 'namkeen', 'haldirams'],
      cashbackPercentage: 10,
    },
    {
      name: 'Oreo Biscuits',
    ...
    },
    {
      ...
      tags: ['biscuit', 'cookies', 'britannia'],
      cashbackPercentage: 10,
    },
    {
      name: 'Parle-G',
    ...
    },
    {
      ...
      tags: ['pringles', 'chips', 'imported'],
      cashbackPercentage: 15,
    },
    {
      name: 'Popcorn',
      description: 'Ready to eat caramel popcorn',
      basePrice: 60,
      unit: '100 g',
      image: 'https://images.unsplash.com/photo-1505686994434-e3cc5abf1330?w=400',
      tags: ['popcorn', 'snack', 'caramel'],
      cashbackPercentage: 12,
    },
    {
      name: 'Mixture',
      description: 'South Indian mixture',
      basePrice: 70,
      unit: '200 g',
    ...
    {
      name: 'Murukku',
      description: 'Crispy chakli',
      basePrice: 80,
      unit: '200 g',
      image: 'https://images.unsplash.com/photo-1606312619070-d48b4c652a52?w=400',
      tags: ['murukku', 'chakli', 'snack'],
      cashbackPercentage: 10,
    },
  ],
  beverages: [
    ...
    {
      name: 'Buttermilk',
      description: 'Fresh chaas/buttermilk',
      basePrice: 25,
      unit: '200 ml',
      image: 'https://images.unsplash.com/photo-1626082927389-6cd097cdc6ec?w=400',
      tags: ['buttermilk', 'chaas', 'drink'],
      cashbackPercentage: 5,
    },
  ],
  staples: [
    ...
    },
    {
      ...
      basePrice: 55,
      unit: '1 kg',
      image: 'https://images.unsplash.com/photo-1581600140682-d4e68c8cde32?w=400',
      tags: ['sugar', 'sweet', 'staple'],
  ...
  'personal-care': [
    ...
    },
    {
      ...
      tags: ['shampoo', 'hair', 'antidandruff'],
    ...
    },
    {
      ...
      unit: '400 ml',
      image: 'https://images.unsplash.com/photo-1556228578-0d85b1a4d571?w=400',
      tags: ['lotion', 'nivea', 'skincare'],
      cashbackPercentage: 18,
    },
    {
      name: 'Gillette Razor',
      description: 'Mach3 disposable razor',
      basePrice: 220,
      unit: '1 pc',
      image: 'https://images.unsplash.com/photo-1585747860715-2ba37e788b70?w=400',
      tags: ['razor', 'gillette', 'shaving'],
      cashbackPercentage: 15,
    },
    {
    ...
    {
      name: 'Face Wash',
      description: 'Himalaya neem face wash',
      basePrice: 180,
      unit: '150 ml',
      image: 'https://images.unsplash.com/photo-1556228841-a3c527ebefe5?w=400',
      tags: ['facewash', 'neem', 'skincare'],
      cashbackPercentage: 15,
    },
    {
      name: 'Deodorant',
      description: 'Fogg deo spray',
      basePrice: 250,
      unit: '150 ml',
      image: 'https://images.unsplash.com/photo-1594035910387-fea47794261f?w=400',
      tags: ['deo', 'fragrance', 'spray'],
      cashbackPercentage: 18,
    },
    {
      name: 'Hand Sanitizer',
      description: 'Lifebuoy germ protection',
      basePrice: 80,
      unit: '100 ml',
      image: 'https://images.unsplash.com/photo-1584744982491-665216d95f8b?w=400',
      tags: ['sanitizer', 'hygiene', 'germ'],
      cashbackPercentage: 12,
    },
    {
      name: 'Lip Balm',
      description: 'Nivea moisturizing lip balm',
      basePrice: 150,
      unit: '4.8 g',
      image: 'https://images.unsplash.com/photo-1586495777744-4413f21062fa?w=400',
      tags: ['lipbalm', 'nivea', 'moisturizing'],
      cashbackPercentage: 15,
    },
  ],
  household: [
    ...
    {
      name: 'Garbage Bags',
      description: 'Biodegradable garbage bags',
      basePrice: 99,
      unit: '30 pcs',
      image: 'https://images.unsplash.com/photo-1610141882127-c62c49a42c6f?w=400',
      tags: ['garbage', 'bags', 'disposable'],
      cashbackPercentage: 8,
    },
    {
      name: 'Steel Scrubber',
      description: 'Scotch-Brite steel scrub',
      basePrice: 45,
      unit: '3 pcs',
      image: 'https://images.unsplash.com/photo-1585227107636-ef34e5a67f1b?w=400',
      tags: ['scrubber', 'scotchbrite', 'utensil'],
      cashbackPercentage: 10,
    },
    {
      name: 'Room Freshener',
      description: 'Odonil air freshener',
      basePrice: 130,
      unit: '200 ml',
      image: 'https://images.unsplash.com/photo-1585828922344-85c9daa264b0?w=400',
      tags: ['freshener', 'air', 'odonil'],
      cashbackPercentage: 12,
    },
    {
      name: 'Naphthalene Balls',
      description: 'Moth repellent balls',
      basePrice: 40,
      unit: '100 g',
      image: 'https://images.unsplash.com/photo-1610141882127-c62c49a42c6f?w=400',
      tags: ['naphthalene', 'moth', 'household'],
      cashbackPercentage: 5,
    },
  ],
};
...
async function seedGrocerySubcategories(parentCategoryId: mongoose.Types.ObjectId) {
  ...
  for (const subcat of grocerySubcategories) {
    ...
    if (existing) {
      logger.info(`  Subcategory "${subcat.name}" already exists, skipping...`);
...
async function seedGroceryStores(categoryId: mongoose.Types.ObjectId) {
  ...
  for (const storeData of groceryStores) {
    ...
    if (existing) {
      logger.info(`  Store "${storeData.name}" already exists, skipping...`);
...
async function seedGroceryProducts(subcategories: any[], stores: any[]) {
  ...
  for (const category of subcategories) {
    ...
    if (!productsList) {
      logger.info(`  No products data for category: ${category.name}`);
      continue;
    }

    logger.info(`  Seeding products for: ${category.name}`);
    ...
    for (const productData of productsList) {
      ...
      const _product = await Product.create({
        ...
        pricing: {
          ...
          discount: Math.round(
            ((productData.basePrice - (productData.salePrice || productData.basePrice)) / productData.basePrice) * 100,
          ),
          currency: 'INR',
        },
    ...
    logger.info(`    Created ${productsList.length} products for ${category.name}`);
  }
...
async function main() {
  try {
    ...
    logger.info('========================================');
    logger.info('GROCERY DATA SEEDER');
    logger.info('========================================');
    ...
    if (!groceryCategory) {
      ...
      logger.info('Created main Grocery category');
    } else {
    ...
    logger.info(`Products: ${totalProducts}`);
