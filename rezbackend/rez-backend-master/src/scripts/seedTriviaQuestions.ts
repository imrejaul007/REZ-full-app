...
const triviaQuestions = [
  // HISTORY
  {
    ...
    points: 15,
    funFact:
      'World War II officially ended on September 2, 1945, when Japan signed the surrender documents aboard the USS Missouri.',
  ...
  },
  {
    ...
    points: 15,
    funFact:
      "Neil Armstrong stepped onto the moon on July 20, 1969, saying 'That's one small step for man, one giant leap for mankind.'",
  ...
  },
  {
    ...
    points: 25,
    funFact:
      'Machu Picchu was built in the 15th century and sits at 7,970 feet above sea level in the Andes Mountains of Peru.',
  ...
  // SCIENCE
  {
    ...
    points: 25,
    funFact:
      "Au comes from the Latin word 'aurum' meaning 'shining dawn.' Gold is one of the least reactive chemical elements.",
  ...
  },
  {
    ...
    points: 35,
    funFact:
      "The speed of light is approximately 186,282 miles per second (299,792 kilometers per second), denoted as 'c' in physics.",
  ...
  },
  {
    ...
    points: 25,
    funFact:
      'The Nile River flows about 4,135 miles through northeastern Africa. Recent studies suggest the Amazon might be slightly longer.',
  ...
  },
  {
    ...
    points: 35,
    funFact:
      'Antarctica is technically the largest desert at 5.5 million square miles. The Sahara is the largest hot desert.',
  ...
  // POP CULTURE
  {
    ...
    points: 15,
    funFact:
      "Michael Jackson earned the title 'King of Pop' for his revolutionary impact on music, dance, and fashion.",
  ...
  },
  {
    ...
    points: 25,
    funFact:
      "The Beatles' 'Abbey Road' (1969) features the iconic zebra crossing photo and was their penultimate studio album.",
  ...
  // MOVIES
  {
    ...
    points: 15,
    funFact:
      "James Cameron's 'Titanic' (1997) won 11 Academy Awards, tying with 'Ben-Hur' for the most Oscars won by a single film.",
  ...
  },
  {
    ...
    points: 25,
    funFact:
      'Avatar (2009) grossed over $2.9 billion worldwide, reclaiming the top spot after a brief period held by Avengers: Endgame.',
  ...
  },
  {
    ...
    points: 25,
    funFact:
      'Ludwig van Beethoven began losing his hearing in his 20s and was completely deaf by 1818, yet continued composing masterpieces.',
  ...
  },
  {
    ...
    points: 25,
    funFact:
      "Vincent van Gogh painted 'The Starry Night' in 1889 while in an asylum in France. It's now at MoMA in New York.",
  ...
  },
  {
    ...
    points: 25,
    funFact:
      "Salvador Dalí was a prominent Surrealist, known for his dreamlike imagery and melting clocks in 'The Persistence of Memory.'",
  ...
  // LITERATURE
  {
    ...
    points: 15,
    funFact:
      "Shakespeare wrote 'Romeo and Juliet' around 1594-1596. It's one of the most frequently performed plays worldwide.",
  ...
  },
  {
    ...
    points: 15,
    funFact:
      "J.K. Rowling's first Harry Potter book was published in 1997 in the UK as 'Philosopher's Stone' (Sorcerer's Stone in the US).",
  ...
  },
  {
    ...
    points: 25,
    funFact:
      "George Orwell wrote '1984' in 1949, creating terms like 'Big Brother,' 'doublethink,' and 'thoughtcrime' that are still used today.",
  ...
  // NATURE
  {
    ...
    points: 15,
    funFact:
      'Blue whales can grow up to 100 feet long and weigh as much as 200 tons, making them the largest animals ever known.',
  ...
  },
  {
    ...
    points: 25,
    funFact:
      'Mandarin Chinese has over 900 million native speakers, though English is the most widely spoken overall including non-native speakers.',
...
async function seedTriviaQuestions() {
  try {
    logger.info('🌱 Starting trivia questions seeding...');
    ...
    logger.info(`🗑️ Cleared ${deleteResult.deletedCount} existing trivia questions`);

    // Insert new trivia questions
    const result = await TriviaQuestion.insertMany(triviaQuestions);
    logger.info(`✅ Successfully seeded ${result.length} trivia questions`);
    ...
    logger.error('❌ Error seeding trivia questions:', error);
    process.exit(1);
  }
}
