  ...
  bangalore: [
    {
      ...
      description:
        'Join industry leaders, innovators, and tech enthusiasts for a day of insights, networking, and learning. Featuring keynotes from top tech CEOs and hands-on workshops.',
      category: 'Technology',
    ...
    },
    {
      ...
      description:
        'Experience the magic of Diljit Dosanjh live in Bangalore. An unforgettable night of music, energy, and entertainment.',
      category: 'Music',
    ...
    },
    {
      ...
      description:
        "Present your startup to India's leading venture capitalists. Network with fellow founders and get funding for your idea.",
      category: 'Business',
    ...
    },
    {
      ...
      description:
        'Escape the city hustle with a 2-day yoga retreat. Includes meditation sessions, organic meals, and nature walks.',
      category: 'Wellness',
    ...
    },
    {
      ...
      description:
        'Watch the epic rivalry unfold live at M. Chinnaswamy Stadium. Royal Challengers Bangalore takes on Chennai Super Kings.',
      category: 'Sports',
    ...
    },
    {
      ...
      description:
        "Sample dishes from 50+ restaurants, attend cooking demos, and enjoy live music. A foodie's paradise!",
      category: 'Food',
  ...
  dubai: [
    {
      ...
      description:
        'Experience the future at Dubai Expo 2025. Discover innovations from 190+ countries, attend exclusive pavilions, and witness spectacular performances.',
      category: 'Technology',
    ...
    },
    {
      ...
      description:
        'Experience the magic of Arabian desert with dune bashing, camel rides, BBQ dinner, and traditional entertainment under the stars.',
      category: 'Entertainment',
    ...
    },
    {
      ...
      description:
        "Explore culinary delights from around the world at Dubai's biggest food festival. Live cooking demos, celebrity chefs, and unlimited tastings.",
      category: 'Food',
    ...
    },
    {
      ...
      description:
        "Visit the world's tallest building observation deck at 555m. Includes sunset views and premium lounge access.",
      category: 'Entertainment',
    ...
    },
    {
      ...
      description:
        'Experience the thrill of F1 racing at the spectacular Yas Marina Circuit. Includes paddock access and post-race concert.',
      category: 'Sports',
    ...
    },
    {
      ...
      description:
        "Join Dubai's biggest fitness movement. Free fitness classes, community runs, and wellness activities across the city.",
      category: 'Wellness',
    ...
    },
    {
      ...
      description:
        'Explore pavilions from 90+ countries, enjoy international cuisine, watch live entertainment, and shop unique handicrafts.',
      category: 'Entertainment',
...
async function seedRegionEvents() {
  ...
  const fixResult = await db!
    .collection('events')
    .updateMany({ 'price.currency': '₹' }, { $set: { 'price.currency': 'INR' } });
  logger.info(`  Fixed ${fixResult.modifiedCount} events (₹ → INR)`);

  // Also fix Mumbai events to be in Bangalore region
  const fixMumbai = await db!
    .collection('events')
    .updateMany({ 'location.city': 'Mumbai' }, { $set: { 'location.city': 'Bangalore' } });
  logger.info(`  Moved ${fixMumbai.modifiedCount} Mumbai events to Bangalore`);
  ...
  for (const [region, templates] of Object.entries(EVENT_TEMPLATES)) {
    ...
    for (const template of templates) {
      ...
      if (existing) {
        logger.info(`  ⏭️  Skipping ${template.title} (already exists)`);
        continue;
      }
...
seedRegionEvents().catch((err) => { console.error(err); process.exit(1); }); // D19: fail loud so CI catches broken seeds
