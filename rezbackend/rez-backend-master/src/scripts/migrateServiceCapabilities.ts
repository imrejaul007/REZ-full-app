...
async function migrateServiceCapabilities(): Promise<void> {
  ...
  logger.info('\n+-------------------------------+--------------+');
  logger.info('| Capability                    | Stores       |');
  logger.info('+-------------------------------+--------------+');
  logger.info(`| Home Delivery                 | ${String(capCounts.homeDelivery).padStart(12)} |`);
  logger.info(`| Table Booking                 | ${String(capCounts.tableBooking).padStart(12)} |`);
  logger.info(`| Dine In                       | ${String(capCounts.dineIn).padStart(12)} |`);
  logger.info(`| Store Pickup                  | ${String(capCounts.storePickup).padStart(12)} |`);
  logger.info(`| Drive Thru                    | ${String(capCounts.driveThru).padStart(12)} |`);
  logger.info('+-------------------------------+--------------+');
  logger.info(`| Total Stores                  | ${String(totalStores).padStart(12)} |`);
  logger.info('+-------------------------------+--------------+\n');
}
