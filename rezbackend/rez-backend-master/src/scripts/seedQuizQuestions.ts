...
const quizQuestions = [
  // SHOPPING CATEGORY - Easy
  {
    ...
    options: [
      'Buy one item and get another free',
      'Buy one item at double price',
      'Buy online get offline discount',
  ...
  },
  {
    ...
    options: [
      'A sale lasting several days',
      'A short-duration sale with limited-time offers',
      'A sale only for new customers',
      'A sale with photography equipment',
    ],
    correctAnswer: 1,
    category: 'shopping',
    difficulty: 'easy',
  ...
  // SHOPPING CATEGORY - Medium
  {
    ...
    options: [
      ...
      'Points earned on purchases for future rewards',
      'Free shipping forever',
      'Priority customer service only',
    ],
    correctAnswer: 1,
    category: 'shopping',
    difficulty: 'medium',
    points: 20,
    explanation:
      'Loyalty programs let you accumulate points with each purchase that can be redeemed for discounts or rewards.',
    tags: ['loyalty', 'rewards'],
  },
  {
    question: 'What is dynamic pricing in e-commerce?',
    options: [
      'Fixed prices year-round',
      'Prices that change based on demand, time, or other factors',
      'Discount for disabled customers',
    ...
    points: 20,
    explanation:
      'Dynamic pricing adjusts product prices in real-time based on market demand, competition, and other factors.',
  ...
  // SHOPPING CATEGORY - Hard
  {
    ...
    options: [
      'Displaying products in showrooms',
      'Examining products in-store but buying online for better prices',
    ...
    points: 30,
    explanation:
      'Showrooming is when shoppers visit physical stores to see products but then purchase them online at lower prices.',
    tags: ['retail', 'trends'],
  },
  ...
  // FASHION CATEGORY - Easy
  {
    ...
    options: [
      ...
      'Environmentally friendly and ethical clothing production',
      'Fast fashion trends',
      'Wearing only black',
    ],
    correctAnswer: 1,
    ...
    points: 10,
    explanation:
      'Sustainable fashion focuses on reducing environmental impact through eco-friendly materials and ethical production.',
  ...
  },
  {
    ...
    points: 10,
    explanation:
      'A lookbook presents a curated collection of outfits to inspire customers and showcase styling possibilities.',
  ...
  // FASHION CATEGORY - Medium
  {
    ...
    options: [
      'Athletic shoes only',
      'Clothing designed for both athletic activities and casual wear',
      'Leisure suits',
      'Athletic equipment',
    ],
    correctAnswer: 1,
    ...
    points: 20,
    explanation:
      'Athleisure is a fashion trend featuring clothing designed for workouts but stylish enough for everyday wear.',
    tags: ['trends', 'casual'],
  },
  {
    ...
    options: [
      ...
      'A small collection of versatile, essential clothing items',
      'Clothing in capsules',
      'Seasonal storage',
    ],
    correctAnswer: 1,
    category: 'fashion',
    ...
    points: 20,
    explanation:
      'A capsule wardrobe is a minimal collection of timeless, versatile pieces that can be mixed and matched.',
  ...
  // FOOD CATEGORY - Easy
  {
    ...
    options: [
      'Buying furniture',
      'Food sourced directly from local farms to restaurants',
  ...
  },
  {
    ...
    options: [
      ...
      'Excluding all animal products including dairy and eggs',
      'A low-carb diet',
      'Eating only fruits',
    ],
    correctAnswer: 1,
  ...
  // FOOD CATEGORY - Medium
  {
    ...
    options: [
      'Studying food molecules',
      'A cooking technique applying scientific principles to create unique textures and presentations',
      'Cooking with gas',
    ...
    points: 20,
    explanation:
      'Molecular gastronomy uses scientific techniques to transform ingredients and create innovative dining experiences.',
  ...
  },
  {
    ...
    options: [
      'Storing data in physical clouds',
      'Storing data on remote servers accessible via internet',
      'Weather data storage',
      'Airplane data storage',
    ],
    correctAnswer: 1,
    category: 'technology',
    difficulty: 'easy',
    points: 10,
    explanation:
      'Cloud storage allows you to save files on remote servers that you can access from anywhere via the internet.',
    tags: ['cloud', 'storage'],
  },
  ...
  // TECHNOLOGY CATEGORY - Medium
  {
    ...
    options: [
      'Building blocks',
      'Creating secure, decentralized digital ledgers',
      'Chain management',
      'Block construction',
    ],
    correctAnswer: 1,
    ...
    points: 20,
    explanation:
      'Blockchain is a distributed ledger technology that records transactions securely across multiple computers.',
  ...
  },
  {
    ...
    points: 20,
    explanation:
      'IoT (Internet of Things) refers to physical devices connected to the internet, collecting and sharing data.',
  ...
  // TECHNOLOGY CATEGORY - Hard
  {
    ...
    options: [
      'Computing at the edge of a desk',
      "Processing data closer to where it's generated rather than in centralized data centers",
      'Advanced gaming',
      'Screen edge technology',
    ],
    correctAnswer: 1,
    category: 'technology',
    difficulty: 'hard',
  ...
  // ENTERTAINMENT CATEGORY - Easy
  {
    ...
    options: [
      'Downloading files permanently',
      'Watching or listening to content in real-time without downloading',
      'Creating streams',
      'Water entertainment',
    ],
    correctAnswer: 1,
    ...
    points: 10,
    explanation:
      'Streaming delivers media content in real-time over the internet without requiring a complete download.',
  ...
  },
  {
    ...
    options: [
      ...
      'Watching multiple episodes or seasons in one sitting',
      'Watching only finales',
      'Watching highlights',
    ],
    correctAnswer: 1,
    category: 'entertainment',
    ...
    points: 10,
    explanation:
      'Binge-watching is consuming multiple episodes of a TV show in rapid succession, typically in one sitting.',
    tags: ['viewing', 'trends'],
  },
  ...
  // ENTERTAINMENT CATEGORY - Medium
  {
    ...
    options: [
      'A pod for storing music',
      'Digital audio programs available for streaming or download',
      'A type of broadcast tower',
      'A music player',
    ],
    correctAnswer: 1,
    category: 'entertainment',
    ...
    points: 20,
    explanation:
      'Podcasts are episodic audio programs on various topics that can be streamed or downloaded for on-demand listening.',
    tags: ['audio', 'content'],
  },
  ...
  },
  {
    ...
    points: 20,
    explanation:
      'The maximum break in snooker is 147 points, achieved by potting all reds with blacks, then all colors.',
  ...
  // LIFESTYLE CATEGORY - Easy
  {
    ...
    options: [
      'Working while balancing on one foot',
      'Managing time between work and personal activities',
    ...
    points: 10,
    explanation:
      'Work-life balance is about maintaining a healthy equilibrium between career demands and personal life.',
  ...
  },
  {
    ...
    points: 10,
    explanation:
      'Meditation is a practice to train attention and awareness, achieving mental clarity and emotional calm.',
  ...
  // LIFESTYLE CATEGORY - Medium
  {
    ...
    options: [
      ...
      'Living with only essential possessions and reducing clutter',
      'Minimal food intake',
    ...
    points: 20,
    explanation:
      'Minimalism focuses on living with less, keeping only what adds value to your life and removing excess.',
  ...
  },
  {
    ...
    points: 30,
    explanation:
      'Marie Curie was the first woman to win a Nobel Prize (Physics, 1903) and the only person to win in two sciences.',
  ...
  // Additional SHOPPING questions
  {
    ...
    options: [
      'Selling at higher prices only',
      'Encouraging customers to purchase a higher-end product than originally intended',
      'Moving to upstairs store',
      'Selling only luxury items',
    ],
    correctAnswer: 1,
    category: 'shopping',
    difficulty: 'medium',
    points: 20,
    explanation:
      'Upselling is a sales technique where the seller encourages the customer to buy a more expensive or upgraded version.',
  ...
  },
  {
    ...
    options: [
      ...
      'Saving items for future purchase consideration',
      'Listing complaints',
      'Gift registry only',
    ],
    correctAnswer: 1,
  ...
  // Additional FASHION questions
  {
    ...
    points: 30,
    explanation:
      'Haute couture refers to high-end fashion that is custom-made for individual clients by luxury fashion houses.',
    tags: ['luxury', 'custom'],
  },
  {
  ...
  },
  {
    ...
    points: 20,
    explanation:
      'Umami is the fifth taste (alongside sweet, sour, salty, bitter), characterized by a savory, meaty flavor.',
    tags: ['taste', 'cooking'],
  },
  ...
  // Additional LIFESTYLE questions
  {
    ...
    options: [
      'A Danish concept of coziness and comfortable living',
      'A type of yoga',
    ...
    points: 30,
    explanation:
      'Hygge is a Danish and Norwegian concept emphasizing coziness, contentment, and well-being through simple pleasures.',
  ...
  // Additional GENERAL questions
  {
    ...
    points: 20,
    explanation:
      'SEO (Search Engine Optimization) is the practice of improving website visibility in search engine results.',
  ...
  },
  {
    ...
    options: [
      'Funding from crowds',
      'Raising money from many people, typically via internet platforms',
      'Government funding',
      'Bank loans',
    ],
    correctAnswer: 1,
...
async function seedQuizQuestions() {
  try {
    ...
    logger.info(`🗑️ Cleared ${deleteResult.deletedCount} existing quiz questions`);

    // Insert new quiz questions
    const result = await QuizQuestion.insertMany(quizQuestions);
    logger.info(`✅ Successfully seeded ${result.length} quiz questions`);
