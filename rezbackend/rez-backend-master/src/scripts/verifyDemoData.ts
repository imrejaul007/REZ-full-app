...
try {
  CoinTransaction =
    require('../models/CoinTransaction').default || require('../models/CoinTransaction').CoinTransaction;
} catch (_e) {}
try {
  PendingCoinReward =
    require('../models/PendingCoinReward').default || require('../models/PendingCoinReward').PendingCoinReward;
} catch (_e) {}
try {
  Share = require('../models/Share').default || require('../models/Share').Share;
} catch (_e) {}
try {
  Order = require('../models/Order').default || require('../models/Order').Order;
} catch (_e) {}
...
function fixed(msg: string) {
  fixesApplied++;
  logger.info(`  🔧 FIXED: ${msg}`);
}

async function main() {
  logger.info('═══════════════════════════════════════════════════════════════');
  logger.info('  REZ DEMO DATA VERIFICATION SCRIPT');
  logger.info('═══════════════════════════════════════════════════════════════');
  ...
  // ─────────────────────────────────────────────────
  logger.info('\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  logger.info('2. CUSTOMER USER + WALLET');
  logger.info('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  ...
  if (customerUser) {
    ...
    info(
      `Name: ${(customerUser as any).profile?.firstName || 'N/A'} ${(customerUser as any).profile?.lastName || 'N/A'}`,
    );
    ...
    if (wallet) {
      ...
      info(
        `Balance: total=${(wallet as any).balance?.total || 0}, available=${(wallet as any).balance?.available || 0}`,
      );
  ...
  // ─────────────────────────────────────────────────
  logger.info('\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  logger.info('3. MERCHANT USER + MERCHANT RECORD');
  logger.info('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  ...
  if (merchantUser) {
    ...
    info(
      `Name: ${(merchantUser as any).profile?.firstName || 'N/A'} ${(merchantUser as any).profile?.lastName || 'N/A'}`,
    );
    ...
    if (storeRecord) {
      ...
      if (storeMerchantId) {
        ...
        if (linkedToUser || linkedToMerchant) {
          ...
          fail(
            `Store merchantId (${storeMerchantId}) doesn't match merchant user (${merchantUserId}) or merchant record (${merchantRecord?._id})`,
          );
        }
      } else {
  ...
  if (storeRecord) {
    ...
    if (products.length > 0) {
      ...
      for (const p of products) {
        ...
        info(
          `  - "${p.name}" | SKU: ${(p as any).sku || 'N/A'} | Price: ₹${original} → ₹${selling} | Stock: ${stock} | Active: ${(p as any).isActive}`,
        );
  ...
  if (merchantUser) {
    ...
    if (mWallet) {
      ...
      info(
        `Balance: total=${bal.total || 0}, available=${bal.available || 0}, pending=${bal.pending || 0}, withdrawn=${bal.withdrawn || 0}`,
      );
      info(
        `Stats: totalSales=${stats.totalSales || 0}, platformFees=${stats.totalPlatformFees || 0}, netSales=${stats.netSales || 0}`,
      );
  ...
  // ─────────────────────────────────────────────────
  logger.info('\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  logger.info('9. ORDER MODEL (platformFee/merchantPayout)');
  logger.info('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  ...
  // ─────────────────────────────────────────────────
  logger.info('\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  logger.info('10. COIN TRANSACTION MODEL');
  logger.info('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  ...
  // ─────────────────────────────────────────────────
  logger.info('\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  logger.info('11. PENDING COIN REWARD MODEL');
  logger.info('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  ...
  // ─────────────────────────────────────────────────
  logger.info('\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  logger.info('13. EXISTING ORDERS');
  logger.info('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  ...
  if (Order) {
    ...
    if (orderCount > 0) {
      ...
      for (const o of recentOrders as any[]) {
        ...
        info(
          `  Order ${o.orderNumber || o._id}: user=${hasUser}, store=${hasStore}, totals=${hasTotals}, status=${o.status}`,
        );
      }
    } else {
  ...
  // ─────────────────────────────────────────────────
  logger.info('\n━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  logger.info('14. DATABASE COLLECTIONS SUMMARY');
  logger.info('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  ...
  if (db) {
    ...
    for (const col of collections.sort((a, b) => a.name.localeCompare(b.name))) {
      ...
      logger.info(`  📁 ${col.name}: ${count} documents`);
    }
  }
  ...
  logger.info(`  🔧 Fixes:      ${fixesApplied}`);
  logger.info('═══════════════════════════════════════════════════════════════');
  ...
  // ─────────────────────────────────────────────────
  logger.info('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  logger.info('  DEMO FLOW READINESS');
  logger.info('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
  ...
  for (const step of steps) {
    logger.info(`  ${step.ready ? '✅' : '❌'} ${step.name} (localhost:${step.port})`);
  }
