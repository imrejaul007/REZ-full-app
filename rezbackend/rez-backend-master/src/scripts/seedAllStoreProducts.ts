...
const PRODUCT_TEMPLATES: Record<
  string,
  Array<{ name: string; subSubCategory: string; description: string; basePrice: number; image: string }>
> = {
  // FOOD & DINING
  cafes: [
    {
    ...
    },
    {
      ...
      description: 'Triple-decker classic sandwich',
      basePrice: 280,
  ...
  'qsr-fast-food': [
    ...
    },
    {
      ...
      description: 'Grilled chicken in tortilla',
      basePrice: 250,
  ...
  'family-restaurants': [
    ...
    },
    {
      ...
      description: 'Indo-Chinese fried chicken',
      basePrice: 320,
    ...
    },
    {
      name: 'Veg Fried Rice',
      subSubCategory: 'Chinese/Asian',
      description: 'Wok-tossed vegetable rice',
      basePrice: 220,
  ...
  'fine-dining': [
    ...
    },
    {
      ...
      subSubCategory: 'Continental',
      description: 'Premium cut with red wine jus',
      basePrice: 1200,
    ...
    },
    {
      ...
      description: 'Creamy arborio rice dish',
      basePrice: 680,
      image: 'https://images.unsplash.com/photo-1476124369491-e7addf5db371?w=400',
    },
    {
      name: 'Sushi Platter',
      subSubCategory: 'Japanese',
    ...
    },
    {
      ...
      description: 'Slow-braised lamb with herbs',
      basePrice: 980,
  ...
  'ice-cream-dessert': [
    ...
    {
      name: 'Mango Sorbet',
      subSubCategory: 'Sorbet',
      description: 'Refreshing mango fruit sorbet',
      basePrice: 150,
    ...
    {
      name: 'Frozen Yogurt',
      subSubCategory: 'Frozen Yogurt',
      description: 'Healthy frozen yogurt cup',
      basePrice: 180,
      image: 'https://images.unsplash.com/photo-1488900128323-21503983a07e?w=400',
    },
    {
  ...
  'bakery-confectionery': [
    ...
    },
    {
      name: 'Red Velvet',
      subSubCategory: 'Cakes & Pastries',
      description: 'Classic with cream cheese frosting',
      basePrice: 480,
    ...
    },
    {
      ...
      description: 'Fried milk balls in syrup',
      basePrice: 80,
      image: 'https://images.unsplash.com/photo-1666190050914-e152153073a4?w=400',
    },
  ],
  'cloud-kitchens': [
    {
    ...
    },
    {
      name: 'Protein Bowl',
      subSubCategory: 'Health & Salad Bowls',
      description: 'High protein meal bowl',
      basePrice: 350,
    ...
    },
    {
      ...
      description: 'Complete meal with rice & curry',
      basePrice: 250,
      image: 'https://images.unsplash.com/photo-1536304929831-ee1ca9d44906?w=400',
    },
    {
      name: 'Brownie Box',
      subSubCategory: 'Desserts only',
      description: 'Assorted brownie box',
      basePrice: 450,
      image: 'https://images.unsplash.com/photo-1564355808539-22fda35bed7e?w=400',
    },
  ],
  'street-food': [
    ...
    },
    {
      ...
      description: 'Mumbai style potato burger',
      basePrice: 50,
      image: 'https://images.unsplash.com/photo-1606491956689-2ea866880c84?w=400',
    },
    {
  ...
  'fresh-vegetables': [
    {
      name: 'Tomatoes 1kg',
      subSubCategory: 'Seasonal Produce',
    ...
    {
      name: 'Broccoli',
      subSubCategory: 'Exotic Vegetables',
    ...
    },
    {
      ...
      subSubCategory: 'Organic Vegetables',
  ...
  'water-cans': [
    ...
    },
    {
      name: 'Bisleri 20L',
      subSubCategory: '20L Can',
      description: 'Bisleri mineral water',
      basePrice: 90,
      image: 'https://images.unsplash.com/photo-1548839140-29a749e1cf4d?w=400',
    },
    {
      name: 'Water Bottle 1L',
      subSubCategory: 'Small Bottles',
      description: 'Packaged drinking water',
      basePrice: 20,
      image: 'https://images.unsplash.com/photo-1548839140-29a749e1cf4d?w=400',
    },
    {
      name: 'Water Pack 500ml x6',
      subSubCategory: 'Small Bottles',
    ...
    },
    {
      name: 'Kinley 1L x12',
      subSubCategory: 'Small Bottles',
      description: 'Kinley water bottle pack',
      basePrice: 180,
      image: 'https://images.unsplash.com/photo-1548839140-29a749e1cf4d?w=400',
    },
  ],
  ...
  salons: [
    ...
    },
    {
      ...
      description: 'Global hair color service',
      basePrice: 1500,
  ...
  'spa-massage': [
    ...
    },
    {
      ...
      description: 'Therapeutic deep massage',
      basePrice: 2000,
      image: 'https://images.unsplash.com/photo-1544161515-4ab6ce6db874?w=400',
    },
    {
      ...
      description: 'Essential oil massage',
      basePrice: 1800,
      image: 'https://images.unsplash.com/photo-1544161515-4ab6ce6db874?w=400',
    },
    {
      ...
      description: 'Traditional ayurvedic therapy',
      basePrice: 2500,
      image: 'https://images.unsplash.com/photo-1544161515-4ab6ce6db874?w=400',
    },
    {
  ...
  pharmacy: [
    ...
    {
      name: 'First Aid Kit',
      subSubCategory: 'First Aid Supplies',
  ...
  clinics: [
    {
      ...
      subSubCategory: 'General Physician',
      description: 'Full body health checkup',
      basePrice: 500,
      image: 'https://images.unsplash.com/photo-1631217868264-e5b90bb7e133?w=400',
    },
    {
      name: 'Fever Consultation',
      subSubCategory: 'General Physician',
      description: 'Doctor consultation for fever',
      basePrice: 300,
      image: 'https://images.unsplash.com/photo-1631217868264-e5b90bb7e133?w=400',
    },
    {
      name: 'Child Vaccination',
      subSubCategory: 'Pediatrician',
      description: 'Routine child vaccination',
      basePrice: 800,
      image: 'https://images.unsplash.com/photo-1631217868264-e5b90bb7e133?w=400',
    },
    {
      ...
      subSubCategory: 'Pediatrician',
      description: 'Child health checkup',
      basePrice: 600,
      image: 'https://images.unsplash.com/photo-1631217868264-e5b90bb7e133?w=400',
    },
    {
      name: 'Joint Pain Consult',
      subSubCategory: 'Orthopedics',
      description: 'Orthopedic consultation',
      basePrice: 700,
      image: 'https://images.unsplash.com/photo-1631217868264-e5b90bb7e133?w=400',
    },
    {
      name: 'Stomach Checkup',
      subSubCategory: 'Gastroenterology',
      description: 'Digestive health checkup',
      basePrice: 600,
      image: 'https://images.unsplash.com/photo-1631217868264-e5b90bb7e133?w=400',
    },
  ],
  ...
  'coaching-centers': [
    ...
    {
      name: 'CAT Coaching',
      subSubCategory: 'CAT/GMAT/GRE',
      description: 'MBA entrance coaching',
      basePrice: 35000,
    ...
    },
    {
      name: 'GRE Prep',
      subSubCategory: 'CAT/GMAT/GRE',
      description: 'GRE test preparation',
      basePrice: 20000,
      image: 'https://images.unsplash.com/photo-1434030216411-0b793f4b4173?w=400',
    },
    {
      name: 'Class 10 Tuition',
      subSubCategory: 'School Tuitions',
    ...
    },
    {
      ...
      subSubCategory: 'School Tuitions',
      description: 'Science stream tuition',
      basePrice: 18000,
      image: 'https://images.unsplash.com/photo-1523050854058-8df90110c9f1?w=400',
    },
  ],
  'skill-development': [
    {
      ...
      subSubCategory: 'Leadership Training',
      description: '2-day leadership program',
      basePrice: 5000,
      image: 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=400',
    },
    {
      name: 'Communication Skills',
      subSubCategory: 'Soft Skills',
      description: 'Effective communication course',
      basePrice: 3000,
      image: 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=400',
    },
    {
      name: 'Public Speaking',
      subSubCategory: 'Public Speaking',
    ...
    },
    {
      ...
      subSubCategory: 'Interview Preparation',
    ...
    },
    {
      ...
      subSubCategory: 'Interview Preparation',
      description: 'Professional resume course',
      basePrice: 1500,
      image: 'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=400',
    },
    {
  ...
  'ac-repair': [
    {
      ...
      description: 'Gas top-up service',
      basePrice: 1500,
      image: 'https://images.unsplash.com/photo-1581578731548-c64695cc6952?w=400',
    },
    {
      name: 'AC Servicing',
      subSubCategory: 'AC Servicing',
    ...
    },
    {
      ...
      subSubCategory: 'Split AC Repair',
      description: 'Split AC troubleshooting',
      basePrice: 800,
      image: 'https://images.unsplash.com/photo-1581578731548-c64695cc6952?w=400',
    },
    {
  ...
  'pest-control': [
    ...
    },
    {
      ...
      subSubCategory: 'Pest Control',
      description: 'Bed bug elimination',
      basePrice: 1500,
      image: 'https://images.unsplash.com/photo-1585704032915-c3400ca199e7?w=400',
    },
    {
    ...
    },
    {
      name: 'Rodent Control',
      subSubCategory: 'Pest Control',
      description: 'Rat control service',
      basePrice: 1200,
      image: 'https://images.unsplash.com/photo-1585704032915-c3400ca199e7?w=400',
    },
    {
      ...
      subSubCategory: 'Pest Control',
      description: 'Complete pest treatment',
      basePrice: 1800,
      image: 'https://images.unsplash.com/photo-1585704032915-c3400ca199e7?w=400',
    },
  ],
  'laundry-dry-cleaning': [
    ...
    {
      name: 'Suit Dry Clean',
      subSubCategory: 'Dry Cleaning',
      description: 'Premium suit cleaning',
      basePrice: 400,
      image: 'https://images.unsplash.com/photo-1545173168-9f1947eebb7f?w=400',
    },
    {
      ...
      subSubCategory: 'Dry Cleaning',
      description: 'Delicate saree cleaning',
      basePrice: 300,
      image: 'https://images.unsplash.com/photo-1545173168-9f1947eebb7f?w=400',
    },
    {
    ...
    },
    {
      ...
      subSubCategory: 'Laundry',
      description: 'Curtain wash service',
      basePrice: 150,
      image: 'https://images.unsplash.com/photo-1545173168-9f1947eebb7f?w=400',
    },
    {
  ...
  'bike-rentals': [
    {
      name: 'Scooter Daily',
      subSubCategory: 'Scooters',
      description: 'Scooter rental per day',
      basePrice: 400,
    ...
    },
    {
      name: 'Activa Weekly',
      subSubCategory: 'Scooters',
      description: 'Activa for 7 days',
      basePrice: 2000,
      image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400',
    },
    {
      name: 'Royal Enfield',
      subSubCategory: 'Motorbikes',
      description: 'Bullet rental per day',
      basePrice: 1000,
      image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400',
    },
    {
      name: 'Sports Bike',
      subSubCategory: 'Motorbikes',
      description: 'Sports bike daily',
      basePrice: 1500,
      image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400',
    },
    {
      name: 'Helmet Rental',
      subSubCategory: 'Gear Rental',
      description: 'Safety helmet rental',
      basePrice: 50,
      image: 'https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=400',
    },
    {
  ...
  'gaming-cafes': [
    {
      name: 'PC Gaming 1hr',
      subSubCategory: 'PC Gaming',
      description: 'High-end PC gaming',
      basePrice: 100,
    ...
    },
    {
      name: 'PC Gaming 3hr',
      subSubCategory: 'PC Gaming',
      description: '3 hour PC package',
      basePrice: 250,
      image: 'https://images.unsplash.com/photo-1511882150382-421056c89033?w=400',
    },
    {
      name: 'PS5 Gaming 1hr',
      subSubCategory: 'Console Gaming',
      description: 'PlayStation 5 gaming',
      basePrice: 150,
      image: 'https://images.unsplash.com/photo-1511882150382-421056c89033?w=400',
    },
    {
      name: 'Xbox Gaming 1hr',
      subSubCategory: 'Console Gaming',
      description: 'Xbox Series X gaming',
      basePrice: 150,
      image: 'https://images.unsplash.com/photo-1511882150382-421056c89033?w=400',
    },
    {
      name: 'E-Sports Entry',
      subSubCategory: 'E-Sports',
  ...
  'amusement-parks': [
    ...
    },
    {
      name: 'All Rides Pass',
      subSubCategory: 'Entry',
      description: 'Unlimited rides pass',
      basePrice: 1500,
      image: 'https://images.unsplash.com/photo-1513889961551-628c1e5e2ee9?w=400',
    },
    {
      name: 'Water Park Entry',
      subSubCategory: 'Water Park',
      description: 'Water park access',
      basePrice: 600,
      image: 'https://images.unsplash.com/photo-1513889961551-628c1e5e2ee9?w=400',
    },
    {
    ...
    },
    {
      name: 'VIP Fast Track',
      subSubCategory: 'Entry',
      description: 'Skip the queue pass',
      basePrice: 500,
      image: 'https://images.unsplash.com/photo-1513889961551-628c1e5e2ee9?w=400',
    },
    {
      name: 'Family Pack',
      subSubCategory: 'Entry',
      description: '4 person family deal',
      basePrice: 2500,
      image: 'https://images.unsplash.com/photo-1513889961551-628c1e5e2ee9?w=400',
    },
  ],
  'vr-ar-experiences': [
    {
      name: 'VR Experience 30min',
      subSubCategory: 'VR Experience',
      description: 'Virtual reality session',
      basePrice: 500,
      image: 'https://images.unsplash.com/photo-1533488765986-dfa2a9939acd?w=400',
    },
    {
      name: 'Escape Room',
      subSubCategory: 'Escape Rooms',
      description: 'Mystery escape room',
      basePrice: 800,
      image: 'https://images.unsplash.com/photo-1533488765986-dfa2a9939acd?w=400',
    },
    {
      name: 'AR Gaming',
      subSubCategory: 'AR Gaming',
      description: 'Augmented reality games',
      basePrice: 400,
      image: 'https://images.unsplash.com/photo-1533488765986-dfa2a9939acd?w=400',
    },
    {
    ...
    },
    {
      name: 'Horror VR',
      subSubCategory: 'VR Experience',
      description: 'Scary VR experience',
      basePrice: 450,
      image: 'https://images.unsplash.com/photo-1533488765986-dfa2a9939acd?w=400',
    },
    {
      name: 'Group Escape Room',
      subSubCategory: 'Escape Rooms',
      description: '6 person escape room',
      basePrice: 3000,
      image: 'https://images.unsplash.com/photo-1533488765986-dfa2a9939acd?w=400',
    },
  ],
  ...
  broadband: [
    {
      ...
      subSubCategory: 'Internet Plans',
      description: '100 Mbps unlimited data',
      basePrice: 699,
      image: 'https://images.unsplash.com/photo-1544197150-b99a580bb7a8?w=400',
    },
    {
      name: '200 Mbps Monthly',
      subSubCategory: 'Internet Plans',
      description: '200 Mbps unlimited data',
      basePrice: 999,
      image: 'https://images.unsplash.com/photo-1544197150-b99a580bb7a8?w=400',
    },
    {
      name: '300 Mbps Monthly',
      subSubCategory: 'Internet Plans',
      description: '300 Mbps premium plan',
      basePrice: 1299,
      image: 'https://images.unsplash.com/photo-1544197150-b99a580bb7a8?w=400',
    },
    {
      name: 'Netflix Bundle',
      subSubCategory: 'OTT Bundles',
    ...
    },
    {
      name: 'Prime Bundle',
      subSubCategory: 'OTT Bundles',
      description: 'Internet + Prime Video',
      basePrice: 1199,
      image: 'https://images.unsplash.com/photo-1544197150-b99a580bb7a8?w=400',
    },
    {
  ...
  'gold-savings': [
    {
      name: 'Digital Gold 1g',
      subSubCategory: 'Digital Gold',
      description: '1 gram digital gold',
      basePrice: 6500,
      image: 'https://images.unsplash.com/photo-1610375461246-83df859d849d?w=400',
    },
    {
      name: 'Digital Gold 5g',
      subSubCategory: 'Digital Gold',
      description: '5 gram digital gold',
      basePrice: 32000,
      image: 'https://images.unsplash.com/photo-1610375461246-83df859d849d?w=400',
    },
    {
      name: 'Gold Coin 10g',
      subSubCategory: 'Physical Gold',
      description: '10 gram gold coin',
      basePrice: 65000,
      image: 'https://images.unsplash.com/photo-1610375461246-83df859d849d?w=400',
    },
    {
      name: 'SIP Gold Monthly',
      subSubCategory: 'Digital Gold',
  ...
  electronics: [
    ...
    {
      name: 'Sony 55" TV',
      subSubCategory: 'Home Appliances',
    ...
    {
      name: 'AirPods Pro',
      subSubCategory: 'Audio Equipment',
  ...
  'mobile-accessories': [
    {
      name: 'Phone Case',
      subSubCategory: 'Covers & Cases',
      description: 'Premium phone case',
      basePrice: 499,
      image: 'https://images.unsplash.com/photo-1601784551446-20c9e07cdbdb?w=400',
    },
    {
      name: 'Screen Guard',
      subSubCategory: 'Screen Guards',
    ...
    },
    {
      name: 'USB-C Cable',
      subSubCategory: 'Chargers',
      description: 'Premium charging cable',
      basePrice: 399,
      image: 'https://images.unsplash.com/photo-1609091839311-d5365f9ff1c5?w=400',
    },
    {
      ...
      subSubCategory: 'Power Banks',
      description: 'High capacity charger',
      basePrice: 1799,
      image: 'https://images.unsplash.com/photo-1609091839311-d5365f9ff1c5?w=400',
    },
  ],
  ...
  jewelry: [
    ...
    },
    {
      ...
      subSubCategory: 'Fashion Jewelry',
      description: 'Trendy earrings',
      basePrice: 799,
  ...
  'local-brands': [
    ...
    },
    {
      name: 'T-Shirt',
      subSubCategory: 'Western Wear',
      description: 'Cotton graphic tee',
      basePrice: 599,
  ...
  default: [
    ...
    {
      name: 'Service Package C',
      subSubCategory: 'Premium',
      description: 'Deluxe service package',
      basePrice: 1500,
      image: 'https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?w=400',
    },
    {
...
async function seedAllStoreProducts() {
  try {
    logger.info('🚀 Starting comprehensive product seeding for ALL stores...');
    ...
    for (const store of stores) {
      ...
      logger.info(`   Deleted ${deleteResult.deletedCount} old products`);
    ...
    logger.info('========================================');
    logger.info(`Total stores processed: ${stores.length}`);
    logger.info(`Total products deleted: ${totalDeleted}`);
    logger.info(`Total products created: ${totalCreated}`);
  } catch (error) {
