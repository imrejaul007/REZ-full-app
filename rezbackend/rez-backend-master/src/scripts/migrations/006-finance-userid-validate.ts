 ...
 *   MONGO_URI=... npx ts-node src/scripts/migrations/006-finance-userid-validate.ts [up|down]
 *
 * NOTE: This migration is READ-ONLY. The down() method is a no-op.
 */
...
/**
 * DOWN: No-op for read-only validation migration.
 * This migration does not modify any data.
 */
async function down(): Promise<void> {
  console.log('[006] DOWN: This migration is READ-ONLY. No rollback needed.');
  console.log('[006] DOWN: No data was modified by the up() operation.');
}
