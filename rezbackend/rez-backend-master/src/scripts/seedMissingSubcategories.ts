...
const LOCATIONS = {
  bangalore: {
    ...
    areas: [
      ...
      { name: 'Electronic City', coords: [77.67, 12.8395], pincode: '560100' },
      { name: 'MG Road', coords: [77.607, 12.9758], pincode: '560001' },
    ],
  },
  dubai: {
    city: 'Dubai',
    ...
    areas: [
      ...
      { name: 'Business Bay', coords: [55.2614, 25.185], pincode: '00000' },
      { name: 'Al Barsha', coords: [55.2006, 25.1124], pincode: '00000' },
      { name: 'JBR', coords: [55.135, 25.0772], pincode: '00000' },
      { name: 'DIFC', coords: [55.2819, 25.21], pincode: '00000' },
    ],
  },
};
...
const STORE_TEMPLATES = {
  ...
  'cloud-kitchens': {
    bangalore: [
      {
        name: 'Rebel Foods Kitchen',
        description: 'Multi-brand cloud kitchen - Faasos, Behrouz, Oven Story',
        tags: ['cloud-kitchen', 'multi-brand', 'delivery-only'],
        cashback: 20,
      },
      {
        name: 'Box8 Kitchen',
        description: 'Fresh meals delivered hot',
        tags: ['cloud-kitchen', 'meals', 'indian'],
        cashback: 18,
      },
      {
        name: 'FreshMenu',
        description: 'Chef-prepared fresh meals',
        tags: ['cloud-kitchen', 'fresh', 'healthy'],
        cashback: 15,
      },
      {
        name: 'Biryani By Kilo Kitchen',
        description: 'Authentic dum biryani delivery',
        tags: ['cloud-kitchen', 'biryani', 'delivery-only'],
        cashback: 12,
      },
      {
        name: 'The Good Bowl',
        description: 'Healthy bowl meals',
        tags: ['cloud-kitchen', 'healthy', 'bowls'],
        cashback: 15,
      },
      {
        name: 'Homely Kitchen',
        description: 'Home-style comfort food',
        tags: ['cloud-kitchen', 'homestyle', 'comfort-food'],
        cashback: 18,
      },
    ],
    dubai: [
      {
        name: 'Kitopi Kitchen',
        description: 'Multi-brand cloud kitchen hub',
        tags: ['cloud-kitchen', 'multi-brand', 'delivery-only'],
        cashback: 15,
      },
      {
        name: 'Sweetheart Kitchen',
        description: 'Desserts and sweets delivery',
        tags: ['cloud-kitchen', 'desserts', 'sweets'],
        cashback: 12,
      },
      {
        name: 'The Meatless Kitchen',
        description: 'Plant-based meal delivery',
        tags: ['cloud-kitchen', 'vegan', 'healthy'],
        cashback: 18,
      },
      {
        name: 'Grub Kitchen Dubai',
        description: 'International cuisine delivery',
        tags: ['cloud-kitchen', 'international', 'delivery-only'],
        cashback: 15,
      },
    ],
  },
  ...
  pharmacies: {
    bangalore: [
      {
        ...
        description: 'Trusted pharmacy chain with home delivery',
      ...
      },
      {
        ...
        tags: ['pharmacy', 'medicine', 'affordable'],
        cashback: 8,
      },
      {
        name: 'Netmeds Store',
        description: 'Online pharmacy with express delivery',
        tags: ['pharmacy', 'online', 'delivery'],
        cashback: 15,
      },
      {
        name: 'PharmEasy Pickup',
        description: 'Medicines at discounted prices',
        tags: ['pharmacy', 'discount', 'healthcare'],
        cashback: 20,
      },
      {
        name: '1mg Store',
      ...
      },
      {
        ...
        description: 'Health and wellness store',
    ...
    dubai: [
      {
        name: 'Aster Pharmacy',
        description: 'Leading pharmacy chain in UAE',
        tags: ['pharmacy', 'medicine', 'healthcare'],
        cashback: 8,
      },
      {
        name: 'Boots Pharmacy',
        description: 'Health and beauty pharmacy',
      ...
      },
      {
        ...
        description: 'Trusted UAE pharmacy chain',
        tags: ['pharmacy', 'medicine', 'trusted'],
        cashback: 10,
      },
    ],
  },
    ...
    bangalore: [
      {
        ...
        description: 'Premium pet products and accessories',
        tags: ['pet-store', 'premium', 'accessories'],
        cashback: 15,
      },
      {
        name: 'Petsy',
        description: 'Online pet supplies store',
        tags: ['pet-store', 'online', 'supplies'],
        cashback: 18,
      },
      {
        name: 'Supertails',
        description: 'Pet food and healthcare',
        tags: ['pet-store', 'food', 'healthcare'],
        cashback: 20,
      },
      {
        name: 'PetKonnect',
        description: 'Pet accessories and grooming products',
        tags: ['pet-store', 'grooming', 'accessories'],
        cashback: 12,
      },
      {
        name: 'Just Dogs',
        description: 'Everything for your furry friend',
        tags: ['pet-store', 'dogs', 'supplies'],
        cashback: 15,
      },
    ],
    dubai: [
      {
        ...
        tags: ['pet-store', 'pet-care', 'supplies'],
        cashback: 12,
      },
      {
        name: 'Petsville',
        description: 'Pet supplies and accessories',
        tags: ['pet-store', 'accessories', 'food'],
        cashback: 15,
      },
      {
        name: 'Dubai Pet Food',
        description: 'Premium pet nutrition',
        tags: ['pet-store', 'food', 'premium'],
        cashback: 10,
      },
      {
        name: 'Paws & Claws',
        description: 'Pet boutique and supplies',
        tags: ['pet-store', 'boutique', 'premium'],
        cashback: 18,
      },
    ],
  },
  ...
  'ac-repair': {
    bangalore: [
      {
        name: 'Urban Company AC Services',
        description: 'Professional AC repair and maintenance',
        tags: ['ac-repair', 'maintenance', 'professional'],
        cashback: 25,
      },
      {
        name: 'Housejoy AC Repair',
        description: 'Quick AC servicing at your doorstep',
        tags: ['ac-repair', 'servicing', 'doorstep'],
        cashback: 20,
      },
      {
        name: 'Mr Right AC Services',
        description: 'Expert AC installation and repair',
        tags: ['ac-repair', 'installation', 'expert'],
        cashback: 18,
      },
      {
        name: 'UrbanClap AC Experts',
        description: 'Verified AC technicians',
        tags: ['ac-repair', 'verified', 'technicians'],
        cashback: 22,
      },
      {
        name: 'Jeeves AC Care',
        description: 'Premium AC maintenance services',
        tags: ['ac-repair', 'premium', 'maintenance'],
        cashback: 15,
      },
    ],
    dubai: [
      {
        name: 'AC Master Dubai',
        description: 'Expert AC repair services',
        tags: ['ac-repair', 'expert', 'repair'],
        cashback: 15,
      },
      {
        name: 'Cool Tech Services',
        description: 'AC installation and maintenance',
        tags: ['ac-repair', 'installation', 'maintenance'],
        cashback: 12,
      },
      {
        name: 'ServiceMarket AC',
        description: 'On-demand AC services',
        tags: ['ac-repair', 'on-demand', 'professional'],
        cashback: 18,
      },
      {
        name: 'Hitches & Glitches',
        description: 'Home maintenance including AC',
        tags: ['ac-repair', 'home-maintenance', 'reliable'],
        cashback: 20,
      },
    ],
  },
  ...
  cleaning: {
    bangalore: [
      {
        name: 'Urban Company Cleaning',
        description: 'Professional home cleaning services',
        tags: ['cleaning', 'home-cleaning', 'professional'],
        cashback: 25,
      },
      {
        name: 'Housejoy Deep Clean',
      ...
      {
        name: 'Helper4U',
        description: 'Affordable cleaning services',
        tags: ['cleaning', 'affordable', 'domestic'],
        cashback: 15,
      },
      {
        name: 'Cleanflo',
        description: 'Eco-friendly cleaning solutions',
        tags: ['cleaning', 'eco-friendly', 'green'],
        cashback: 18,
      },
      {
        name: 'BookMyBai',
        description: 'Domestic help and cleaning',
        tags: ['cleaning', 'domestic-help', 'maid-service'],
        cashback: 12,
      },
      {
        name: 'Mr Right Cleaning',
        description: 'Home and office cleaning',
        tags: ['cleaning', 'office', 'home'],
        cashback: 15,
      },
    ],
    dubai: [
      {
        name: 'Justlife Cleaning',
        description: 'Professional cleaning services',
        tags: ['cleaning', 'professional', 'home-cleaning'],
        cashback: 20,
      },
      {
        name: 'ServiceMarket Clean',
        description: 'Trusted cleaning professionals',
        tags: ['cleaning', 'trusted', 'verified'],
        cashback: 18,
      },
      {
        name: 'Helpling Dubai',
        description: 'On-demand home cleaning',
        tags: ['cleaning', 'on-demand', 'flexible'],
        cashback: 15,
      },
      {
        name: 'Fantastic Services',
        description: 'Complete home cleaning solutions',
        tags: ['cleaning', 'complete', 'professional'],
        cashback: 22,
      },
    ],
  },
    ...
    bangalore: [
      {
        ...
        tags: ['salon', 'unisex', 'beauty'],
        cashback: 20,
      },
      {
        name: 'Juice Salon',
        description: 'Trendy hair styling salon',
        tags: ['salon', 'hair', 'trendy'],
        cashback: 18,
      },
      {
        name: 'Toni&Guy',
        description: 'International hairdressing brand',
        tags: ['salon', 'premium', 'international'],
        cashback: 15,
      },
      {
        name: 'Naturals Salon',
  ...
  'spa-wellness': {
    ...
    dubai: [
      ...
      {
        name: 'SensAsia Urban Spa',
        description: 'Asian-inspired spa treatments',
        tags: ['spa', 'asian', 'wellness'],
        cashback: 18,
      },
...
async function seedMissingSubcategories() {
  ...
  const beforeDist = await db!
    .collection('stores')
    .aggregate([{ $group: { _id: '$subcategorySlug', count: { $sum: 1 } } }, { $sort: { count: -1 } }])
    .toArray();
  ...
  for (const [subcategorySlug, regionStores] of Object.entries(STORE_TEMPLATES)) {
    ...
    for (const [region, stores] of Object.entries(regionStores)) {
      ...
      for (let i = 0; i < stores.length; i++) {
        ...
        if (existing) {
          logger.info(`  ⏭️  Skipping ${store.name} (already exists)`);
          continue;
        }
        ...
        const storeDoc = {
          ...
          images: {
            ...
            cover:
              images[(i + 1) % images.length] || 'https://images.unsplash.com/photo-1472851294608-062f824d29cc?w=800',
            gallery: images,
          },
          ratings: {
  ...
  if (storesToInsert.length > 0) {
    ...
    logger.info(`✅ Inserted ${storesToInsert.length} stores`);
  } else {
...
seedMissingSubcategories().catch((err) => { console.error(err); process.exit(1); }); // D19: fail loud so CI catches broken seeds
