...
const sampleEvents = [
  ...
  // Movies (Entertainment)
  {
    ...
    description:
      'Experience the epic conclusion to the Marvel multiverse saga on the big screen. Book your premier show tickets now and be among the first to witness the spectacle!',
    ...
    location: {
      ...
      city: 'Bangalore',
      state: 'Karnataka',
      coordinates: { lat: 12.9969, lng: 77.697 },
      isOnline: false,
    },
  ...
  },
  {
    ...
    subtitle: '₹599 • INOX',
    description:
      "Dive back into the world of Pandora with the most immersive IMAX 3D experience. Feel the magic of James Cameron's visual masterpiece.",
  ...
  // Parks (Entertainment)
  {
    ...
    description:
      "Experience thrilling rides, water parks, and entertainment at India's favorite amusement park. Special weekend rates with unlimited access to all attractions!",
    ...
    location: {
      ...
      city: 'Bangalore',
      state: 'Karnataka',
      coordinates: { lat: 12.834, lng: 77.401 },
      isOnline: false,
    },
  ...
  },
  {
    ...
    description:
      'Step into a world of fantasy and adventure at Imagica. Experience world-class rides, shows, and entertainment for the whole family.',
  ...
  // Gaming (Entertainment)
  {
    ...
    description:
      "Compete in India's biggest BGMI tournament! Show off your skills, win exciting prizes, and prove you're the ultimate battle royale champion.",
  ...
  },
  {
    ...
    description:
      'Step into virtual worlds with our premium VR gaming experience. Featuring the latest Oculus Quest and HTC Vive setups with 50+ game titles.',
  ...
  // ===== MUSIC CATEGORY (for Concerts) =====
  {
    ...
    description:
      'Experience the magic of Coldplay live! Their Music of the Spheres World Tour comes to India with spectacular visuals and unforgettable performances.',
    ...
    location: {
      ...
      city: 'Mumbai',
      state: 'Maharashtra',
      coordinates: { lat: 19.045, lng: 73.0292 },
      isOnline: false,
    },
  ...
  },
  {
    ...
    description:
      'The voice of romance performs live! Join us for an enchanting evening with Arijit Singh as he performs his greatest hits.',
  ...
  },
  {
    ...
    description:
      'An evening of classical Indian music featuring renowned artists. Experience the beauty of ragas in the historic setting of Bangalore Palace.',
  ...
  // ===== EDUCATION CATEGORY (for Workshops) =====
  {
    ...
    description:
      'Learn professional photography techniques from award-winning photographers. Hands-on training with DSLRs and post-processing skills.',
  ...
  },
  {
    ...
    description:
      'Discover the therapeutic art of pottery. Create your own ceramic pieces under expert guidance and take home your handmade creations.',
    ...
    location: {
      ...
      city: 'Bangalore',
      state: 'Karnataka',
      coordinates: { lat: 12.8891, lng: 77.585 },
      isOnline: false,
    },
    date: getFutureDate(5),
    time: '2:00 PM',
  ...
  },
  {
    ...
    description:
      'Intensive hands-on bootcamp covering AI fundamentals, Python programming, and machine learning projects. Perfect for beginners!',
  ...
  // ===== SPORTS CATEGORY =====
  {
    ...
    description:
      'Witness the epic rivalry! Royal Challengers Bangalore take on Mumbai Indians in this electrifying IPL match at the Chinnaswamy Stadium.',
  ...
  },
  {
    ...
    description:
      'The southern derby is here! Watch Bengaluru FC face Kerala Blasters in this thrilling Indian Super League encounter.',
  ...
  },
  {
    ...
    description:
      "Join thousands of runners in Bangalore's biggest marathon! Choose from 5K, 10K, or full marathon categories.",
...
async function seedEvents() {
  try {
    ...
    logger.info('🗑️ Cleared existing events');
    ...
    events.forEach((event, index) => {
      logger.info(
        `${index + 1}. ${event.title} (${event.category}${event.subcategory ? '/' + event.subcategory : ''}) - ${event.status}`,
      );
    });
