...
export const SpinWheelConfig: Model<ISpinWheelConfig> = mongoose.model<ISpinWheelConfig>(
  'SpinWheelConfig',
...
export const SpinWheelSpin: Model<ISpinWheelSpin> = mongoose.model<ISpinWheelSpin>(
  'SpinWheelSpin',
  SpinWheelSpinSchema,
);
...
const UserSpinMetricsSchema = new Schema<IUserSpinMetrics>(
  {
    ...
    date: { type: Date, required: true }, // Stores date at midnight UTC
...
export const UserSpinMetrics: Model<IUserSpinMetrics> = mongoose.model<IUserSpinMetrics>(
  'UserSpinMetrics',
  UserSpinMetricsSchema,
);
