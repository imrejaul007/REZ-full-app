...
// KAVITA: Compound index for getForEvent() time-range queries (prevents collection scan)
EventRewardConfigSchema.index({ eventId: 1, isActive: 1, validFrom: 1, validUntil: 1 });
