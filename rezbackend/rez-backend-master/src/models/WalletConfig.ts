...
const WalletConfigSchema = new Schema<IWalletConfig>(
  {
    ...
    redemptionConfig: {
      conversionRates: {
        gift_card: { type: Number, default: 0.1 },
        bill_pay: { type: Number, default: 0.1 },
    ...
    priveProgramConfig: {
      ...
      pillarWeights: {
        ...
        trust: { type: Number, default: 0.2 },
        influence: { type: Number, default: 0.2 },
        economicValue: { type: Number, default: 0.15 },
        brandAffinity: { type: Number, default: 0.1 },
        network: { type: Number, default: 0.1 },
      },
      tiers: {
        type: [
          {
        ...
        default: [
          ...
          },
          {
            ...
            benefits: [
              ...
              'Priority concierge (24h SLA)',
              'Exclusive Signature offers',
              'Advanced analytics',
            ],
          },
          {
            ...
            benefits: [
              ...
              '2x coin multiplier',
              'VIP concierge (1h SLA)',
              'Exclusive Elite experiences',
    ...
    coinExpiryConfig: {
      ...
      branded: {
        expiryDays: { type: Number, default: 180 }, // 180 = 6 months
        maxUsagePct: { type: Number, default: 100 },
      },
    },
    coinRules: {
      ...
      default: {
        ...
        promo: {
          usageRules: [
            'Max 20% of bill value per transaction',
            'Valid only during campaign period',
            'Check expiry date',
          ],
        ...
        branded: {
          usageRules: [
            'Use only at the issuing merchant',
            'Expires in 180 days (configurable)',
