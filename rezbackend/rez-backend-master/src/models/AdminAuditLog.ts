...
export interface IAdminAuditLog extends Document {
  ...
  timestamp: Date;
  // NIDHI: governance — before/after capture for config changes
  changes?: {
...
const AdminAuditLogSchema = new Schema<IAdminAuditLog>({
  ...
  // NIDHI: governance — before/after state for compliance audits
  changes: {
    beforeValues: Schema.Types.Mixed,
    afterValues: Schema.Types.Mixed,
    changedFields: [String],
  },
}, {
