...
// KAVITA: compound index for processing queue queries — prevents collection scan on unprocessed event polling
AnalyticsEventSchema.index({ processed: 1, eventType: 1, timestamp: -1 });
