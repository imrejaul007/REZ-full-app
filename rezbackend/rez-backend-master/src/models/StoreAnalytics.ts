...
export interface IStoreAnalyticsModel extends Model<IStoreAnalytics> {
  ...
  getPopularStores(options?: { startDate?: Date; endDate?: Date; eventType?: string; limit?: number }): Promise<any[]>;
...
StoreAnalyticsSchema.statics.getStoreAnalytics = async function (
  storeId: string,
  options: {
    startDate?: Date;
    endDate?: Date;
...
StoreAnalyticsSchema.statics.getPopularStores = async function (
  options: {
    startDate?: Date;
    endDate?: Date;
    eventType?: string;
...
StoreAnalyticsSchema.statics.getUserAnalytics = async function (
  userId: string,
  options: {
    startDate?: Date;
    endDate?: Date;
...
export const StoreAnalytics = mongoose.model<IStoreAnalytics, IStoreAnalyticsModel>(
  'StoreAnalytics',
