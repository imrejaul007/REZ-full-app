...
BonusClaimSchema.statics.getUserClaimCount = async function (campaignId: string, userId: string): Promise<number> {
...
BonusClaimSchema.statics.getUserDailyClaimCount = async function (campaignId: string, userId: string): Promise<number> {
...
BonusClaimSchema.statics.getUserTotalReward = async function (campaignId: string, userId: string): Promise<number> {
...
const BonusClaim = mongoose.model<IBonusClaim, IBonusClaimModel>('BonusClaim', BonusClaimSchema);
