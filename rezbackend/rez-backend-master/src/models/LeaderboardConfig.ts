...
export type LeaderboardScopeType = 'global' | 'city' | 'area' | 'campus';
...
export interface ILeaderboardConfig extends Document {
  ...
  // Phase 2.4: Area & Campus Leaderboards
  scopeType: LeaderboardScopeType;
  scopeId?: Types.ObjectId; // References Area or Campus document
...
const LeaderboardConfigSchema = new Schema<ILeaderboardConfig>(
  {
    ...
    // Phase 2.4: Area & Campus Leaderboards scope
    scopeType: {
      type: String,
      enum: ['global', 'city', 'area', 'campus'],
      default: 'global',
      index: true,
    },
    scopeId: {
      type: Schema.Types.ObjectId,
      // References either Area or Campus depending on scopeType
      refPath: 'scopeType',
      index: true,
    },
    createdBy: {
