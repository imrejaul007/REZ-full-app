...
// KAVITA: Compound index for store-specific coin drop queries (prevents collection scan in earning analytics)
CoinDropSchema.index({ storeId: 1, isActive: 1, endTime: 1 });
CoinDropSchema.index({ storeId: 1, createdAt: -1 }); // Store's coin drop history
