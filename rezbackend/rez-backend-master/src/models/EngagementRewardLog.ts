...
// KAVITA: compound index for engagement reward daily limits and caps — prevents collection scan on daily reset queries
EngagementRewardLogSchema.index({ action: 1, createdAt: -1 });
