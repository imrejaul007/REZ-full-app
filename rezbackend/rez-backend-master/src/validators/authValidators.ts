...
// Phone number validation — canonical E.164 format.
// Requires a + prefix and 7–15 digits (covers all real country codes + subscriber numbers).
// Frontend always sends numbers with + after normalisation (e.g. "+919876543210").
// Matches: +919876543210 (+91 India), +971501234567 (+971 UAE), +12125551234 (+1 US)
// Rejects: "9876543210" (no country code), "+1X" (too short), "+9" (only 1 digit after +)
