...
export const loggingMiddleware = (req: Request, res: Response, next: NextFunction) => {
  ...
  // Removed per-request incoming log — it doubled allocations per HTTP call.
  // All relevant fields (method, path, status, duration) are captured in the
  // single response log below, which fires once per request.
