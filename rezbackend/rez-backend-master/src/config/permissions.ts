...
export const PERMISSIONS = {
  ...
  'pos:create_bill': ['owner', 'admin', 'manager', 'staff', 'cashier'],
  'pos:apply_discount': ['owner', 'admin', 'manager'],
  'pos:void_bill': ['owner', 'admin', 'manager'],

  // Products
  'products:view': ['owner', 'admin', 'manager', 'staff', 'cashier'],
  ...
  // Orders
  'orders:view': ['owner', 'admin', 'manager', 'staff', 'cashier'],
  'orders:view_all': ['owner', 'admin', 'manager'],
  'orders:update_status': ['owner', 'admin', 'manager', 'staff', 'cashier'],
...
export const ROLE_PERMISSIONS: Record<MerchantUserRole, Permission[]> = {
  ...
  // Cashier: POS-only access — billing, products, basic orders
  cashier: [
    'pos:create_bill',
    'products:view',
    'orders:view',
