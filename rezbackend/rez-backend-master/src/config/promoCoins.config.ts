 ...
 */
export function convertCoinsToINR(coins: number, config: PromoCoinsConfig = DEFAULT_PROMO_COINS_CONFIG): number {
 ...
 */
export function getCoinsExpiryDate(config: PromoCoinsConfig = DEFAULT_PROMO_COINS_CONFIG): Date | undefined {
