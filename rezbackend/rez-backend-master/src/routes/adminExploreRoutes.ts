...
router.get('/stats', getExploreDashboardStats);
...
router.put(
  '/comparisons/:comparisonId/feature',
  validateParams(
    Joi.object({
...
router.get('/videos/stats', getExploreVideoStats);
...
router.post(
  ...
  validateBody(
    Joi.object({
      ...
      category: Joi.string()
        .valid('trending_me', 'trending_her', 'waist', 'article', 'featured', 'challenge', 'tutorial', 'review')
        .default('featured'),
...
router.post(
  ...
  validateBody(
    Joi.object({
      ...
      action: Joi.string()
        .valid('publish', 'unpublish', 'feature', 'unfeature', 'trending', 'untrending', 'approve', 'reject')
        .required(),
    }),
  ),
  bulkUpdateVideos,
