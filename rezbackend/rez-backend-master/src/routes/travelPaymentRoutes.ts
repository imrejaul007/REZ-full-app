...
router.post('/create-order', authenticate, bbpsPayLimiter, createTravelPaymentOrder);
...
router.post('/create-checkout-session', authenticate, bbpsPayLimiter, createTravelStripeSession);
