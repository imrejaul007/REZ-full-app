...
router.get('/config/public', optionalAuth, getPublicSupportConfig);
...
// Get tickets summary
router.get('/tickets/summary', authenticate, getTicketsSummary);
...
router.post(
  ...
  validate(
    Joi.object({
      ...
      category: Joi.string()
        .valid('order', 'payment', 'product', 'account', 'technical', 'delivery', 'refund', 'other')
        .required(),
...
// Get FAQ categories
router.get('/faq/categories', optionalAuth, getFAQCategories);
