 ...
 */
router.post('/webhook/confirm', webhookAuth, webhookRateLimit(100, 60000), confirmPurchaseWebhook);
 ...
 * Body: { purchase_id, reason }
 */
router.post('/webhook/refund', webhookAuth, webhookRateLimit(100, 60000), refundWebhook);
 ...
 * Body: { purchase_id, reason }
 */
router.post('/webhook/reject', webhookAuth, webhookRateLimit(100, 60000), rejectPurchaseWebhook);
