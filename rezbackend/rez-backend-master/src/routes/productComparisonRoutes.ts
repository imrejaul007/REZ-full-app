...
router.delete(
  '/:comparisonId/products/:productId',
  requireAuth,
  validateParams(
    Joi.object({
      comparisonId: commonSchemas.objectId(),
...
router.get('/user/stats', requireAuth, getProductComparisonStats);

// Clear all product comparisons
router.delete('/user/clear-all', requireAuth, clearAllProductComparisons);
