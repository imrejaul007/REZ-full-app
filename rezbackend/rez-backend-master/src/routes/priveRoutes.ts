...
import { getSmartSpendCatalog, getSmartSpendItem, trackSmartSpendClick } from '../controllers/smartSpendController';
...
router.post(
  '/concierge/tickets/:id/message',
  strictLimiter,
  requireFeatureFlag('conciergeEnabled'),
  addConciergeMessage,
);
