...
router.post(
  '/social-impact/:id/approve',
  requireAdmin,
  programController.approveSocialImpactEvent.bind(programController),
);
router.post(
  '/social-impact/:id/reject',
  requireAdmin,
  programController.rejectSocialImpactEvent.bind(programController),
);
...
router.get(
  '/social-impact/:id/participants',
  requireAdmin,
  programController.getSocialImpactParticipants.bind(programController),
);
router.post('/social-impact/:id/check-in', requireAdmin, programController.checkInSocialImpact.bind(programController));
router.post(
  '/social-impact/:id/complete',
  requireAdmin,
  programController.completeSocialImpact.bind(programController),
);
router.post(
  '/social-impact/:id/bulk-complete',
  requireAdmin,
  programController.bulkCompleteSocialImpact.bind(programController),
);

// Social Impact - Attendance verification
router.post(
  '/social-impact/:id/generate-qr',
  requireAdmin,
  programController.generateQRCheckIn.bind(programController),
);
router.post('/social-impact/:id/verify-qr', requireAdmin, programController.verifyQRCheckIn.bind(programController));
router.post(
  '/social-impact/:id/generate-otp',
  requireAdmin,
  programController.generateOTPCheckIn.bind(programController),
);
