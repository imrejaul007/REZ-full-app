...
// Single pick detail
router.get('/picks/:pickId', optionalAuth, getPickDetail);

// Track pick view
router.post('/picks/:pickId/view', optionalAuth, trackPickView);

// Track pick click
router.post('/picks/:pickId/click', optionalAuth, trackPickClick);

// Toggle pick like (auth required)
router.post('/picks/:pickId/like', authenticate, togglePickLike);

// Toggle pick bookmark (auth required)
router.post('/picks/:pickId/bookmark', authenticate, togglePickBookmark);
...
// Apply as creator
router.post('/apply', authenticate, applyAsCreator);
...
// Delete my pick
router.delete('/my-picks/:pickId', authenticate, deleteMyPick);

// Update my pick
router.patch('/my-picks/:pickId', authenticate, updateMyPick);
...
// Get my earnings
router.get('/my-earnings', authenticate, getMyEarnings);
