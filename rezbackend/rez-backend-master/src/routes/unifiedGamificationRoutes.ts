...
// BED-002: added authenticate middleware
// ========================================
router.get('/coins/balance', authenticate, getCoinBalance);
...
// router.post('/scratch-card/create');
// router.post('/scratch-card/scratch');
// router.post('/scratch-card/:id/claim');
...
const gateStats = requireGamificationFeature('achievements', {
  ...
  challengesActive: 0,
  rank: 0,
  allRanks: { spending: 0, reviews: 0, referrals: 0, coins: 0, cashback: 0 },
});
