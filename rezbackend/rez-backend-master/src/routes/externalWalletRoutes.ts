...
router.post('/paytm/initiate', authenticate, bbpsPayLimiter, initiatePaytmPayment);

// ==================== AMAZON PAY ====================

// Initiate Amazon Pay payment
router.post('/amazonpay/initiate', authenticate, bbpsPayLimiter, initiateAmazonPayPayment);

// ==================== MOBIKWIK ====================

// Initiate Mobikwik payment
router.post('/mobikwik/initiate', authenticate, bbpsPayLimiter, initiateMobikwikPayment);
