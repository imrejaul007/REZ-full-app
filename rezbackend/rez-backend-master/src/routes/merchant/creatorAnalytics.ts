...
router.get(
  ...
  asyncHandler(async (req: Request, res: Response) => {
    ...
    sendSuccess(res, {
      ...
      pendingPicks,
      conversionRate: ps.totalClicks > 0 ? Math.round((ps.totalPurchases / ps.totalClicks) * 100 * 100) / 100 : 0,
    });
  }),
);
