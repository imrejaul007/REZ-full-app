...
router.get(
  ...
  asyncHandler(async (req: Request, res: Response) => {
    ...
    const sortBy = ALLOWED_WALLET_SORT_FIELDS.includes(req.query.sortBy as string)
...
router.get(
  ...
  asyncHandler(async (_req: Request, res: Response) => {
    ...
    const pendingWithdrawals = walletsWithPending
      .map((wallet) => {
...
router.get(
  ...
  asyncHandler(async (req: Request, res: Response) => {
    ...
    const result = await merchantWalletService.getTransactionHistory(req.params.merchantId, page, limit, type);
...
router.post(
  ...
  asyncHandler(async (req: Request, res: Response) => {
    ...
    await merchantWalletService.processWithdrawal(req.params.merchantId, transactionId, transactionReference);
...
router.post(
  ...
  asyncHandler(async (req: Request, res: Response) => {
    ...
    await merchantWalletService.rejectWithdrawal(req.params.merchantId, transactionId, reason);
