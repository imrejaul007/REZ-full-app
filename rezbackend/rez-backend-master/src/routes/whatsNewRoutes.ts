 ...
 */
router.get('/', optionalAuth, validateQuery(getStoriesQuerySchema), getActiveStories);
 ...
 */
router.get('/unseen-count', optionalAuth, getUnseenCount);
 ...
 */
router.get('/:id', optionalAuth, validateParams(storyIdParamSchema), getStoryById);
 ...
 */
router.post('/:id/view', optionalAuth, validateParams(storyIdParamSchema), trackView);
 ...
 * @access  Public (optional auth for user-specific tracking)
 */
router.post('/:id/click', optionalAuth, validateParams(storyIdParamSchema), trackClick);
 ...
 * @access  Public (optional auth for user-specific tracking)
 */
router.post('/:id/complete', optionalAuth, validateParams(storyIdParamSchema), trackCompletion);
 ...
 * @access  Private (Admin only)
 */
router.get('/admin/analytics', authenticate, getAnalyticsSummary);
 ...
 * @access  Private (Admin only)
 */
router.post('/admin', authenticate, validate(createStorySchema), createStory);
 ...
 * @access  Private (Admin only)
 */
router.put('/admin/:id', authenticate, validateParams(storyIdParamSchema), validate(updateStorySchema), updateStory);
 ...
 */
router.delete('/admin/:id', authenticate, validateParams(storyIdParamSchema), deleteStory);
