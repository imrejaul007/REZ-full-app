...
router.get('/:id/warranty', authenticate, getWarrantyDetails);

// Get AMC details
router.get('/:id/amc', authenticate, getAMCDetails);
...
router.get('/service-requests/active', authenticate, getActiveServiceRequests);
...
router.get('/service-requests/:id', authenticate, getServiceRequestDetails);
