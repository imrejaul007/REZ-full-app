...
import { getEarningCategories, getProjects, getProjectById, submitProject } from '../controllers/projectController';
...
router.get('/categories', optionalAuth, getEarningCategories);
