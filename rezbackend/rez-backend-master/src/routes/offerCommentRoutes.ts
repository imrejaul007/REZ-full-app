...
// Admin moderation (require admin role)
router.get('/comments/pending', requireAuth, requireAdmin, getPendingComments);
router.patch('/comments/:commentId/moderate', requireAuth, requireAdmin, moderateComment);
