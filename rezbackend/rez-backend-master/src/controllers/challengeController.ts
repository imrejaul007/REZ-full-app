...
class ChallengeController {
  ...
  getActiveChallenges = asyncHandler(async (req: Request, res: Response) => {
    try {
      ...
      const challenges = await challengeService.getActiveChallenges(type as string | undefined);
  ...
  getMyProgress = asyncHandler(async (req: Request, res: Response) => {
    try {
      ...
      const progress = await challengeService.getUserProgress(userId, includeCompleted === 'true');
