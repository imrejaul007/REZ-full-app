...
class SponsorController {
  // GET /api/sponsors
  getSponsors = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
    try {
  ...
  createSponsor = asyncHandler(async (req: Request, res: Response) => {
    try {
      const { name, logo, description, brandCoinName, brandCoinLogo, contactPerson, website, industry } = req.body;
  ...
  // GET /api/sponsors/:id
  getSponsorById = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
    try {
      const { id } = req.params;
  ...
  deactivateSponsor = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
    try {
      const { id } = req.params;
  ...
  activateSponsor = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
    try {
      const { id } = req.params;
  ...
  getSponsorEvents = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
    try {
      const { id } = req.params;
  ...
  getSponsorAnalytics = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
    try {
      const { id } = req.params;
  ...
  getSponsorBudget = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
    try {
      const { id } = req.params;
  ...
  getSponsorLedger = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
    try {
      const { id } = req.params;
