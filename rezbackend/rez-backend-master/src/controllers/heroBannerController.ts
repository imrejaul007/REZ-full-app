...
export const trackBannerView = async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
    const { source: _source, device: _device, location: _location } = req.body;
...
export const trackBannerClick = async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
    const { source: _source3, device: _device3, location: _location3 } = req.body;
...
export const trackBannerConversion = async (req: Request, res: Response) => {
  try {
    const { id } = req.params;
    const { conversionType: _conversionType, value: _value, source: _source2, device: _device2 } = req.body;
