...
const VALID_CATEGORIES: MainCategorySlug[] = [
  'food-dining',
  'beauty-wellness',
  'grocery-essentials',
  'fitness-sports',
...
const FITNESS_SPORTS_MISSIONS = [
  {
    missionId: 'fitness-visit-3-gyms',
    title: 'Visit 3 Gyms/Studios',
    description: 'Try 3 different fitness venues',
    target: 3,
    reward: 50,
    icon: '🏋️',
  },
  {
    missionId: 'fitness-book-5-classes',
    title: 'Book 5 Fitness Classes',
    description: 'Book group classes or personal training',
    target: 5,
    reward: 75,
    icon: '📅',
  },
  {
    missionId: 'fitness-7-day-streak',
    title: '7-Day Check-in Streak',
    description: 'Check in every day for 7 consecutive days',
    target: 7,
    reward: 50,
  ...
  {
    missionId: 'fitness-leave-2-reviews',
    title: 'Rate 2 Venues',
    description: 'Leave reviews at fitness venues',
    target: 2,
    reward: 30,
    icon: '⭐',
  },
  {
    missionId: 'fitness-try-3-workouts',
    title: 'Try 3 Workout Types',
    description: 'Try different workout categories',
    target: 3,
    reward: 60,
    icon: '💪',
  },
...
const BEAUTY_WELLNESS_MISSIONS = [
  {
    missionId: 'beauty-visit-3-salons',
    title: 'Visit 3 Salons/Spas',
    description: 'Try 3 different beauty venues',
    target: 3,
    reward: 50,
    icon: '💇',
  },
  {
    missionId: 'beauty-book-5-services',
    title: 'Book 5 Services',
    description: 'Book beauty or wellness services',
    target: 5,
    reward: 75,
    icon: '📅',
  },
  {
    missionId: 'beauty-7-day-streak',
    title: '7-Day Self-Care Streak',
    description: 'Check in every day for 7 consecutive days',
    target: 7,
    reward: 50,
    icon: '🔥',
  ...
  {
    missionId: 'beauty-leave-2-reviews',
    title: 'Rate 2 Venues',
    description: 'Leave reviews at beauty venues',
    target: 2,
    reward: 30,
    icon: '⭐',
  },
  {
    missionId: 'beauty-try-3-services',
    title: 'Try 3 Service Types',
    description: 'Try different beauty categories',
    target: 3,
    reward: 60,
    icon: '✨',
  },
...
const GROCERY_ESSENTIALS_MISSIONS = [
  {
    missionId: 'grocery-shop-3-stores',
    title: 'Shop at 3 Stores',
    description: 'Try 3 different grocery stores',
    target: 3,
    reward: 50,
    icon: '🛒',
  },
  {
    missionId: 'grocery-place-10-orders',
    title: 'Place 10 Orders',
    description: 'Complete 10 grocery orders',
    target: 10,
    reward: 100,
    icon: '📦',
  },
  {
    missionId: 'grocery-7-day-streak',
    title: '7-Day Shopping Streak',
    description: 'Check in every day for 7 consecutive days',
    target: 7,
    reward: 50,
    icon: '🔥',
  ...
  {
    missionId: 'grocery-leave-2-reviews',
    title: 'Rate 2 Stores',
    description: 'Leave reviews at grocery stores',
    target: 2,
    reward: 30,
    icon: '⭐',
  },
  {
    missionId: 'grocery-try-5-categories',
    title: 'Try 5 Categories',
    description: 'Shop from 5 different product categories',
    target: 5,
    reward: 75,
    icon: '🧺',
  },
...
const HEALTHCARE_MISSIONS = [
  {
    missionId: 'health-visit-3-clinics',
    title: 'Visit 3 Clinics',
    description: 'Try 3 different healthcare providers',
    target: 3,
    reward: 50,
    icon: '🏥',
  },
  {
    missionId: 'health-book-5-appointments',
    title: 'Book 5 Appointments',
    description: 'Book doctor or lab appointments',
    target: 5,
    reward: 75,
    icon: '📅',
  },
  {
    missionId: 'health-checkup-streak',
    title: 'Health Checkup Streak',
    description: 'Complete routine checkups for 3 months',
    target: 3,
    reward: 60,
    icon: '🔥',
  },
  {
    missionId: 'health-rate-2-doctors',
    title: 'Rate 2 Doctors',
    description: 'Leave reviews for healthcare providers',
    target: 2,
    reward: 30,
    icon: '⭐',
  },
  {
    missionId: 'health-try-3-specialties',
    title: 'Try 3 Specialties',
    description: 'Visit different medical specialties',
    target: 3,
    reward: 60,
    icon: '💊',
  },
...
const FASHION_MISSIONS = [
  {
    missionId: 'fashion-visit-3-stores',
    title: 'Visit 3 Stores',
    description: 'Shop at 3 different fashion stores',
    target: 3,
    reward: 50,
    icon: '👗',
  },
  {
    missionId: 'fashion-buy-5-brands',
    title: 'Buy from 5 Brands',
  ...
  {
    missionId: 'fashion-7-day-streak',
    title: '7-Day Style Streak',
    description: 'Check in every day for 7 consecutive days',
    target: 7,
    reward: 50,
    icon: '🔥',
  ...
  {
    missionId: 'fashion-rate-2-boutiques',
    title: 'Rate 2 Boutiques',
    description: 'Leave reviews at fashion stores',
    target: 2,
    reward: 30,
    icon: '⭐',
  },
  {
    missionId: 'fashion-try-3-categories',
    title: 'Try 3 Categories',
    description: 'Shop from 3 different fashion categories',
    target: 3,
    reward: 60,
    icon: '👠',
  },
...
const EDUCATION_MISSIONS = [
  {
    missionId: 'edu-enroll-3-courses',
    title: 'Enroll in 3 Courses',
    description: 'Join 3 different courses or classes',
    target: 3,
    reward: 50,
    icon: '📚',
  },
  {
    missionId: 'edu-complete-5-classes',
    title: 'Complete 5 Classes',
    description: 'Attend and complete 5 class sessions',
    target: 5,
    reward: 75,
    icon: '✅',
  },
  {
    missionId: 'edu-7-day-streak',
  ...
  {
    missionId: 'edu-rate-2-institutes',
    title: 'Rate 2 Institutes',
    description: 'Leave reviews for educational institutes',
    target: 2,
    reward: 30,
    icon: '⭐',
  },
  {
    missionId: 'edu-try-3-subjects',
    title: 'Try 3 Subjects',
    description: 'Explore 3 different subject areas',
    target: 3,
    reward: 60,
    icon: '🎓',
  },
...
const HOME_SERVICES_MISSIONS = [
  {
    missionId: 'home-book-3-services',
    title: 'Book 3 Services',
    description: 'Book 3 different home services',
    target: 3,
    reward: 50,
    icon: '🏠',
  },
  {
    missionId: 'home-complete-5-jobs',
    title: 'Complete 5 Jobs',
    description: 'Get 5 home service jobs completed',
    target: 5,
    reward: 75,
    icon: '🔧',
  },
  {
    missionId: 'home-monthly-maintenance',
    title: 'Monthly Maintenance',
    description: 'Schedule maintenance services for 3 months',
    target: 3,
    reward: 60,
    icon: '🔥',
  },
  {
    missionId: 'home-rate-2-providers',
    title: 'Rate 2 Providers',
    description: 'Leave reviews for service providers',
    target: 2,
    reward: 30,
    icon: '⭐',
  },
  {
    missionId: 'home-try-3-services',
    title: 'Try 3 Service Types',
    description: 'Use 3 different types of home services',
    target: 3,
    reward: 60,
    icon: '🛠️',
  },
...
const TRAVEL_MISSIONS = [
  {
    missionId: 'travel-book-3-trips',
    title: 'Book 3 Trips',
    description: 'Book 3 different travel experiences',
    target: 3,
    reward: 50,
    icon: '✈️',
  },
  {
    missionId: 'travel-visit-5-destinations',
    title: 'Visit 5 Destinations',
    description: 'Travel to 5 different destinations',
    target: 5,
    reward: 75,
    icon: '🗺️',
  },
  {
    missionId: 'travel-weekend-streak',
    title: 'Weekend Getaway Streak',
    description: 'Plan weekend trips for 3 months',
    target: 3,
    reward: 60,
    icon: '🔥',
  },
  {
    missionId: 'travel-rate-2-hotels',
    title: 'Rate 2 Hotels',
    description: 'Leave reviews for hotels or venues',
    target: 2,
    reward: 30,
    icon: '⭐',
  },
  {
    missionId: 'travel-try-3-modes',
    title: 'Try 3 Travel Modes',
    description: 'Use 3 different travel modes',
    target: 3,
    reward: 60,
    icon: '🚂',
  },
...
const ENTERTAINMENT_MISSIONS = [
  {
    missionId: 'ent-attend-3-events',
    title: 'Attend 3 Events',
    description: 'Attend 3 different entertainment events',
    target: 3,
    reward: 50,
    icon: '🎬',
  },
  {
    missionId: 'ent-book-5-tickets',
    title: 'Book 5 Tickets',
    description: 'Book tickets for 5 shows or events',
    target: 5,
    reward: 75,
    icon: '🎟️',
  },
  {
    missionId: 'ent-weekend-streak',
    title: 'Weekend Fun Streak',
    description: 'Attend events for 4 consecutive weekends',
    target: 4,
    reward: 50,
    icon: '🔥',
  },
  {
    missionId: 'ent-rate-2-venues',
    title: 'Rate 2 Venues',
    description: 'Leave reviews for entertainment venues',
    target: 2,
    reward: 30,
    icon: '⭐',
  },
  {
    missionId: 'ent-try-3-types',
    title: 'Try 3 Entertainment Types',
    description: 'Experience 3 different entertainment types',
    target: 3,
    reward: 60,
    icon: '🎭',
  },
...
const FINANCIAL_MISSIONS = [
  {
    missionId: 'fin-pay-3-bills',
    title: 'Pay 3 Bills',
    description: 'Pay 3 different utility or service bills',
    target: 3,
    reward: 50,
    icon: '💳',
  },
  {
    missionId: 'fin-use-5-services',
    title: 'Use 5 Services',
    description: 'Use 5 different financial services',
    target: 5,
    reward: 75,
    icon: '🏦',
  },
  {
    missionId: 'fin-savings-streak',
  ...
  {
    missionId: 'fin-rate-2-providers',
    title: 'Rate 2 Providers',
    description: 'Leave reviews for financial service providers',
    target: 2,
    reward: 30,
    icon: '⭐',
  },
  {
    missionId: 'fin-try-3-products',
    title: 'Try 3 Financial Products',
    description: 'Use 3 different financial product types',
    target: 3,
    reward: 60,
    icon: '📊',
  },
...
const ELECTRONICS_MISSIONS = [
  {
    missionId: 'elec-buy-3-stores',
    title: 'Buy from 3 Stores',
    description: 'Purchase from 3 different electronics stores',
    target: 3,
    reward: 50,
    icon: '📱',
  },
  {
    missionId: 'elec-purchase-5-items',
    title: 'Purchase 5 Items',
    description: 'Buy 5 different electronics products',
    target: 5,
    reward: 75,
    icon: '💻',
  },
  {
    missionId: 'elec-review-streak',
    title: 'Tech Review Streak',
    description: 'Write tech reviews for 3 consecutive weeks',
    target: 3,
    reward: 50,
    icon: '🔥',
  },
  {
    missionId: 'elec-rate-2-brands',
    title: 'Rate 2 Brands',
    description: 'Leave reviews for electronics brands',
    target: 2,
    reward: 30,
    icon: '⭐',
  },
  {
    missionId: 'elec-try-3-categories',
    title: 'Try 3 Categories',
    description: 'Shop from 3 different electronics categories',
    target: 3,
    reward: 60,
    icon: '🎮',
  },
...
// Category-aware brand name fallback (reserved for future use)
...
function getTierFromPurchaseCount(count: number): {
...
async function populateBrandLoyaltyFromOrders(userId: string): Promise<any[]> {
  try {
    ...
    const storeIdsNeedingNames = brandStats.filter((b) => !b.name || genericNames.includes(b.name)).map((b) => b._id);
...
// Map mission ID prefixes to their MainCategory slugs (reserved for future use)
// eslint-disable-next-line @typescript-eslint/no-unused-vars
...
export async function computeMissionProgress(userId: string, streakCurrent: number): Promise<Map<string, number>> {
  ...
  try {
    ...
    const storesWithCategory =
      allStoreIds.size > 0
        ? await Store.find({ _id: { $in: Array.from(allStoreIds) } })
            .select('_id category')
            .lean()
        : [];
...
export const getUserLoyalty = asyncHandler(async (req: Request, res: Response) => {
  ...
  try {
    ...
    if (category && VALID_CATEGORIES.includes(category as MainCategorySlug)) {
      const catCoins =
        loyaltyObj.categoryCoins instanceof Map
    ...
    logger.error('[LOYALTY] Failed to fetch loyalty data', { error: err instanceof Error ? err.message : err });
...
export const checkIn = asyncHandler(async (req: Request, res: Response) => {
  ...
  try {
    ...
    const lastCheckin = loyalty.streak.lastCheckin ? new Date(loyalty.streak.lastCheckin) : null;
    ...
    await coinService.awardCoins(
      ...
      'daily_login',
      description,
      { streakDay: newStreak, idempotencyKey, referenceId: idempotencyKey },
      validCategory || null,
    );
    ...
    const streakMission = loyalty.missions.find(
      (m: any) => (m.missionId.includes('streak') || m.missionId.includes('maintenance')) && !m.completedAt,
    );
    if (streakMission) {
  ...
  try {
    ...
    try {
      await coinService.awardCoins(
        ...
        { missionId: mission.missionId, referenceId: `mission:${userId}:${mission.missionId}` },
...
export const getCoinBalance = asyncHandler(async (req: Request, res: Response) => {
  ...
  try {
    ...
    logger.error('[LOYALTY] Failed to fetch coin balance', { error: err instanceof Error ? err.message : err });
...
export const getHomepageLoyaltySummary = asyncHandler(async (req: Request, res: Response) => {
  ...
  try {
    ...
    const [loyaltyData, nearbyStores] = await Promise.all([
      ...
      Store.find(storeFilter).select('_id name logo').limit(50).lean(),
    ]);
    ...
    if (storeIds.length > 0) {
      ...
      if (trendingService) {
        ...
        const savings =
          (trendingService.pricing?.original || trendingService.pricing?.selling || 0) -
          (trendingService.pricing?.selling || 0);
