...
import { sendSuccess, sendNotFound, sendError, sendUnauthorized, sendBadRequest } from '../utils/response';
...
import { isValidRegion, RegionId, getRegionConfig } from '../services/regionService';
...
export const removeCoupon = asyncHandler(async (req: Request, res: Response) => {
  ...
  try {
    ...
    logger.error('[CART] Failed to remove coupon:', error);
...
export const getCartSummary = asyncHandler(async (req: Request, res: Response) => {
  ...
  try {
    ...
    logger.error('[CART] Failed to get cart summary:', error);
...
export const validateCart = asyncHandler(async (req: Request, res: Response) => {
  ...
  try {
    ...
    logger.error('[CART] Failed to validate cart for checkout', { error: err instanceof Error ? err.message : err });
