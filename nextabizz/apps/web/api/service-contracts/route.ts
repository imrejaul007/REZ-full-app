...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    console.error('Service contracts GET error:', errorMessage);
    return NextResponse.json(
...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    const errorMessage = error instanceof Error ? error.message : 'Unknown error';
    console.error('Service contracts POST error:', errorMessage);
    return NextResponse.json(
...
export async function PUT(request: NextRequest) {
  ...
  try {
    ...
    const errorMessage = error instanceof Error ? error.message : 'Unknown error';
    console.error('Service contracts PUT error:', errorMessage);
    return NextResponse.json(
...
export async function DELETE(request: NextRequest) {
  ...
  try {
    ...
    const errorMessage = error instanceof Error ? error.message : 'Unknown error';
    console.error('Service contracts DELETE error:', errorMessage);
    return NextResponse.json(
