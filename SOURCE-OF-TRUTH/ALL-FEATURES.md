...
**Platform:** Consumer App + Merchant App + Admin App + REZ Now + Web Menu + Microservices + REZ Mind
...
# REZ MIND - AI & INTELLIGENCE (Complete - May 8, 2026)

**REZ MIND is the AI brain of the entire ReZ ecosystem.**
...
| App/Service | Sends | Receives | Status |
|-------------|-------|----------|--------|
| Consumer App | | | FULL |
| Merchant App | | | SEND |
| Do App | | | FULL |
...
| Where | How |
|-------|-----|
| Consumer App | Personalized home feed (+30 pts score) |
| Backend Feed | REZ Mind interests merged + AI scores |
| Marketing | User segments for campaigns |
| Ads | Intent-based targeting |
| Support | User context & history |
| Dormant Users | Auto re-engagement (cron job) |
