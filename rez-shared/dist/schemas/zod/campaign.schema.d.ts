...
export declare const BaseCampaignSchema: z.ZodObject<{
    ...
    spent?: number;
    status?: "cancelled" | "completed" | "failed" | "expired" | "rejected" | "sent" | "draft" | "scheduled" | "sending" | "pending_review" | "active" | "paused";
    name?: string;
    description?: string;
    channel?: "push" | "email" | "sms" | "in_app" | "social" | "whatsapp" | "web" | "api";
    startDate?: Date;
    endDate?: Date;
