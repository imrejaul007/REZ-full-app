...
exports.calculateComponentScores = calculateComponentScores;
...
function calculateReliabilityScore(metrics) {
    ...
    const overall = Math.round(components.eventDelivery * WEIGHTS.eventDelivery +
 ...
 */
function isProductionReady(score) {
    const blockers = [];
...
//# sourceMappingURL=reliability-score.js.map