...
async function main(): Promise<void> {
  ...
  // Consumer-facing routes (JWT auth) - v1 API
  app.use('/api/v1/finance/borrow', borrowRoutes);
  app.use('/api/v1/finance/credit', creditRoutes);
  app.use('/api/v1/finance/pay', payRoutes);

  // Partner webhook routes (internal token auth)
  app.use('/api/v1/finance/partner/webhook', partnerRoutes);
