...
app.post('/api/v1/payments', async (req: Request, res: Response) => {
  try {
    ...
    const result = await circuitBreaker(
      'payment-service',
      async () => {
        const response = await fetch(`${SERVICE_URLS.payment}/api/v1/payment`, {
          method: 'POST',
          headers: {
...
app.post('/api/v1/orders', async (req: Request, res: Response) => {
  try {
    ...
    const result = await circuitBreaker(
      'order-service',
      async () => {
        const response = await fetch(`${SERVICE_URLS.order}/api/v1/orders`, {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
            'X-Company-Id': req.headers['x-company-id'] as string,
  ...
  try {
    ...
    const result = await circuitBreaker(
      ...
      async () => {
        ...
        const response = await fetch(`${SERVICE_URLS.catalog}/api/v1/products?${params}`, {
          headers: {
            'X-Company-Id': req.headers['x-company-id'] as string,
          },
        });
 ...
 */
app.get('/api/v1/hotels/search', async (req: Request, res: Response) => {
  try {
    ...
    const result = await circuitBreaker(
      ...
      async () => {
        ...
        const response = await fetch(`${SERVICE_URLS.hotel}/api/v1/hotels/search?${params}`, {
          headers: {
            'X-Company-Id': req.headers['x-company-id'] as string,
            'X-User-Id': req.headers['x-user-id'] as string,
          },
 ...
 */
app.get('/api/v1/wallet/balance', async (req: Request, res: Response) => {
  try {
    const result = await circuitBreaker(
      'wallet-service',
      async () => {
        const response = await fetch(`${SERVICE_URLS.wallet}/api/v1/wallet/balance`, {
          headers: {
            'X-Company-Id': req.headers['x-company-id'] as string,
            'X-User-Id': req.headers['x-user-id'] as string,
...
app.post('/api/v1/notifications', async (req: Request, res: Response) => {
  try {
    ...
    const result = await circuitBreaker(
      ...
      async () => {
        const response = await fetch(`${SERVICE_URLS.notification}/api/v1/notifications`, {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
            'X-Company-Id': req.headers['x-company-id'] as string,
 ...
 */
app.get('/api/v1/integrations/makcorps/hotels', async (req: Request, res: Response) => {
  try {
 ...
 */
app.get('/api/v1/integrations/nextabizz/products', async (req: Request, res: Response) => {
  try {
